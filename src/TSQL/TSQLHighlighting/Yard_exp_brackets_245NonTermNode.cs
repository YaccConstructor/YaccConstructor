...
{
    public class Yard_exp_brackets_245NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_245NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_245NonTermNode (string s, object positions)
        {
            text = s;
