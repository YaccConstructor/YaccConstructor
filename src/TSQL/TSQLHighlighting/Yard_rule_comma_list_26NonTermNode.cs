...
{
    public class Yard_rule_comma_list_26NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_26NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_26NonTermNode (string s, object positions)
        {
            text = s;
