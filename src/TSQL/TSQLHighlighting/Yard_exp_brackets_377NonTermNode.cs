...
{
    public class Yard_exp_brackets_377NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_377NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_377NonTermNode (string s, object positions)
        {
            text = s;
