...
{
    public class Yard_exp_brackets_297NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_297NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_297NonTermNode (string s, object positions)
        {
            text = s;
