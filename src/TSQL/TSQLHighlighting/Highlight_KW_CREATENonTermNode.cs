...
{
    public class Highlight_KW_CREATENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CREATENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CREATENonTermNode (string s, object positions)
        {
            text = s;
