...
{
    public class KW_STATISTICS_NORECOMPUTETermNode : IAbstractTreeNode
    {
        ...
        public KW_STATISTICS_NORECOMPUTETermNode (string s)
        {
            text = s;
        }

        public KW_STATISTICS_NORECOMPUTETermNode (string s, object positions)
        {
            text = s;
