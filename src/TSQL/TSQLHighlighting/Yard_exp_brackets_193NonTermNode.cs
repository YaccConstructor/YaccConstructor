...
{
    public class Yard_exp_brackets_193NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_193NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_193NonTermNode (string s, object positions)
        {
            text = s;
