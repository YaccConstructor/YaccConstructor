...
{
    public class WEIGHTTermNode : ITreeNode
    {
        ...
        public WEIGHTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public WEIGHTTermNode (string ycTokName, string ycValue)
        {
        ...
        public WEIGHTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
