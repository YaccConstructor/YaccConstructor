...
{
    public class KW_OPENDATASOURCETermNode : IAbstractTreeNode
    {
        ...
        public KW_OPENDATASOURCETermNode (string s)
        {
            text = s;
        }

        public KW_OPENDATASOURCETermNode (string s, object positions)
        {
            text = s;
