...
{
    public class Highlight_KW_FETCHNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FETCHNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FETCHNonTermNode (string s, object positions)
        {
            text = s;
