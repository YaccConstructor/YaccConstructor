...
{
    public class KW_ANYTermNode : ITreeNode
    {
        ...
        public KW_ANYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ANYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ANYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
