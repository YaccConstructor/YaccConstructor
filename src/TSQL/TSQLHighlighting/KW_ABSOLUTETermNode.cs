...
{
    public class KW_ABSOLUTETermNode : ITreeNode
    {
        ...
        public KW_ABSOLUTETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ABSOLUTETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ABSOLUTETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
