...
{
    public class Highlight_KW_REMOTE_PROC_TRANSACTIONSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_REMOTE_PROC_TRANSACTIONSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_REMOTE_PROC_TRANSACTIONSNonTermNode (string s, object positions)
        {
            text = s;
