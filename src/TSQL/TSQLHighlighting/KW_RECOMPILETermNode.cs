...
{
    public class KW_RECOMPILETermNode : ITreeNode
    {
        ...
        public KW_RECOMPILETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_RECOMPILETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_RECOMPILETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
