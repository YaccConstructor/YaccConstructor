...
{
    public class Yard_exp_brackets_251NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_251NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_251NonTermNode (string s, object positions)
        {
            text = s;
