...
{
    public class Yard_exp_brackets_357NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_357NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_357NonTermNode (string s, object positions)
        {
            text = s;
