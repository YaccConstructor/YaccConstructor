...
{
    public class Highlight_LOGNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_LOGNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_LOGNonTermNode (string s, object positions)
        {
            text = s;
