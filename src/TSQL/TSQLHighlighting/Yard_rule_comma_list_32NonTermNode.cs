...
{
    public class Yard_rule_comma_list_32NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_32NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_32NonTermNode (string s, object positions)
        {
            text = s;
