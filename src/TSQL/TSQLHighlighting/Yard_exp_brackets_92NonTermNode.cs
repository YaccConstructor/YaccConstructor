...
{
    public class Yard_exp_brackets_92NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_92NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_92NonTermNode (string s, object positions)
        {
            text = s;
