...
{
    public class KW_OFFTermNode : ITreeNode
    {
        ...
        public KW_OFFTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OFFTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OFFTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
