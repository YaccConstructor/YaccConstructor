                ...
                |> List.mapi 
                    (fun i elem -> 
                        if elem.omit then 
                            ...
                            let binding = Some <| new Source(sprintf "S%d" (i+1))
...
let buildAstSimple (ruleList: Rule<Source, Source> list)  = 
