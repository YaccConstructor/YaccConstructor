...
{
    public class Yard_exp_brackets_232NonTermNode : ITreeNode
    {
        ...
        public Yard_exp_brackets_232NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_exp_brackets_232NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_exp_brackets_232NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
