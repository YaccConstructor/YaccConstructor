...
{
    public class DOUBLE_COLONTermNode : ITreeNode
    {
        ...
        public DOUBLE_COLONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public DOUBLE_COLONTermNode (string ycTokName, string ycValue)
        {
        ...
        public DOUBLE_COLONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
