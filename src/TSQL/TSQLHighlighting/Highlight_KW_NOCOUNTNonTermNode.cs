...
{
    public class Highlight_KW_NOCOUNTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NOCOUNTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NOCOUNTNonTermNode (string s, object positions)
        {
            text = s;
