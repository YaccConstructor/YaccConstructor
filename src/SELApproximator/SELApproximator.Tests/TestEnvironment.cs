...
{
    /// <summary>
    /// Black copypaste from 
    /// https://github.com/xunit/resharper-xunit/blob/ebfa811835e32935387e28f9040d52fd6562a465/resharper/test/src/tests/AcceptanceTests/TestEnvironment.9.1.cs
    /// </summary>
    [SetUpFixture]
    public class TestEnvironmentAssembly : ExtensionTestEnvironmentAssembly<ITestsZone>
    {
        ...
        protected override JetHostItems.Packages CreateJetHostPackages(JetHostItems.Engine engine)
        {
            ...
            {
                //RelativePath relativeTestDataPath = TestUtil.GetTestDataPathBase_Find_FromAttr(mainAssembly) ?? TestUtil.DefaultTestDataPath;
                ...
                //Commented three lines above are equivavent this method
