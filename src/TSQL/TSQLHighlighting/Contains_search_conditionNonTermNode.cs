...
{
    public class Contains_search_conditionNonTermNode : ITreeNode
    {
        ...
        public Contains_search_conditionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Contains_search_conditionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Contains_search_conditionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
