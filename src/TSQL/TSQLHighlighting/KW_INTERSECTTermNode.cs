...
{
    public class KW_INTERSECTTermNode : ITreeNode
    {
        ...
        public KW_INTERSECTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_INTERSECTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_INTERSECTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
