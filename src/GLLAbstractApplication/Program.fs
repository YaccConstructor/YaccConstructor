...
let run () =
    ...
    let il = ref <| fe.ParseGrammar(@"C:\Users\User\recursive-ascent\src\GLLAbstractApplication\forSle.yrd")
...
let inputGraph =
    ...
    qGraph.AddVerticesAndEdgeRange
            [edg 0 0 (GLL.SimpleAmb.B  3)
             edg 0 1 (GLL.SimpleAmb.RNGLR_EOF 8)
             ] |> ignore
