...
{
    public class KW_PLANTermNode : ITreeNode
    {
        ...
        public KW_PLANTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PLANTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PLANTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
