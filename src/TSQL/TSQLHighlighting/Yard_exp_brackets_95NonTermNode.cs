...
{
    public class Yard_exp_brackets_95NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_95NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_95NonTermNode (string s, object positions)
        {
            text = s;
