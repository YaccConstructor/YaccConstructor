...
{
    public class Yard_exp_brackets_166NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_166NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_166NonTermNode (string s, object positions)
        {
            text = s;
