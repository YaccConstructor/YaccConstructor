...
{
    public class Highlight_KW_OPENDATASOURCENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OPENDATASOURCENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OPENDATASOURCENonTermNode (string s, object positions)
        {
            text = s;
