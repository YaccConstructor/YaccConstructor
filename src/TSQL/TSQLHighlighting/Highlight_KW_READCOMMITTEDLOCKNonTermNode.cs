...
{
    public class Highlight_KW_READCOMMITTEDLOCKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_READCOMMITTEDLOCKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_READCOMMITTEDLOCKNonTermNode (string s, object positions)
        {
            text = s;
