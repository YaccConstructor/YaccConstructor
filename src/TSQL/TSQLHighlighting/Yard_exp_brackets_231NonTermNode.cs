...
{
    public class Yard_exp_brackets_231NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_231NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_231NonTermNode (string s, object positions)
        {
            text = s;
