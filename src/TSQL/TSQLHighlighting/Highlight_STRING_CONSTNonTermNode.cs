...
{
    public class Highlight_STRING_CONSTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_STRING_CONSTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_STRING_CONSTNonTermNode (string s, object positions)
        {
            text = s;
