...
{
    public class ForNonTermNode : ITreeNode
    {
        ...
        public ForNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ForNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public ForNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
