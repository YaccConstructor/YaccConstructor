...
{
    public class Unpivoted_tableNonTermNode : IAbstractTreeNode
    {
        ...
        public Unpivoted_tableNonTermNode (string s)
        {
            text = s;
        }

        public Unpivoted_tableNonTermNode (string s, object positions)
        {
            text = s;
