...
{
    public class KW_MAXDOPTermNode : ITreeNode
    {
        ...
        public KW_MAXDOPTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MAXDOPTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MAXDOPTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
