...
{
    public class Yard_exp_brackets_297NonTermNode : ITreeNode
    {
        ...
        public Yard_exp_brackets_297NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_exp_brackets_297NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_exp_brackets_297NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
