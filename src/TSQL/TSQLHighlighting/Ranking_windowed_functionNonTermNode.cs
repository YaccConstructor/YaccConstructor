...
{
    public class Ranking_windowed_functionNonTermNode : ITreeNode
    {
        ...
        public Ranking_windowed_functionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Ranking_windowed_functionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Ranking_windowed_functionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
