...
{
    public class Highlight_KW_REMOTENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_REMOTENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_REMOTENonTermNode (string s, object positions)
        {
            text = s;
