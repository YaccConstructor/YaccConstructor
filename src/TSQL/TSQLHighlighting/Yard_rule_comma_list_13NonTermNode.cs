...
{
    public class Yard_rule_comma_list_13NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_13NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_13NonTermNode (string s, object positions)
        {
            text = s;
