...
{
    public class Ignore_dup_keyLitNode : ITreeNode
    {
        ...
        public Ignore_dup_keyLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Ignore_dup_keyLitNode (string ycTokName, string ycValue)
        {
        ...
        public Ignore_dup_keyLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
