...
{
    public class Highlight_KW_BASE64NonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BASE64NonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BASE64NonTermNode (string s, object positions)
        {
            text = s;
