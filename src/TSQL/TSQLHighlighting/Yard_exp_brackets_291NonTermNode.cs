...
{
    public class Yard_exp_brackets_291NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_291NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_291NonTermNode (string s, object positions)
        {
            text = s;
