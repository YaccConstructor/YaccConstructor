...
{
    public class Yard_exp_brackets_393NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_393NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_393NonTermNode (string s, object positions)
        {
            text = s;
