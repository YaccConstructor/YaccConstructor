...
{
    public class Highlight_KW_TIMENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TIMENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TIMENonTermNode (string s, object positions)
        {
            text = s;
