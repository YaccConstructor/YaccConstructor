...
{
    public class Yard_exp_brackets_416NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_416NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_416NonTermNode (string s, object positions)
        {
            text = s;
