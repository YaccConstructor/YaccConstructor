...
{
    public class KW_IMPLICIT_TRANSACTIONSTermNode : ITreeNode
    {
        ...
        public KW_IMPLICIT_TRANSACTIONSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_IMPLICIT_TRANSACTIONSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_IMPLICIT_TRANSACTIONSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
