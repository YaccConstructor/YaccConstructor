...
{
    public class KW_INNERTermNode : ITreeNode
    {
        ...
        public KW_INNERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_INNERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_INNERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
