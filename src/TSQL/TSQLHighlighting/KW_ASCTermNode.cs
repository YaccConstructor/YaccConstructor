...
{
    public class KW_ASCTermNode : ITreeNode
    {
        ...
        public KW_ASCTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ASCTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ASCTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
