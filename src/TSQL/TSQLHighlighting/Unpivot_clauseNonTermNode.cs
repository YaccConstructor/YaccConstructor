...
{
    public class Unpivot_clauseNonTermNode : IAbstractTreeNode
    {
        ...
        public Unpivot_clauseNonTermNode (string s)
        {
            text = s;
        }

        public Unpivot_clauseNonTermNode (string s, object positions)
        {
            text = s;
