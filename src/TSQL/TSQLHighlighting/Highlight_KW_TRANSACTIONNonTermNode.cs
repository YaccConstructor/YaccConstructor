...
{
    public class Highlight_KW_TRANSACTIONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TRANSACTIONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TRANSACTIONNonTermNode (string s, object positions)
        {
            text = s;
