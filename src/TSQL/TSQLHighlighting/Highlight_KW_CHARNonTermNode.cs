...
{
    public class Highlight_KW_CHARNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CHARNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CHARNonTermNode (string s, object positions)
        {
            text = s;
