...
{
    public class KW_NUMERIC_ROUNDABORTTermNode : IAbstractTreeNode
    {
        ...
        public KW_NUMERIC_ROUNDABORTTermNode (string s)
        {
            text = s;
        }

        public KW_NUMERIC_ROUNDABORTTermNode (string s, object positions)
        {
            text = s;
