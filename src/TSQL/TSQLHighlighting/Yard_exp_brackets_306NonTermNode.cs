...
{
    public class Yard_exp_brackets_306NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_306NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_306NonTermNode (string s, object positions)
        {
            text = s;
