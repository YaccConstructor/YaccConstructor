...
{
    public class KW_ORTermNode : ITreeNode
    {
        ...
        public KW_ORTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ORTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ORTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
