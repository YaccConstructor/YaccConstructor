...
{
    public class KW_COMPUTETermNode : ITreeNode
    {
        ...
        public KW_COMPUTETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_COMPUTETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_COMPUTETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
