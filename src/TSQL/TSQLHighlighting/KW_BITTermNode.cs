...
{
    public class KW_BITTermNode : ITreeNode
    {
        ...
        public KW_BITTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BITTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BITTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
