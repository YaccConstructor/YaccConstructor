...
{
    public class Highlight_KW_BROWSENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BROWSENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BROWSENonTermNode (string s, object positions)
        {
            text = s;
