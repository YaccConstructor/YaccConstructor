...
{
    public class Highlight_KW_COMMITNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_COMMITNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_COMMITNonTermNode (string s, object positions)
        {
            text = s;
