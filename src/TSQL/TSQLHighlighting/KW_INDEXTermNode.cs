...
{
    public class KW_INDEXTermNode : ITreeNode
    {
        ...
        public KW_INDEXTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_INDEXTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_INDEXTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
