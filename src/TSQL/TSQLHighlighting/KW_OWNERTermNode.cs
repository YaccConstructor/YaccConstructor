...
{
    public class KW_OWNERTermNode : ITreeNode
    {
        ...
        public KW_OWNERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OWNERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OWNERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
