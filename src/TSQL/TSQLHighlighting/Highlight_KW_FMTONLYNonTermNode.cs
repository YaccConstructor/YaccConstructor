...
{
    public class Highlight_KW_FMTONLYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FMTONLYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FMTONLYNonTermNode (string s, object positions)
        {
            text = s;
