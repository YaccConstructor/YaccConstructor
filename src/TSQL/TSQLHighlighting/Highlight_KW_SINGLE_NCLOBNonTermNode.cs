...
{
    public class Highlight_KW_SINGLE_NCLOBNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SINGLE_NCLOBNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SINGLE_NCLOBNonTermNode (string s, object positions)
        {
            text = s;
