...
{
    public class Highlight_KW_FLOATNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FLOATNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FLOATNonTermNode (string s, object positions)
        {
            text = s;
