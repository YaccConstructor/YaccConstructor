...
{
    public class Yard_rule_comma_list_73NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_73NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_73NonTermNode (string s, object positions)
        {
            text = s;
