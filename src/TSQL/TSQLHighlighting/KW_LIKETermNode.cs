...
{
    public class KW_LIKETermNode : ITreeNode
    {
        ...
        public KW_LIKETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LIKETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LIKETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
