...
{
    public class Yard_rule_yard_many_1_49NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_49NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_49NonTermNode (string s, object positions)
        {
            text = s;
