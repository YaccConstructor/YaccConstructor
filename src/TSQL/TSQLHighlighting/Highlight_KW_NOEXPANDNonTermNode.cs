...
{
    public class Highlight_KW_NOEXPANDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NOEXPANDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NOEXPANDNonTermNode (string s, object positions)
        {
            text = s;
