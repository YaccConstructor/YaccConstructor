...
{
    public class Yard_exp_brackets_233NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_233NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_233NonTermNode (string s, object positions)
        {
            text = s;
