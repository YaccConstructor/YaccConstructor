...
{
    public class Highlight_KW_NONonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NONonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NONonTermNode (string s, object positions)
        {
            text = s;
