...
{
    public class Highlight_KW_ABSENTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ABSENTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ABSENTNonTermNode (string s, object positions)
        {
            text = s;
