...
let website = "/YaccConstructor"

let githubLink = "http://github.com/YaccConstructor/YaccConstructor"

// Specify more information about your project
let info =
  [ "project-name", "YaccConstructor"
    "project-author", "YaccConstructor software foundation"
    "project-summary", "Platform for parser generators and other grammarware research and development."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/YaccConstructor" ]
...
let binaries =
    ...
    let conventionBased = 
        ...
        |> subDirectories
        |> Array.map (fun d -> bin @@ (sprintf "Release/v40/YC.%s.dll" d.Name))
        |> List.ofArray
