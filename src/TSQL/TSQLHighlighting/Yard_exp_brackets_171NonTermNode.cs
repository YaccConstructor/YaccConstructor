...
{
    public class Yard_exp_brackets_171NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_171NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_171NonTermNode (string s, object positions)
        {
            text = s;
