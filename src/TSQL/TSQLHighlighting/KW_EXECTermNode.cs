...
{
    public class KW_EXECTermNode : ITreeNode
    {
        ...
        public KW_EXECTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_EXECTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_EXECTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
