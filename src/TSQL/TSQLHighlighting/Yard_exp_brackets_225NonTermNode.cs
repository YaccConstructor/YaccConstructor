...
{
    public class Yard_exp_brackets_225NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_225NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_225NonTermNode (string s, object positions)
        {
            text = s;
