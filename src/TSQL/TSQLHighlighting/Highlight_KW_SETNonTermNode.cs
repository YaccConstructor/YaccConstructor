...
{
    public class Highlight_KW_SETNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SETNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SETNonTermNode (string s, object positions)
        {
            text = s;
