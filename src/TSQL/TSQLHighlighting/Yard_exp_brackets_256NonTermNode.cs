...
{
    public class Yard_exp_brackets_256NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_256NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_256NonTermNode (string s, object positions)
        {
            text = s;
