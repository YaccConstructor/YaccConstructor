...
{
    public class KW_ROWS_PER_BATCHTermNode : IAbstractTreeNode
    {
        ...
        public KW_ROWS_PER_BATCHTermNode (string s)
        {
            text = s;
        }

        public KW_ROWS_PER_BATCHTermNode (string s, object positions)
        {
            text = s;
