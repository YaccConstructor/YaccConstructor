...
{
    public class Commit_transactionNonTermNode : IAbstractTreeNode
    {
        ...
        public Commit_transactionNonTermNode (string s)
        {
            text = s;
        }

        public Commit_transactionNonTermNode (string s, object positions)
        {
            text = s;
