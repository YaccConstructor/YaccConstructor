...
{
    public class KW_SCALAR_DATA_TYPETermNode : IAbstractTreeNode
    {
        ...
        public KW_SCALAR_DATA_TYPETermNode (string s)
        {
            text = s;
        }

        public KW_SCALAR_DATA_TYPETermNode (string s, object positions)
        {
            text = s;
