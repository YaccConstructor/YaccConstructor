...
{
    public class Yard_exp_brackets_392NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_392NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_392NonTermNode (string s, object positions)
        {
            text = s;
