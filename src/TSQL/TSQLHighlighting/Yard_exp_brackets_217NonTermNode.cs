...
{
    public class Yard_exp_brackets_217NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_217NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_217NonTermNode (string s, object positions)
        {
            text = s;
