...
{
    public class Highlight_KW_OFNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OFNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OFNonTermNode (string s, object positions)
        {
            text = s;
