...
{
    public class KW_NOEXECTermNode : ITreeNode
    {
        ...
        public KW_NOEXECTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NOEXECTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NOEXECTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
