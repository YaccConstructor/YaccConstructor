...
{
    public class Highlight_GLOBALVARNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_GLOBALVARNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_GLOBALVARNonTermNode (string s, object positions)
        {
            text = s;
