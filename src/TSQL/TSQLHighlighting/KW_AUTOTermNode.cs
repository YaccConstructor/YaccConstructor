...
{
    public class KW_AUTOTermNode : ITreeNode
    {
        ...
        public KW_AUTOTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_AUTOTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_AUTOTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
