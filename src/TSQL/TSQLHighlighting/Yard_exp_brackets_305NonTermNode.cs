...
{
    public class Yard_exp_brackets_305NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_305NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_305NonTermNode (string s, object positions)
        {
            text = s;
