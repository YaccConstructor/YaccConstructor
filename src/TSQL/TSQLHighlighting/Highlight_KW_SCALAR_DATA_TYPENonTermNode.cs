...
{
    public class Highlight_KW_SCALAR_DATA_TYPENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SCALAR_DATA_TYPENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SCALAR_DATA_TYPENonTermNode (string s, object positions)
        {
            text = s;
