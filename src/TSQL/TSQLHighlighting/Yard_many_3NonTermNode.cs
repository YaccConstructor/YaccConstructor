...
{
    public class Yard_many_3NonTermNode : ITreeNode
    {
        ...
        public Yard_many_3NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_many_3NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_many_3NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
