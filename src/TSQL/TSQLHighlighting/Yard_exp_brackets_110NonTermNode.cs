...
{
    public class Yard_exp_brackets_110NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_110NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_110NonTermNode (string s, object positions)
        {
            text = s;
