...
{
    public class Proc_formal_paramNonTermNode : ITreeNode
    {
        ...
        public Proc_formal_paramNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Proc_formal_paramNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Proc_formal_paramNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
