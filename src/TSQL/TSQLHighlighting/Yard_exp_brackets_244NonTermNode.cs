...
{
    public class Yard_exp_brackets_244NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_244NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_244NonTermNode (string s, object positions)
        {
            text = s;
