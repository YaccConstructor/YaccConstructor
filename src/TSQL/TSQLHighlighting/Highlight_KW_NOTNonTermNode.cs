...
{
    public class Highlight_KW_NOTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NOTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NOTNonTermNode (string s, object positions)
        {
            text = s;
