...
{
    public class Yard_exp_brackets_370NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_370NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_370NonTermNode (string s, object positions)
        {
            text = s;
