...
{
    public class Proximity_termNonTermNode : ITreeNode
    {
        ...
        public Proximity_termNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Proximity_termNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Proximity_termNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
