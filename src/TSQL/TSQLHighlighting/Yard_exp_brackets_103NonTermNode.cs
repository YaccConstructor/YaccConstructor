...
{
    public class Yard_exp_brackets_103NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_103NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_103NonTermNode (string s, object positions)
        {
            text = s;
