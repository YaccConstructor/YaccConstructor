...
{
    public class Highlight_DOUBLE_COLONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_DOUBLE_COLONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_DOUBLE_COLONNonTermNode (string s, object positions)
        {
            text = s;
