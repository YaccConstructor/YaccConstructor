...
{
    public class Yard_exp_brackets_404NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_404NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_404NonTermNode (string s, object positions)
        {
            text = s;
