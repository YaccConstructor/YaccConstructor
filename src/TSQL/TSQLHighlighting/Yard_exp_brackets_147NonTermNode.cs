...
{
    public class Yard_exp_brackets_147NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_147NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_147NonTermNode (string s, object positions)
        {
            text = s;
