...
{
    public class Highlight_KW_DESCNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DESCNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DESCNonTermNode (string s, object positions)
        {
            text = s;
