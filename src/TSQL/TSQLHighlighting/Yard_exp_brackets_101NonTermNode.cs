...
{
    public class Yard_exp_brackets_101NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_101NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_101NonTermNode (string s, object positions)
        {
            text = s;
