...
{
    public class KW_OVERTermNode : ITreeNode
    {
        ...
        public KW_OVERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OVERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OVERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
