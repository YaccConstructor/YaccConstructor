...
{
    public class Yard_rule_comma_list_41NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_41NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_41NonTermNode (string s, object positions)
        {
            text = s;
