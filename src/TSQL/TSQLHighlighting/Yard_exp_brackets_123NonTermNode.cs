...
{
    public class Yard_exp_brackets_123NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_123NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_123NonTermNode (string s, object positions)
        {
            text = s;
