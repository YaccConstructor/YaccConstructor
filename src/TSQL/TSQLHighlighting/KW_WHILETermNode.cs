...
{
    public class KW_WHILETermNode : ITreeNode
    {
        ...
        public KW_WHILETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_WHILETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_WHILETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
