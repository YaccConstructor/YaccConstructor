...
{
    public class RBRACETermNode : ITreeNode
    {
        ...
        public RBRACETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public RBRACETermNode (string ycTokName, string ycValue)
        {
        ...
        public RBRACETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
