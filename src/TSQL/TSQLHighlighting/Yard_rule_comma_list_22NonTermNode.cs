...
{
    public class Yard_rule_comma_list_22NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_22NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_22NonTermNode (string s, object positions)
        {
            text = s;
