...
{
    public class Yard_exp_brackets_186NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_186NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_186NonTermNode (string s, object positions)
        {
            text = s;
