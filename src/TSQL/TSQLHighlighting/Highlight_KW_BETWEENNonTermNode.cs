...
{
    public class Highlight_KW_BETWEENNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BETWEENNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BETWEENNonTermNode (string s, object positions)
        {
            text = s;
