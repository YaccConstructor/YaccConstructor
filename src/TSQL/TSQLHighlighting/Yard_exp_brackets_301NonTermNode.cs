...
{
    public class Yard_exp_brackets_301NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_301NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_301NonTermNode (string s, object positions)
        {
            text = s;
