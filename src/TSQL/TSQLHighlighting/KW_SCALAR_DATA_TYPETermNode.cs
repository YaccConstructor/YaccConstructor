...
{
    public class KW_SCALAR_DATA_TYPETermNode : ITreeNode
    {
        ...
        public KW_SCALAR_DATA_TYPETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SCALAR_DATA_TYPETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SCALAR_DATA_TYPETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
