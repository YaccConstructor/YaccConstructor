namespace Yard.Generators.OldGLL
...
open PrintTable
open Yard.Generators.OldGLL.TranslatorPrinter2
open Option
...
type GLLOld() = 
    inherit Generator()
        ...
        override this.Generate (definition, _,args) =
            ...
            box ()
        override this.Generate(definition,isSomething) = this.Generate (definition, isSomething, "")