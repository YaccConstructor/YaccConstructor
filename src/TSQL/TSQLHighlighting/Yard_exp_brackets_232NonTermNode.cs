...
{
    public class Yard_exp_brackets_232NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_232NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_232NonTermNode (string s, object positions)
        {
            text = s;
