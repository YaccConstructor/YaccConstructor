...
{
    public class Highlight_KW_ANYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ANYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ANYNonTermNode (string s, object positions)
        {
            text = s;
