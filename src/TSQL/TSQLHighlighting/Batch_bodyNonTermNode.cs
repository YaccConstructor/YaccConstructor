...
{
    public class Batch_bodyNonTermNode : ITreeNode
    {
        ...
        public Batch_bodyNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Batch_bodyNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Batch_bodyNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
