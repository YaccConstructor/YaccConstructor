...
{
    public class Yard_exp_brackets_176NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_176NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_176NonTermNode (string s, object positions)
        {
            text = s;
