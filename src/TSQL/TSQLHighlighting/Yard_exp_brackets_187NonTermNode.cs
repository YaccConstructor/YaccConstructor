...
{
    public class Yard_exp_brackets_187NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_187NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_187NonTermNode (string s, object positions)
        {
            text = s;
