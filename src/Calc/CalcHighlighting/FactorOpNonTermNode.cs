...
{
    public class FactorOpNonTermNode : ITreeNode
    {
        ...
        public FactorOpNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public FactorOpNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public FactorOpNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
