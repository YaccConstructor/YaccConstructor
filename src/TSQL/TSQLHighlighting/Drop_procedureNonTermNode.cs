...
{
    public class Drop_procedureNonTermNode : IAbstractTreeNode
    {
        ...
        public Drop_procedureNonTermNode (string s)
        {
            text = s;
        }

        public Drop_procedureNonTermNode (string s, object positions)
        {
            text = s;
