...
{
    public class Yard_exp_brackets_234NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_234NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_234NonTermNode (string s, object positions)
        {
            text = s;
