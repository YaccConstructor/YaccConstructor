...
{
    public class Yard_exp_brackets_346NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_346NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_346NonTermNode (string s, object positions)
        {
            text = s;
