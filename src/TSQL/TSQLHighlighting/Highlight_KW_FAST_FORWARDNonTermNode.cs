...
{
    public class Highlight_KW_FAST_FORWARDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FAST_FORWARDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FAST_FORWARDNonTermNode (string s, object positions)
        {
            text = s;
