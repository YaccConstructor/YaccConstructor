...
{
    public class OpenLitNode : ITreeNode
    {
        ...
        public OpenLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public OpenLitNode (string ycTokName, string ycValue)
        {
        ...
        public OpenLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
