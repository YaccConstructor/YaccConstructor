...
{
    public class FromNonTermNode : ITreeNode
    {
        ...
        public FromNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public FromNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public FromNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
