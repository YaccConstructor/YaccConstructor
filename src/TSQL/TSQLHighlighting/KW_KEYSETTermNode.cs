...
{
    public class KW_KEYSETTermNode : ITreeNode
    {
        ...
        public KW_KEYSETTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_KEYSETTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_KEYSETTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
