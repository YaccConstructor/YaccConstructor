...
{
    public class Yard_rule_yard_many_1_12NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_12NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_12NonTermNode (string s, object positions)
        {
            text = s;
