...
{
    public class Yard_exp_brackets_239NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_239NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_239NonTermNode (string s, object positions)
        {
            text = s;
