...
{
    public class KW_SQL_VARIANTTermNode : ITreeNode
    {
        ...
        public KW_SQL_VARIANTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SQL_VARIANTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SQL_VARIANTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
