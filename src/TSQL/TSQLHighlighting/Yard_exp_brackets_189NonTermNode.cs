...
{
    public class Yard_exp_brackets_189NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_189NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_189NonTermNode (string s, object positions)
        {
            text = s;
