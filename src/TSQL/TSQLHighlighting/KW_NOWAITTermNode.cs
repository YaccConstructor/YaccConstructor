...
{
    public class KW_NOWAITTermNode : ITreeNode
    {
        ...
        public KW_NOWAITTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NOWAITTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NOWAITTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
