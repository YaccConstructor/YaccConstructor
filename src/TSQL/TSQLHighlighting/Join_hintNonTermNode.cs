...
{
    public class Join_hintNonTermNode : ITreeNode
    {
        ...
        public Join_hintNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Join_hintNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Join_hintNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
