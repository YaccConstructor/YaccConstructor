...
{
    public class KW_READ_ONLYTermNode : ITreeNode
    {
        ...
        public KW_READ_ONLYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_READ_ONLYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_READ_ONLYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
