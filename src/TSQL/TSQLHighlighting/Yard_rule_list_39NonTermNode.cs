...
{
    public class Yard_rule_list_39NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_39NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_39NonTermNode (string s, object positions)
        {
            text = s;
