...
{
    public class Yard_exp_brackets_359NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_359NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_359NonTermNode (string s, object positions)
        {
            text = s;
