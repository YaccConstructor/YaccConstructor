...
{
    public class KW_IGNORE_DUP_KEYTermNode : ITreeNode
    {
        ...
        public KW_IGNORE_DUP_KEYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_IGNORE_DUP_KEYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_IGNORE_DUP_KEYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
