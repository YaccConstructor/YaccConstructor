...
{
    public class KW_FIRSTTermNode : ITreeNode
    {
        ...
        public KW_FIRSTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FIRSTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FIRSTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
