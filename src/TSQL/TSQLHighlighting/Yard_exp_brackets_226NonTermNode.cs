...
{
    public class Yard_exp_brackets_226NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_226NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_226NonTermNode (string s, object positions)
        {
            text = s;
