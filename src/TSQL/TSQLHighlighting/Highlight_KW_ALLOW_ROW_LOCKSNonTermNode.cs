...
{
    public class Highlight_KW_ALLOW_ROW_LOCKSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ALLOW_ROW_LOCKSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ALLOW_ROW_LOCKSNonTermNode (string s, object positions)
        {
            text = s;
