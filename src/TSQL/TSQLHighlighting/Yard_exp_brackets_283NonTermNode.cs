...
{
    public class Yard_exp_brackets_283NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_283NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_283NonTermNode (string s, object positions)
        {
            text = s;
