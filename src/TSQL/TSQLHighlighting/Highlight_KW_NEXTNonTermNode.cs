...
{
    public class Highlight_KW_NEXTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NEXTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NEXTNonTermNode (string s, object positions)
        {
            text = s;
