...
{
    public class KW_LESSTermNode : ITreeNode
    {
        ...
        public KW_LESSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LESSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LESSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
