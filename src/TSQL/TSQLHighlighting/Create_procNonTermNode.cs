...
{
    public class Create_procNonTermNode : ITreeNode
    {
        ...
        public Create_procNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Create_procNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Create_procNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
