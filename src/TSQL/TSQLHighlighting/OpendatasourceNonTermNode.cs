...
{
    public class OpendatasourceNonTermNode : IAbstractTreeNode
    {
        ...
        public OpendatasourceNonTermNode (string s)
        {
            text = s;
        }

        public OpendatasourceNonTermNode (string s, object positions)
        {
            text = s;
