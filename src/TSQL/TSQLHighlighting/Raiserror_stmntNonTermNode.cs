...
{
    public class Raiserror_stmntNonTermNode : ITreeNode
    {
        ...
        public Raiserror_stmntNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Raiserror_stmntNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Raiserror_stmntNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
