...
{
    public class Yard_exp_brackets_413NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_413NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_413NonTermNode (string s, object positions)
        {
            text = s;
