...
{
    public class Highlight_KW_GONonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_GONonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_GONonTermNode (string s, object positions)
        {
            text = s;
