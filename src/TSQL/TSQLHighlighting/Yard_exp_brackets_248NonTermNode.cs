...
{
    public class Yard_exp_brackets_248NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_248NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_248NonTermNode (string s, object positions)
        {
            text = s;
