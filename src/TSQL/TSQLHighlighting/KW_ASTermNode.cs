...
{
    public class KW_ASTermNode : ITreeNode
    {
        ...
        public KW_ASTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ASTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ASTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
