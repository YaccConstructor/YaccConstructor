...
{
    public class KW_ERRORFILETermNode : ITreeNode
    {
        ...
        public KW_ERRORFILETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ERRORFILETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ERRORFILETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
