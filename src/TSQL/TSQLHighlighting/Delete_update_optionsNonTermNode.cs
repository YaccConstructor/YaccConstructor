...
{
    public class Delete_update_optionsNonTermNode : IAbstractTreeNode
    {
        ...
        public Delete_update_optionsNonTermNode (string s)
        {
            text = s;
        }

        public Delete_update_optionsNonTermNode (string s, object positions)
        {
            text = s;
