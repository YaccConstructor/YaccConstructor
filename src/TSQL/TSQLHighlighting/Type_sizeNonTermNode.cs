...
{
    public class Type_sizeNonTermNode : ITreeNode
    {
        ...
        public Type_sizeNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Type_sizeNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Type_sizeNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
