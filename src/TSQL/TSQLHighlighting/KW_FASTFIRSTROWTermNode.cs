...
{
    public class KW_FASTFIRSTROWTermNode : ITreeNode
    {
        ...
        public KW_FASTFIRSTROWTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FASTFIRSTROWTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FASTFIRSTROWTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
