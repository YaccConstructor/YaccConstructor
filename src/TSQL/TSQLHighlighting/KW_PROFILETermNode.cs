...
{
    public class KW_PROFILETermNode : ITreeNode
    {
        ...
        public KW_PROFILETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PROFILETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PROFILETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
