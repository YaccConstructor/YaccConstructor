...
{
    public class KW_ROWLOCKTermNode : ITreeNode
    {
        ...
        public KW_ROWLOCKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROWLOCKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROWLOCKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
