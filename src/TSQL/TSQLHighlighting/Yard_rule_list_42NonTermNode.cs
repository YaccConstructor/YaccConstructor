...
{
    public class Yard_rule_list_42NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_42NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_42NonTermNode (string s, object positions)
        {
            text = s;
