...
{
    public class Yard_some_7NonTermNode : ITreeNode
    {
        ...
        public Yard_some_7NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_some_7NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_some_7NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
