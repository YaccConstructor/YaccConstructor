...
{
    public class Highlight_KW_ROLLBACKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROLLBACKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROLLBACKNonTermNode (string s, object positions)
        {
            text = s;
