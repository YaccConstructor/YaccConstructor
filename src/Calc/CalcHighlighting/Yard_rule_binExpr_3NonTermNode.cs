...
{
    public class Yard_rule_binExpr_3NonTermNode : ITreeNode
    {
        ...
        public Yard_rule_binExpr_3NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_rule_binExpr_3NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_rule_binExpr_3NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
