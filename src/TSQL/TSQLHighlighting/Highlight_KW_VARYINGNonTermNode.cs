...
{
    public class Highlight_KW_VARYINGNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_VARYINGNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_VARYINGNonTermNode (string s, object positions)
        {
            text = s;
