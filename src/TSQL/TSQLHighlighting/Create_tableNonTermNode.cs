...
{
    public class Create_tableNonTermNode : ITreeNode
    {
        ...
        public Create_tableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Create_tableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Create_tableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
