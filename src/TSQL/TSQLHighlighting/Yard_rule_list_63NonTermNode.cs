...
{
    public class Yard_rule_list_63NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_63NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_63NonTermNode (string s, object positions)
        {
            text = s;
