...
{
    public class KW_BYTermNode : ITreeNode
    {
        ...
        public KW_BYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
