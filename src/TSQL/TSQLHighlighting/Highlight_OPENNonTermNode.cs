...
{
    public class Highlight_OPENNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_OPENNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_OPENNonTermNode (string s, object positions)
        {
            text = s;
