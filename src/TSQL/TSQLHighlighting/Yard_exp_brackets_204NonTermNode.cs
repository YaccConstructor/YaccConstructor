...
{
    public class Yard_exp_brackets_204NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_204NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_204NonTermNode (string s, object positions)
        {
            text = s;
