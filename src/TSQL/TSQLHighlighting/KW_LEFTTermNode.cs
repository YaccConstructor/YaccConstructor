...
{
    public class KW_LEFTTermNode : ITreeNode
    {
        ...
        public KW_LEFTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LEFTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LEFTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
