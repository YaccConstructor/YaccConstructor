...
{
    public class Yard_exp_brackets_102NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_102NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_102NonTermNode (string s, object positions)
        {
            text = s;
