...
{
    public class KW_ESCAPETermNode : ITreeNode
    {
        ...
        public KW_ESCAPETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ESCAPETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ESCAPETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
