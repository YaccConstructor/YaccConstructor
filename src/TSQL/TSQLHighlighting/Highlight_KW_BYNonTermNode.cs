...
{
    public class Highlight_KW_BYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BYNonTermNode (string s, object positions)
        {
            text = s;
