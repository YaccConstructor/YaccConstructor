...
{
    public class Yard_exp_brackets_288NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_288NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_288NonTermNode (string s, object positions)
        {
            text = s;
