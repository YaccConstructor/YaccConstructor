...
{
    public class FreetexttableNonTermNode : IAbstractTreeNode
    {
        ...
        public FreetexttableNonTermNode (string s)
        {
            text = s;
        }

        public FreetexttableNonTermNode (string s, object positions)
        {
            text = s;
