...
{
    public class Highlight_KW_NULLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NULLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NULLNonTermNode (string s, object positions)
        {
            text = s;
