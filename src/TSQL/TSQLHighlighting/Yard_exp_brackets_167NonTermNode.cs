...
{
    public class Yard_exp_brackets_167NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_167NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_167NonTermNode (string s, object positions)
        {
            text = s;
