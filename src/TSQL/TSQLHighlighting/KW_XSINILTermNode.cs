...
{
    public class KW_XSINILTermNode : ITreeNode
    {
        ...
        public KW_XSINILTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_XSINILTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_XSINILTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
