...
{
    public class KW_VARYINGTermNode : ITreeNode
    {
        ...
        public KW_VARYINGTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_VARYINGTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_VARYINGTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
