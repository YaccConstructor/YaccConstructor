...
{
    public class Yard_exp_brackets_414NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_414NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_414NonTermNode (string s, object positions)
        {
            text = s;
