...
{
    public class Yard_exp_brackets_180NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_180NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_180NonTermNode (string s, object positions)
        {
            text = s;
