...
{
    public class Highlight_KW_INDEXNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_INDEXNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_INDEXNonTermNode (string s, object positions)
        {
            text = s;
