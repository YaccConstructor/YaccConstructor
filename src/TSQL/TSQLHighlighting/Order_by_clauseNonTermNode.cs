...
{
    public class Order_by_clauseNonTermNode : ITreeNode
    {
        ...
        public Order_by_clauseNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Order_by_clauseNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Order_by_clauseNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
