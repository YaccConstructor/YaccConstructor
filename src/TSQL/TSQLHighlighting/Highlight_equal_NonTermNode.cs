...
{
    public class Highlight_equal_NonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_equal_NonTermNode (string s)
        {
            text = s;
        }

        public Highlight_equal_NonTermNode (string s, object positions)
        {
            text = s;
