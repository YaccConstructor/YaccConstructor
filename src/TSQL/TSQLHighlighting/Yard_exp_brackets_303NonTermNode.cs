...
{
    public class Yard_exp_brackets_303NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_303NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_303NonTermNode (string s, object positions)
        {
            text = s;
