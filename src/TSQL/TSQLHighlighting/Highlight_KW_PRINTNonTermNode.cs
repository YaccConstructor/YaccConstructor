...
{
    public class Highlight_KW_PRINTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PRINTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PRINTNonTermNode (string s, object positions)
        {
            text = s;
