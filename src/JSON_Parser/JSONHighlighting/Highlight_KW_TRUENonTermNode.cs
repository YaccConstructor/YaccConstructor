...
{
    public class Highlight_KW_TRUENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TRUENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TRUENonTermNode (string s, object positions)
        {
            text = s;
