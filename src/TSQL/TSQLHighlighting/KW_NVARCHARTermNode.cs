...
{
    public class KW_NVARCHARTermNode : ITreeNode
    {
        ...
        public KW_NVARCHARTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NVARCHARTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NVARCHARTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
