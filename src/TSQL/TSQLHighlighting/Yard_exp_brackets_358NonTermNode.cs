...
{
    public class Yard_exp_brackets_358NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_358NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_358NonTermNode (string s, object positions)
        {
            text = s;
