...
{
    public class Highlight_KW_INSERTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_INSERTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_INSERTNonTermNode (string s, object positions)
        {
            text = s;
