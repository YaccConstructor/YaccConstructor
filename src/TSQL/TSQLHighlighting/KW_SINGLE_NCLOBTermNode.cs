...
{
    public class KW_SINGLE_NCLOBTermNode : ITreeNode
    {
        ...
        public KW_SINGLE_NCLOBTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SINGLE_NCLOBTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SINGLE_NCLOBTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
