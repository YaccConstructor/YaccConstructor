...
{
    public class Yard_exp_brackets_228NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_228NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_228NonTermNode (string s, object positions)
        {
            text = s;
