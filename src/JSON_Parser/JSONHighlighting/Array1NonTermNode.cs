...
{
    public class Array1NonTermNode : ITreeNode
    {
        ...
        public Array1NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Array1NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Array1NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
