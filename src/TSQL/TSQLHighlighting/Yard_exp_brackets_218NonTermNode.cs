...
{
    public class Yard_exp_brackets_218NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_218NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_218NonTermNode (string s, object positions)
        {
            text = s;
