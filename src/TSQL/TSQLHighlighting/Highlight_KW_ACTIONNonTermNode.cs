...
{
    public class Highlight_KW_ACTIONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ACTIONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ACTIONNonTermNode (string s, object positions)
        {
            text = s;
