...
{
    public class Highlight_WEIGHTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_WEIGHTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_WEIGHTNonTermNode (string s, object positions)
        {
            text = s;
