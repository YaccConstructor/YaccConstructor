...
{
    public class Yard_exp_brackets_259NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_259NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_259NonTermNode (string s, object positions)
        {
            text = s;
