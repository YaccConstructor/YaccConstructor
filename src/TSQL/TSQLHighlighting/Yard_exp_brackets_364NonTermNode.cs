...
{
    public class Yard_exp_brackets_364NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_364NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_364NonTermNode (string s, object positions)
        {
            text = s;
