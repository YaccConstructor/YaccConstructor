...
{
    public class Highlight_KW_WHENNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_WHENNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_WHENNonTermNode (string s, object positions)
        {
            text = s;
