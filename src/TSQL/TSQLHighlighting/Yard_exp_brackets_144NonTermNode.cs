...
{
    public class Yard_exp_brackets_144NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_144NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_144NonTermNode (string s, object positions)
        {
            text = s;
