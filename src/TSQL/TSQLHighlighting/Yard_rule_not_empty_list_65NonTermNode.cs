...
{
    public class Yard_rule_not_empty_list_65NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_not_empty_list_65NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_not_empty_list_65NonTermNode (string s, object positions)
        {
            text = s;
