...
{
    public class Pivoted_tableNonTermNode : IAbstractTreeNode
    {
        ...
        public Pivoted_tableNonTermNode (string s)
        {
            text = s;
        }

        public Pivoted_tableNonTermNode (string s, object positions)
        {
            text = s;
