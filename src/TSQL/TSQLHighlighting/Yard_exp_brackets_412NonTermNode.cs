...
{
    public class Yard_exp_brackets_412NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_412NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_412NonTermNode (string s, object positions)
        {
            text = s;
