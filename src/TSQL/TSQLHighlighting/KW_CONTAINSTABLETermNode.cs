...
{
    public class KW_CONTAINSTABLETermNode : IAbstractTreeNode
    {
        ...
        public KW_CONTAINSTABLETermNode (string s)
        {
            text = s;
        }

        public KW_CONTAINSTABLETermNode (string s, object positions)
        {
            text = s;
