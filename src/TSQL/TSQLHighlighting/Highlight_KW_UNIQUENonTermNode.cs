...
{
    public class Highlight_KW_UNIQUENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_UNIQUENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_UNIQUENonTermNode (string s, object positions)
        {
            text = s;
