...
{
    public class Right_bracket_LitNode : ITreeNode
    {
        ...
        public Right_bracket_LitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Right_bracket_LitNode (string ycTokName, string ycValue)
        {
        ...
        public Right_bracket_LitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
