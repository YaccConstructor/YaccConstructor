...
{
    public class Yard_exp_brackets_298NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_298NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_298NonTermNode (string s, object positions)
        {
            text = s;
