...
{
    public class Highlight_KW_NUMERICNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NUMERICNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NUMERICNonTermNode (string s, object positions)
        {
            text = s;
