...
{
    public class Highlight_KW_LESSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LESSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LESSNonTermNode (string s, object positions)
        {
            text = s;
