...
{
    public class KW_ANDTermNode : ITreeNode
    {
        ...
        public KW_ANDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ANDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ANDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
