...
{
    public class Yard_exp_brackets_219NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_219NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_219NonTermNode (string s, object positions)
        {
            text = s;
