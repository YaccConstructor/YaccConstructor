...
{
    public class Yard_rule_yard_many_1_75NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_75NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_75NonTermNode (string s, object positions)
        {
            text = s;
