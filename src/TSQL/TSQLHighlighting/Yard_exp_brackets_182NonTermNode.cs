...
{
    public class Yard_exp_brackets_182NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_182NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_182NonTermNode (string s, object positions)
        {
            text = s;
