...
{
    public class Highlight_KW_EQUALNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_EQUALNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_EQUALNonTermNode (string s, object positions)
        {
            text = s;
