...
{
    public class KW_PRIMARYTermNode : ITreeNode
    {
        ...
        public KW_PRIMARYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PRIMARYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PRIMARYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
