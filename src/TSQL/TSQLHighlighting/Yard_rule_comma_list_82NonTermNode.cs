...
{
    public class Yard_rule_comma_list_82NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_82NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_82NonTermNode (string s, object positions)
        {
            text = s;
