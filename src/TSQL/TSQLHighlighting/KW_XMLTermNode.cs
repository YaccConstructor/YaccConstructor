...
{
    public class KW_XMLTermNode : ITreeNode
    {
        ...
        public KW_XMLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_XMLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_XMLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
