...
{
    public class Yard_rule_yard_many_1_69NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_69NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_69NonTermNode (string s, object positions)
        {
            text = s;
