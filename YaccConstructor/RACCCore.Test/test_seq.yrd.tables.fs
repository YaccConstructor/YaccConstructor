...
let private gotoSet = 
    Set.ofArray [|(("raccStart",0,"NUMBER"),Set.ofArray [|("s",1)|]);(("raccStart",0,"s"),Set.ofArray [|("raccStart",1)|]);(("raccStart",1,"Dummy"),Set.ofArray [|("raccStart",2)|]);(("s",0,"NUMBER"),Set.ofArray [|("s",1)|]);(("s",1,"PLUS"),Set.ofArray [|("s",2)|]);(("s",2,"NUMBER"),Set.ofArray [|("s",3)|]);(("s",3,"Dummy"),Set.ofArray [|("s",4)|])|]
    |> dict
