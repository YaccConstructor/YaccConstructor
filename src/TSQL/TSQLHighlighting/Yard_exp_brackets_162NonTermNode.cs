...
{
    public class Yard_exp_brackets_162NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_162NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_162NonTermNode (string s, object positions)
        {
            text = s;
