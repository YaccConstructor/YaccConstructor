...
{
    public class Highlight_KW_EXTRACTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_EXTRACTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_EXTRACTNonTermNode (string s, object positions)
        {
            text = s;
