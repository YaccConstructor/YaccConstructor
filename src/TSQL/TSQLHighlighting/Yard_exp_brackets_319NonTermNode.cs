...
{
    public class Yard_exp_brackets_319NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_319NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_319NonTermNode (string s, object positions)
        {
            text = s;
