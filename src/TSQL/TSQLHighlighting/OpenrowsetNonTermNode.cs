...
{
    public class OpenrowsetNonTermNode : ITreeNode
    {
        ...
        public OpenrowsetNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public OpenrowsetNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public OpenrowsetNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
