...
{
    public class Highlight_KW_DEFAULTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DEFAULTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DEFAULTNonTermNode (string s, object positions)
        {
            text = s;
