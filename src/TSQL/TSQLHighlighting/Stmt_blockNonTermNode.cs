...
{
    public class Stmt_blockNonTermNode : ITreeNode
    {
        ...
        public Stmt_blockNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Stmt_blockNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Stmt_blockNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
