...
{
    public class Yard_exp_brackets_255NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_255NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_255NonTermNode (string s, object positions)
        {
            text = s;
