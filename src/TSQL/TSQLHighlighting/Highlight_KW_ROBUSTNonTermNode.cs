...
{
    public class Highlight_KW_ROBUSTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROBUSTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROBUSTNonTermNode (string s, object positions)
        {
            text = s;
