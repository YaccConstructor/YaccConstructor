...
{
    public class Yard_exp_brackets_159NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_159NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_159NonTermNode (string s, object positions)
        {
            text = s;
