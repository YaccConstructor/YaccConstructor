...
{
    public class Highlight_KW_MINUTENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MINUTENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MINUTENonTermNode (string s, object positions)
        {
            text = s;
