...
{
    public class Yard_exp_brackets_136NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_136NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_136NonTermNode (string s, object positions)
        {
            text = s;
