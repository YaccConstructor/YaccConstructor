...
and _fslex_tokens  _fslex_state lexbuf =
  ...
  | 0 -> ( 
# 41 "Lexer_simple_braces_2.fsl"
                        MyLexeme( getTag T_LBR, LexBuffer<_>.LexemeString(lexbuf))
# 61 "Lexer_simple_braces_2.fs"
          )
  | 1 -> ( 
# 43 "Lexer_simple_braces_2.fsl"
                        MyLexeme( getTag T_RBR, LexBuffer<_>.LexemeString(lexbuf))
# 66 "Lexer_simple_braces_2.fs"
          )
  | 2 -> ( 
# 44 "Lexer_simple_braces_2.fsl"
                        MyLexeme( -1, LexBuffer<_>.LexemeString(lexbuf))
# 71 "Lexer_simple_braces_2.fs"
          )
  | _ -> failwith "tokens"

# 46 "Lexer_simple_braces_2.fsl"
...
# 3000000 "Lexer_simple_braces_2.fs"
