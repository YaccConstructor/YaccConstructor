...
{
    public class Yard_exp_brackets_221NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_221NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_221NonTermNode (string s, object positions)
        {
            text = s;
