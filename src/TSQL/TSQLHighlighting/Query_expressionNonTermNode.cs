...
{
    public class Query_expressionNonTermNode : IAbstractTreeNode
    {
        ...
        public Query_expressionNonTermNode (string s)
        {
            text = s;
        }

        public Query_expressionNonTermNode (string s, object positions)
        {
            text = s;
