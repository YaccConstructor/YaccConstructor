...
{
    public class KW_FREETEXTTABLETermNode : IAbstractTreeNode
    {
        ...
        public KW_FREETEXTTABLETermNode (string s)
        {
            text = s;
        }

        public KW_FREETEXTTABLETermNode (string s, object positions)
        {
            text = s;
