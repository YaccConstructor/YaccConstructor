...
{
    public class KW_ANSI_WARNINGSTermNode : ITreeNode
    {
        ...
        public KW_ANSI_WARNINGSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ANSI_WARNINGSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ANSI_WARNINGSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
