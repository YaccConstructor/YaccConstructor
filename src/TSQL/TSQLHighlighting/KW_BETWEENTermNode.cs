...
{
    public class KW_BETWEENTermNode : ITreeNode
    {
        ...
        public KW_BETWEENTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BETWEENTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BETWEENTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
