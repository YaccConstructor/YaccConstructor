...
namespace YC.ReSharper.AbstractAnalysis.Plugin.GraphCodeWindow
{
    ...
    //    private YC.AbstractAnalysis.Helper.ReSharperHelper _processor;
    //}

    
    //public class LoadGraphEventArgs : EventArgs
    //{
    //    public LoadGraphEventArgs(YC.AbstractAnalysis.Helper.ReSharperHelper processor)
    //    {
    //        this.Processor = processor;
    //    }

    //    public YC.AbstractAnalysis.Helper.ReSharperHelper Processor { get; private set; }
    //}
}
