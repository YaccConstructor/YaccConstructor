...
{
    public class Highlight_PLUSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_PLUSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_PLUSNonTermNode (string s, object positions)
        {
            text = s;
