...
{
    public class Yard_rule_comma_list_88NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_88NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_88NonTermNode (string s, object positions)
        {
            text = s;
