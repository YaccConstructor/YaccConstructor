...
{
    public class Highlight_KW_FULLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FULLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FULLNonTermNode (string s, object positions)
        {
            text = s;
