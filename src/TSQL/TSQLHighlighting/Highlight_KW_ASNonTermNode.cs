...
{
    public class Highlight_KW_ASNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ASNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ASNonTermNode (string s, object positions)
        {
            text = s;
