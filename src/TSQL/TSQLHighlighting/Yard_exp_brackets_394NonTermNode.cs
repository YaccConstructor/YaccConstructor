...
{
    public class Yard_exp_brackets_394NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_394NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_394NonTermNode (string s, object positions)
        {
            text = s;
