...
{
    public class KW_ROWS_PER_BATCHTermNode : ITreeNode
    {
        ...
        public KW_ROWS_PER_BATCHTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROWS_PER_BATCHTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROWS_PER_BATCHTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
