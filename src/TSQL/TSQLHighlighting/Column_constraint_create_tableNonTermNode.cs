...
{
    public class Column_constraint_create_tableNonTermNode : ITreeNode
    {
        ...
        public Column_constraint_create_tableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Column_constraint_create_tableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Column_constraint_create_tableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
