...
{
    public class Search_conditionNonTermNode : ITreeNode
    {
        ...
        public Search_conditionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Search_conditionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Search_conditionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
