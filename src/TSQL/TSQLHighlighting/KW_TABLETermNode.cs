...
{
    public class KW_TABLETermNode : ITreeNode
    {
        ...
        public KW_TABLETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TABLETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TABLETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
