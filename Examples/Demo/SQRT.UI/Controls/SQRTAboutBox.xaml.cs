...
namespace SQRT.UI.Controls
{
    /// <summary>
    /// Interaction logic for SQRTAboutBox.xaml
    /// </summary>
    public partial class SQRTAboutBox : Window
    {
        /// <summary>
        /// Default constructor is protected so callers must use one with a parent.
        /// </summary>
        protected SQRTAboutBox()
        {
            InitializeComponent();
        }

        /// <summary>
        /// Constructor that takes a parent for this SQRTAboutBox dialog.
        /// </summary>
        /// <param name="parent">Parent window for this dialog.</param>
        public SQRTAboutBox(Window parent)
            : this()
        {
            this.Owner = parent;
        }
