...
{
    public class Yard_exp_brackets_121NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_121NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_121NonTermNode (string s, object positions)
        {
            text = s;
