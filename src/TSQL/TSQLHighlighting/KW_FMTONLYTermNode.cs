...
{
    public class KW_FMTONLYTermNode : ITreeNode
    {
        ...
        public KW_FMTONLYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FMTONLYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FMTONLYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
