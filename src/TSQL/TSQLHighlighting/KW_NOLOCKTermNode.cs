...
{
    public class KW_NOLOCKTermNode : ITreeNode
    {
        ...
        public KW_NOLOCKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NOLOCKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NOLOCKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
