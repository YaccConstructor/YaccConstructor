...
{
    public class Yard_exp_brackets_154NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_154NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_154NonTermNode (string s, object positions)
        {
            text = s;
