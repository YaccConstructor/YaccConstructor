...
{
    public class Highlight_KW_PERSISTEDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PERSISTEDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PERSISTEDNonTermNode (string s, object positions)
        {
            text = s;
