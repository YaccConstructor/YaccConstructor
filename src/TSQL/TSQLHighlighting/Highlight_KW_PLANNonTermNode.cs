...
{
    public class Highlight_KW_PLANNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PLANNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PLANNonTermNode (string s, object positions)
        {
            text = s;
