...
{
    public class Yard_exp_brackets_174NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_174NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_174NonTermNode (string s, object positions)
        {
            text = s;
