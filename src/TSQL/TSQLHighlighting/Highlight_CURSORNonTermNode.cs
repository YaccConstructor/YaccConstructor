...
{
    public class Highlight_CURSORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_CURSORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_CURSORNonTermNode (string s, object positions)
        {
            text = s;
