...
{
    public class KW_REMOTETermNode : ITreeNode
    {
        ...
        public KW_REMOTETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_REMOTETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_REMOTETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
