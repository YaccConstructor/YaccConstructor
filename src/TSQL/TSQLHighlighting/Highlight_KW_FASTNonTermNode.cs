...
{
    public class Highlight_KW_FASTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FASTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FASTNonTermNode (string s, object positions)
        {
            text = s;
