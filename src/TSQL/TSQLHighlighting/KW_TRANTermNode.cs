...
{
    public class KW_TRANTermNode : ITreeNode
    {
        ...
        public KW_TRANTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TRANTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TRANTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
