...
{
    public class Yard_exp_brackets_418NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_418NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_418NonTermNode (string s, object positions)
        {
            text = s;
