...
{
    public class IDENTTermNode : ITreeNode
    {
        ...
        public IDENTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public IDENTTermNode (string ycTokName, string ycValue)
        {
        ...
        public IDENTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
