...
{
    public class KW_NONCLUSTEREDTermNode : ITreeNode
    {
        ...
        public KW_NONCLUSTEREDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NONCLUSTEREDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NONCLUSTEREDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
