...
{
    public class KW_LOWERTermNode : ITreeNode
    {
        ...
        public KW_LOWERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LOWERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LOWERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
