...
{
    public class KW_WHERETermNode : ITreeNode
    {
        ...
        public KW_WHERETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_WHERETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_WHERETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
