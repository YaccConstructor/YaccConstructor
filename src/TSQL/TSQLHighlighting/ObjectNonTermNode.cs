...
{
    public class ObjectNonTermNode : ITreeNode
    {
        ...
        public ObjectNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ObjectNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public ObjectNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
