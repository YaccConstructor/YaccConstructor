...
{
    public class KW_FORCEPLANTermNode : ITreeNode
    {
        ...
        public KW_FORCEPLANTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FORCEPLANTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FORCEPLANTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
