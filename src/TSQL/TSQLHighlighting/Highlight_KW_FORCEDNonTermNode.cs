...
{
    public class Highlight_KW_FORCEDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FORCEDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FORCEDNonTermNode (string s, object positions)
        {
            text = s;
