...
{
    public class Yard_exp_brackets_360NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_360NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_360NonTermNode (string s, object positions)
        {
            text = s;
