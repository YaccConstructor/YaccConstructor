...
{
    public class KW_IMPLICIT_TRANSACTIONSTermNode : IAbstractTreeNode
    {
        ...
        public KW_IMPLICIT_TRANSACTIONSTermNode (string s)
        {
            text = s;
        }

        public KW_IMPLICIT_TRANSACTIONSTermNode (string s, object positions)
        {
            text = s;
