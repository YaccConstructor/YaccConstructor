...
{
    public class Highlight_STRING1NonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_STRING1NonTermNode (string s)
        {
            text = s;
        }

        public Highlight_STRING1NonTermNode (string s, object positions)
        {
            text = s;
