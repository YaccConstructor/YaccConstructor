...
{
    public class Star_LitNode : ITreeNode
    {
        ...
        public Star_LitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Star_LitNode (string ycTokName, string ycValue)
        {
        ...
        public Star_LitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
