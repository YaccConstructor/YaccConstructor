...
{
    public class Yard_exp_brackets_375NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_375NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_375NonTermNode (string s, object positions)
        {
            text = s;
