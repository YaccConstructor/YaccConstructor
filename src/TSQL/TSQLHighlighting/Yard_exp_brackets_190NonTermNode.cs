...
{
    public class Yard_exp_brackets_190NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_190NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_190NonTermNode (string s, object positions)
        {
            text = s;
