...
{
    public class Dec_numNonTermNode : ITreeNode
    {
        ...
        public Dec_numNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Dec_numNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Dec_numNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
