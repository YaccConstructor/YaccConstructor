...
let fa = 
    {
        ...
        Rules        = Set.ofList [{FromStateID = 1; Symbol = Epsilon; Label = "l1"; ToStateID = 2}
...
let fa2 = 
    {
        ...
        Rules        = Set.ofList [{FromStateID = 1; Symbol = Epsilon; Label = "l1"; ToStateID = 2}
                                   ;{FromStateID = 2; Symbol = NSymbol("a"); Label = "l2"; ToStateID = 3}
                                   ;{FromStateID = 3; Symbol = Epsilon; Label = "l3"; ToStateID = 4}
                                   ;{FromStateID = 2; Symbol = Epsilon; Label = "l4"; ToStateID = 3}
                                   ;{FromStateID = 3; Symbol = Epsilon; Label = "l5"; ToStateID = 2}                                   
                                  ]    
    }
...
let fa3 = 
    {
        ...
        StartStates  = Set.ofList [1]
        FinaleStates = Set.ofList [6]
        Rules        = Set.ofList [{FromStateID = 1; Symbol = Epsilon; Label = "SCls"; ToStateID = 2}
                                   ;{FromStateID = 2; Symbol = Epsilon; Label = "Sa"; ToStateID = 3}
                                   ;{FromStateID = 3; Symbol =  NSymbol("a"); Label = "l1"; ToStateID = 4}
                                   ;{FromStateID = 4; Symbol = Epsilon; Label = "Ea"; ToStateID = 5}
                                   ;{FromStateID = 5; Symbol = Epsilon; Label = "ECls"; ToStateID = 6}
                                   ;{FromStateID = 2; Symbol = Epsilon; Label = "l2"; ToStateID = 5}                                   
                                   ;{FromStateID = 5; Symbol = Epsilon; Label = "l3"; ToStateID = 2}
                                  ]    
    }
do 
   printf "%A" (NLFAToDLFA.NLFAToDLFA fa3)
