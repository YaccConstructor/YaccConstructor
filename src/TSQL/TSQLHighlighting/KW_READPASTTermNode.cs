...
{
    public class KW_READPASTTermNode : ITreeNode
    {
        ...
        public KW_READPASTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_READPASTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_READPASTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
