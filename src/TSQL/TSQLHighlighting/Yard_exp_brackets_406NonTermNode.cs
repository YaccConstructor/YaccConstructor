...
{
    public class Yard_exp_brackets_406NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_406NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_406NonTermNode (string s, object positions)
        {
            text = s;
