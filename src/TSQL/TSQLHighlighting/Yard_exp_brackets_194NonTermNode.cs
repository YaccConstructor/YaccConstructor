...
{
    public class Yard_exp_brackets_194NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_194NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_194NonTermNode (string s, object positions)
        {
            text = s;
