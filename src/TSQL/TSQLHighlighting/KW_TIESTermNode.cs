...
{
    public class KW_TIESTermNode : ITreeNode
    {
        ...
        public KW_TIESTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TIESTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TIESTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
