...
{
    public class LOCALVARTermNode : ITreeNode
    {
        ...
        public LOCALVARTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public LOCALVARTermNode (string ycTokName, string ycValue)
        {
        ...
        public LOCALVARTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
