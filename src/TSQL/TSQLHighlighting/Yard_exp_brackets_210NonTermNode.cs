...
{
    public class Yard_exp_brackets_210NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_210NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_210NonTermNode (string s, object positions)
        {
            text = s;
