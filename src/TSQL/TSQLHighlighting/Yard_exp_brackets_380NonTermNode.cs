...
{
    public class Yard_exp_brackets_380NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_380NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_380NonTermNode (string s, object positions)
        {
            text = s;
