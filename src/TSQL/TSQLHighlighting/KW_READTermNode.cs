...
{
    public class KW_READTermNode : ITreeNode
    {
        ...
        public KW_READTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_READTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_READTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
