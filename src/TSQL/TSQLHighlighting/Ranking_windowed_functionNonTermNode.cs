...
{
    public class Ranking_windowed_functionNonTermNode : IAbstractTreeNode
    {
        ...
        public Ranking_windowed_functionNonTermNode (string s)
        {
            text = s;
        }

        public Ranking_windowed_functionNonTermNode (string s, object positions)
        {
            text = s;
