...
{
    public class Proc_body_stmntNonTermNode : IAbstractTreeNode
    {
        ...
        public Proc_body_stmntNonTermNode (string s)
        {
            text = s;
        }

        public Proc_body_stmntNonTermNode (string s, object positions)
        {
            text = s;
