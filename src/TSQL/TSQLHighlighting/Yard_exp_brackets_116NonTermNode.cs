...
{
    public class Yard_exp_brackets_116NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_116NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_116NonTermNode (string s, object positions)
        {
            text = s;
