...
{
    public class ClassLitNode : ITreeNode
    {
        ...
        public ClassLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ClassLitNode (string ycTokName, string ycValue)
        {
        ...
        public ClassLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
