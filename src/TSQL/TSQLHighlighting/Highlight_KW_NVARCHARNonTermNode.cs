...
{
    public class Highlight_KW_NVARCHARNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NVARCHARNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NVARCHARNonTermNode (string s, object positions)
        {
            text = s;
