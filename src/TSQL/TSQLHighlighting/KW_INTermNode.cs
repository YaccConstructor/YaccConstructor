...
{
    public class KW_INTermNode : ITreeNode
    {
        ...
        public KW_INTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_INTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_INTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
