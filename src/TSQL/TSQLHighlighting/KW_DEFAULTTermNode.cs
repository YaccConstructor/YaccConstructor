...
{
    public class KW_DEFAULTTermNode : ITreeNode
    {
        ...
        public KW_DEFAULTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DEFAULTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DEFAULTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
