...
{
    public class Highlight_KW_RAWNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_RAWNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_RAWNonTermNode (string s, object positions)
        {
            text = s;
