...
{
    public class KW_CONCATTermNode : ITreeNode
    {
        ...
        public KW_CONCATTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CONCATTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CONCATTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
