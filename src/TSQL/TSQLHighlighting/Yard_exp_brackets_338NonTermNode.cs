...
{
    public class Yard_exp_brackets_338NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_338NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_338NonTermNode (string s, object positions)
        {
            text = s;
