...
{
    public class Root_ruleNonTermNode : ITreeNode
    {
        ...
        public Root_ruleNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Root_ruleNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Root_ruleNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
