...
{
    public class Yard_rule_list_27NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_27NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_27NonTermNode (string s, object positions)
        {
            text = s;
