...
{
    public class Yard_rule_list_39NonTermNode : ITreeNode
    {
        ...
        public Yard_rule_list_39NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_rule_list_39NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_rule_list_39NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
