...
{
    public class Yard_exp_brackets_258NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_258NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_258NonTermNode (string s, object positions)
        {
            text = s;
