...
{
    public class PairNonTermNode : ITreeNode
    {
        ...
        public PairNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public PairNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public PairNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
