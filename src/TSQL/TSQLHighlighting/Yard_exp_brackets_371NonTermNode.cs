...
{
    public class Yard_exp_brackets_371NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_371NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_371NonTermNode (string s, object positions)
        {
            text = s;
