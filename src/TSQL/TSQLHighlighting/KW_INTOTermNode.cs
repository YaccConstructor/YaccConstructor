...
{
    public class KW_INTOTermNode : ITreeNode
    {
        ...
        public KW_INTOTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_INTOTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_INTOTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
