...
{
    public class Highlight_KW_ONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ONNonTermNode (string s, object positions)
        {
            text = s;
