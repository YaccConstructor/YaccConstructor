...
{
    public class Highlight_AVGNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_AVGNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_AVGNonTermNode (string s, object positions)
        {
            text = s;
