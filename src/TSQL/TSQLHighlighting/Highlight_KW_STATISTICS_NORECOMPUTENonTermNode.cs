...
{
    public class Highlight_KW_STATISTICS_NORECOMPUTENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_STATISTICS_NORECOMPUTENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_STATISTICS_NORECOMPUTENonTermNode (string s, object positions)
        {
            text = s;
