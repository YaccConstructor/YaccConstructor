...
{
    public class Yard_rule_not_empty_list_65NonTermNode : ITreeNode
    {
        ...
        public Yard_rule_not_empty_list_65NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_rule_not_empty_list_65NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_rule_not_empty_list_65NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
