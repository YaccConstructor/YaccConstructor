...
{
    public class Highlight_KW_VARCHARNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_VARCHARNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_VARCHARNonTermNode (string s, object positions)
        {
            text = s;
