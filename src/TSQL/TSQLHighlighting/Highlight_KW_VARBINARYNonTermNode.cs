...
{
    public class Highlight_KW_VARBINARYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_VARBINARYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_VARBINARYNonTermNode (string s, object positions)
        {
            text = s;
