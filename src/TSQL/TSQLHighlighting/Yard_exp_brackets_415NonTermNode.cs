...
{
    public class Yard_exp_brackets_415NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_415NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_415NonTermNode (string s, object positions)
        {
            text = s;
