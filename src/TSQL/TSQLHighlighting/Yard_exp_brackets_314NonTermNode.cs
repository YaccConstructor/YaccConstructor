...
{
    public class Yard_exp_brackets_314NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_314NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_314NonTermNode (string s, object positions)
        {
            text = s;
