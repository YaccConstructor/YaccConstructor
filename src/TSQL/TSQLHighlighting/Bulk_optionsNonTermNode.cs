...
{
    public class Bulk_optionsNonTermNode : ITreeNode
    {
        ...
        public Bulk_optionsNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Bulk_optionsNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Bulk_optionsNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
