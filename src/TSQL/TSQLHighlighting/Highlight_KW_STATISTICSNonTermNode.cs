...
{
    public class Highlight_KW_STATISTICSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_STATISTICSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_STATISTICSNonTermNode (string s, object positions)
        {
            text = s;
