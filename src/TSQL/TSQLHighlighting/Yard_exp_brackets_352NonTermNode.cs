...
{
    public class Yard_exp_brackets_352NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_352NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_352NonTermNode (string s, object positions)
        {
            text = s;
