...
{
    public class Yard_exp_brackets_220NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_220NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_220NonTermNode (string s, object positions)
        {
            text = s;
