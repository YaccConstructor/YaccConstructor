...
{
    public class Yard_rule_yard_many_1_69NonTermNode : ITreeNode
    {
        ...
        public Yard_rule_yard_many_1_69NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_rule_yard_many_1_69NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_rule_yard_many_1_69NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
