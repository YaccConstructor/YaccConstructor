...
{
    public class Yard_opt_7NonTermNode : ITreeNode
    {
        ...
        public Yard_opt_7NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_opt_7NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_opt_7NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
