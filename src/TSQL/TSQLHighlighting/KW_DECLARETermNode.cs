...
{
    public class KW_DECLARETermNode : ITreeNode
    {
        ...
        public KW_DECLARETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DECLARETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DECLARETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
