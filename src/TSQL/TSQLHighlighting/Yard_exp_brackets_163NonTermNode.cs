...
{
    public class Yard_exp_brackets_163NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_163NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_163NonTermNode (string s, object positions)
        {
            text = s;
