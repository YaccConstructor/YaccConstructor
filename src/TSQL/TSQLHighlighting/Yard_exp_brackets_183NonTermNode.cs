...
{
    public class Yard_exp_brackets_183NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_183NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_183NonTermNode (string s, object positions)
        {
            text = s;
