...
{
    public class Highlight_star_NonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_star_NonTermNode (string s)
        {
            text = s;
        }

        public Highlight_star_NonTermNode (string s, object positions)
        {
            text = s;
