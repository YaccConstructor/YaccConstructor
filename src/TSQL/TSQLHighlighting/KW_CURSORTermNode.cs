...
{
    public class KW_CURSORTermNode : ITreeNode
    {
        ...
        public KW_CURSORTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CURSORTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CURSORTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
