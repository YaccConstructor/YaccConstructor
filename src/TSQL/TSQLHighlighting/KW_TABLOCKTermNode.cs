...
{
    public class KW_TABLOCKTermNode : ITreeNode
    {
        ...
        public KW_TABLOCKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TABLOCKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TABLOCKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
