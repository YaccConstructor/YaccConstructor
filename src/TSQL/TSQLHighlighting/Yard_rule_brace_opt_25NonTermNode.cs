...
{
    public class Yard_rule_brace_opt_25NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_brace_opt_25NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_brace_opt_25NonTermNode (string s, object positions)
        {
            text = s;
