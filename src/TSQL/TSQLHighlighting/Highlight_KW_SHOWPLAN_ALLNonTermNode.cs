...
{
    public class Highlight_KW_SHOWPLAN_ALLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SHOWPLAN_ALLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SHOWPLAN_ALLNonTermNode (string s, object positions)
        {
            text = s;
