...
{
    public class Yard_opt_134NonTermNode : ITreeNode
    {
        ...
        public Yard_opt_134NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_opt_134NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_opt_134NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
