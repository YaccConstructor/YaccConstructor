...
..\..\Bin\Release\v40\YC.YaccConstructor.exe -i ..\RNGLRAbstractParser.Test\bio2.yrd  -c ExpandEbnf -c ExpandMeta -g "GLLGenerator -pos int -token int -module GLL.Bio2 -o bio2.yrd.fs -abstract true" >> log.txt