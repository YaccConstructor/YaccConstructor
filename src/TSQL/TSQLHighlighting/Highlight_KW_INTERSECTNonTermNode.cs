...
{
    public class Highlight_KW_INTERSECTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_INTERSECTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_INTERSECTNonTermNode (string s, object positions)
        {
            text = s;
