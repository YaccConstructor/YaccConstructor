...
{
    public class Yard_exp_brackets_268NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_268NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_268NonTermNode (string s, object positions)
        {
            text = s;
