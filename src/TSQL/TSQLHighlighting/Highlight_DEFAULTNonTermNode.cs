...
{
    public class Highlight_DEFAULTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_DEFAULTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_DEFAULTNonTermNode (string s, object positions)
        {
            text = s;
