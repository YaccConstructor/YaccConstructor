...
{
    public class KW_MERGETermNode : ITreeNode
    {
        ...
        public KW_MERGETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MERGETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MERGETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
