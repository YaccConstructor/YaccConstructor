...
{
    public class Yard_exp_brackets_235NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_235NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_235NonTermNode (string s, object positions)
        {
            text = s;
