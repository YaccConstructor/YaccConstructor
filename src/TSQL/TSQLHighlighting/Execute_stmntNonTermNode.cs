...
{
    public class Execute_stmntNonTermNode : IAbstractTreeNode
    {
        ...
        public Execute_stmntNonTermNode (string s)
        {
            text = s;
        }

        public Execute_stmntNonTermNode (string s, object positions)
        {
            text = s;
