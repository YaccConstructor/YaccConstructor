...
{
    public class Yard_rule_list_77NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_77NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_77NonTermNode (string s, object positions)
        {
            text = s;
