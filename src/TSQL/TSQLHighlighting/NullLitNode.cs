...
{
    public class NullLitNode : ITreeNode
    {
        ...
        public NullLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public NullLitNode (string ycTokName, string ycValue)
        {
        ...
        public NullLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
