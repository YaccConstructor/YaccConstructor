...
{
    public class Highlight_KW_KEEPFIXEDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_KEEPFIXEDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_KEEPFIXEDNonTermNode (string s, object positions)
        {
            text = s;
