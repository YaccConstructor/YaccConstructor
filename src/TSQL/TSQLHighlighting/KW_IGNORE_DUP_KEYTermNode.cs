...
{
    public class KW_IGNORE_DUP_KEYTermNode : IAbstractTreeNode
    {
        ...
        public KW_IGNORE_DUP_KEYTermNode (string s)
        {
            text = s;
        }

        public KW_IGNORE_DUP_KEYTermNode (string s, object positions)
        {
            text = s;
