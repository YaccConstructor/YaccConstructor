...
{
    public class Yard_exp_brackets_188NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_188NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_188NonTermNode (string s, object positions)
        {
            text = s;
