...
{
    public class KW_PARAMETERIZATIONTermNode : IAbstractTreeNode
    {
        ...
        public KW_PARAMETERIZATIONTermNode (string s)
        {
            text = s;
        }

        public KW_PARAMETERIZATIONTermNode (string s, object positions)
        {
            text = s;
