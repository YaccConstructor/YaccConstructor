...
{
    public class Yard_exp_brackets_285NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_285NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_285NonTermNode (string s, object positions)
        {
            text = s;
