...
{
    public class Yard_exp_brackets_160NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_160NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_160NonTermNode (string s, object positions)
        {
            text = s;
