...
{
    public class Highlight_KW_LOWERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LOWERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LOWERNonTermNode (string s, object positions)
        {
            text = s;
