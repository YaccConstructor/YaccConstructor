...
{
    public class KW_UNIQUETermNode : ITreeNode
    {
        ...
        public KW_UNIQUETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_UNIQUETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_UNIQUETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
