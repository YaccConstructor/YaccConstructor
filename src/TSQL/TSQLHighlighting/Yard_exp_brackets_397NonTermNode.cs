...
{
    public class Yard_exp_brackets_397NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_397NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_397NonTermNode (string s, object positions)
        {
            text = s;
