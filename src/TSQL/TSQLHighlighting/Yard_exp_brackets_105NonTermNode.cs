...
{
    public class Yard_exp_brackets_105NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_105NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_105NonTermNode (string s, object positions)
        {
            text = s;
