...
{
    public class Table_type_definitionNonTermNode : IAbstractTreeNode
    {
        ...
        public Table_type_definitionNonTermNode (string s)
        {
            text = s;
        }

        public Table_type_definitionNonTermNode (string s, object positions)
        {
            text = s;
