...
{
    public class Unpivoted_tableNonTermNode : ITreeNode
    {
        ...
        public Unpivoted_tableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Unpivoted_tableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Unpivoted_tableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
