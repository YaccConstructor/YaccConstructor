...
{
    public class Yard_exp_brackets_405NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_405NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_405NonTermNode (string s, object positions)
        {
            text = s;
