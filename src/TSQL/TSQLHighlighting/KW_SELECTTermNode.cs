...
{
    public class KW_SELECTTermNode : ITreeNode
    {
        ...
        public KW_SELECTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SELECTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SELECTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
