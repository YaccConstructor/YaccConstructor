...
{
    public class Dot_LitNode : ITreeNode
    {
        ...
        public Dot_LitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Dot_LitNode (string ycTokName, string ycValue)
        {
        ...
        public Dot_LitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
