...
{
    public class Highlight_KW_SECONDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SECONDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SECONDNonTermNode (string s, object positions)
        {
            text = s;
