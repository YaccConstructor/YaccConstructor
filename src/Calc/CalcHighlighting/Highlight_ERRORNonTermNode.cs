...
{
    public class Highlight_ERRORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_ERRORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_ERRORNonTermNode (string s, object positions)
        {
            text = s;
