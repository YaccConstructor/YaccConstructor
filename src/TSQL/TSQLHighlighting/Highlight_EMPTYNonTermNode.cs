...
{
    public class Highlight_EMPTYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_EMPTYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_EMPTYNonTermNode (string s, object positions)
        {
            text = s;
