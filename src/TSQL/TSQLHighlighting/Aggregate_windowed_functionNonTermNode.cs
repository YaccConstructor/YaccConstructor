...
{
    public class Aggregate_windowed_functionNonTermNode : ITreeNode
    {
        ...
        public Aggregate_windowed_functionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Aggregate_windowed_functionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Aggregate_windowed_functionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
