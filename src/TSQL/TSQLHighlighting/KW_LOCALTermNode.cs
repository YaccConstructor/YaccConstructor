...
{
    public class KW_LOCALTermNode : ITreeNode
    {
        ...
        public KW_LOCALTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LOCALTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LOCALTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
