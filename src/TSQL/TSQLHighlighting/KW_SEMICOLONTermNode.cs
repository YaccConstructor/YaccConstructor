...
{
    public class KW_SEMICOLONTermNode : ITreeNode
    {
        ...
        public KW_SEMICOLONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SEMICOLONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SEMICOLONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
