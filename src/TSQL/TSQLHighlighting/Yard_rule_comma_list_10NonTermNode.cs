...
{
    public class Yard_rule_comma_list_10NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_10NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_10NonTermNode (string s, object positions)
        {
            text = s;
