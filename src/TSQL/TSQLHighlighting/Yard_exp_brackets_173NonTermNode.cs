...
{
    public class Yard_exp_brackets_173NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_173NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_173NonTermNode (string s, object positions)
        {
            text = s;
