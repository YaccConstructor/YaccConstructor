...
{
    public class Highlight_KW_CONSTRAINTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CONSTRAINTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CONSTRAINTNonTermNode (string s, object positions)
        {
            text = s;
