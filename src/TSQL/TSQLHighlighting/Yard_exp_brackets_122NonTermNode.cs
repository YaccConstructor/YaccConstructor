...
{
    public class Yard_exp_brackets_122NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_122NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_122NonTermNode (string s, object positions)
        {
            text = s;
