...
{
    public class Yard_exp_brackets_150NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_150NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_150NonTermNode (string s, object positions)
        {
            text = s;
