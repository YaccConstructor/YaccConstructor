...
{
    public class KW_RAWTermNode : ITreeNode
    {
        ...
        public KW_RAWTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_RAWTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_RAWTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
