...
{
    public class Yard_opt_151NonTermNode : ITreeNode
    {
        ...
        public Yard_opt_151NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_opt_151NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_opt_151NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
