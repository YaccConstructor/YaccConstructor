...
{
    public class Yard_rule_yard_many_1_90NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_90NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_90NonTermNode (string s, object positions)
        {
            text = s;
