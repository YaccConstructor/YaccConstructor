...
{
    public class Highlight_KW_ESCAPENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ESCAPENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ESCAPENonTermNode (string s, object positions)
        {
            text = s;
