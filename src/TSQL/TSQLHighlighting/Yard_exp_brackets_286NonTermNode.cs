...
{
    public class Yard_exp_brackets_286NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_286NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_286NonTermNode (string s, object positions)
        {
            text = s;
