...
{
    public class KW_SCROLLTermNode : ITreeNode
    {
        ...
        public KW_SCROLLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SCROLLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SCROLLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
