...
{
    public class Sql_datatypeNonTermNode : ITreeNode
    {
        ...
        public Sql_datatypeNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Sql_datatypeNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Sql_datatypeNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
