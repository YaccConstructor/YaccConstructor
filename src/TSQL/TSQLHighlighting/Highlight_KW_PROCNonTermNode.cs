...
{
    public class Highlight_KW_PROCNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PROCNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PROCNonTermNode (string s, object positions)
        {
            text = s;
