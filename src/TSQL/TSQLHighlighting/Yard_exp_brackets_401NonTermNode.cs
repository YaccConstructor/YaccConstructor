...
{
    public class Yard_exp_brackets_401NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_401NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_401NonTermNode (string s, object positions)
        {
            text = s;
