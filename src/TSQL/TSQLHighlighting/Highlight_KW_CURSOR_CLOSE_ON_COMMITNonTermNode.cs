...
{
    public class Highlight_KW_CURSOR_CLOSE_ON_COMMITNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CURSOR_CLOSE_ON_COMMITNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CURSOR_CLOSE_ON_COMMITNonTermNode (string s, object positions)
        {
            text = s;
