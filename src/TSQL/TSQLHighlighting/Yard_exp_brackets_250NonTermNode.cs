...
{
    public class Yard_exp_brackets_250NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_250NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_250NonTermNode (string s, object positions)
        {
            text = s;
