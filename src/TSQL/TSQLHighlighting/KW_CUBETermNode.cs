...
{
    public class KW_CUBETermNode : ITreeNode
    {
        ...
        public KW_CUBETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CUBETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CUBETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
