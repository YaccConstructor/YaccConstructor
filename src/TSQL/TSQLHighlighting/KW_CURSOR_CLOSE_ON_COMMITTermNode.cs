...
{
    public class KW_CURSOR_CLOSE_ON_COMMITTermNode : ITreeNode
    {
        ...
        public KW_CURSOR_CLOSE_ON_COMMITTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CURSOR_CLOSE_ON_COMMITTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CURSOR_CLOSE_ON_COMMITTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
