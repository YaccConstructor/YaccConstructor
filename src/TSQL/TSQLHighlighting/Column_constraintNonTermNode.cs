...
{
    public class Column_constraintNonTermNode : ITreeNode
    {
        ...
        public Column_constraintNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Column_constraintNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Column_constraintNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
