...
{
    public class KW_PROCTermNode : ITreeNode
    {
        ...
        public KW_PROCTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PROCTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PROCTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
