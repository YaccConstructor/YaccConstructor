...
{
    public class Yard_exp_brackets_200NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_200NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_200NonTermNode (string s, object positions)
        {
            text = s;
