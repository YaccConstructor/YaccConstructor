...
{
    public class Rollback_transactionNonTermNode : IAbstractTreeNode
    {
        ...
        public Rollback_transactionNonTermNode (string s)
        {
            text = s;
        }

        public Rollback_transactionNonTermNode (string s, object positions)
        {
            text = s;
