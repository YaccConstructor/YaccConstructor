...
{
    public class KW_SETTermNode : ITreeNode
    {
        ...
        public KW_SETTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SETTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SETTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
