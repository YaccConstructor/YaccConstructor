...
{
    public class Yard_exp_brackets_363NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_363NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_363NonTermNode (string s, object positions)
        {
            text = s;
