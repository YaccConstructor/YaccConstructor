...
{
    public class Pivoted_tableNonTermNode : ITreeNode
    {
        ...
        public Pivoted_tableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Pivoted_tableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Pivoted_tableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
