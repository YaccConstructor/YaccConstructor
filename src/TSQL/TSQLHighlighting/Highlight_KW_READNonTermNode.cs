...
{
    public class Highlight_KW_READNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_READNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_READNonTermNode (string s, object positions)
        {
            text = s;
