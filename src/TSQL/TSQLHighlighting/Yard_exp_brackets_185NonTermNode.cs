...
{
    public class Yard_exp_brackets_185NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_185NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_185NonTermNode (string s, object positions)
        {
            text = s;
