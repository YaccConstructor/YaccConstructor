...
{
    public class Generation_termNonTermNode : IAbstractTreeNode
    {
        ...
        public Generation_termNonTermNode (string s)
        {
            text = s;
        }

        public Generation_termNonTermNode (string s, object positions)
        {
            text = s;
