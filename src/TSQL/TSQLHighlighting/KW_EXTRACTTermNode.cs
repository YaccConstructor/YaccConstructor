...
{
    public class KW_EXTRACTTermNode : ITreeNode
    {
        ...
        public KW_EXTRACTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_EXTRACTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_EXTRACTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
