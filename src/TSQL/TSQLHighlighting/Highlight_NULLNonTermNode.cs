...
{
    public class Highlight_NULLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_NULLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_NULLNonTermNode (string s, object positions)
        {
            text = s;
