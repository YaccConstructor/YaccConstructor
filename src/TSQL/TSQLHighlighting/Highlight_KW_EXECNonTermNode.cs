...
{
    public class Highlight_KW_EXECNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_EXECNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_EXECNonTermNode (string s, object positions)
        {
            text = s;
