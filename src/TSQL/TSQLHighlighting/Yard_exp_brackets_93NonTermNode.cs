...
{
    public class Yard_exp_brackets_93NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_93NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_93NonTermNode (string s, object positions)
        {
            text = s;
