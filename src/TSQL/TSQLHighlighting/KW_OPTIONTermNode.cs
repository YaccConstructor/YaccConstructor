...
{
    public class KW_OPTIONTermNode : ITreeNode
    {
        ...
        public KW_OPTIONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OPTIONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OPTIONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
