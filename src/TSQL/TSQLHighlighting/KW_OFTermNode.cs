...
{
    public class KW_OFTermNode : ITreeNode
    {
        ...
        public KW_OFTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OFTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OFTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
