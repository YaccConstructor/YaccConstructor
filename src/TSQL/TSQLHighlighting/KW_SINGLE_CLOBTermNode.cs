...
{
    public class KW_SINGLE_CLOBTermNode : ITreeNode
    {
        ...
        public KW_SINGLE_CLOBTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SINGLE_CLOBTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SINGLE_CLOBTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
