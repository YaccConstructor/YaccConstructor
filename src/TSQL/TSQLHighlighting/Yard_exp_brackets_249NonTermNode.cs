...
{
    public class Yard_exp_brackets_249NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_249NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_249NonTermNode (string s, object positions)
        {
            text = s;
