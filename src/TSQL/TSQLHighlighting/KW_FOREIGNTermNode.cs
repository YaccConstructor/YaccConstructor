...
{
    public class KW_FOREIGNTermNode : ITreeNode
    {
        ...
        public KW_FOREIGNTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FOREIGNTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FOREIGNTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
