...
{
    public class KW_ROOTTermNode : ITreeNode
    {
        ...
        public KW_ROOTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROOTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROOTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
