...
{
    public class Yard_rule_list_11NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_11NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_11NonTermNode (string s, object positions)
        {
            text = s;
