...
{
    public class Yard_exp_brackets_229NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_229NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_229NonTermNode (string s, object positions)
        {
            text = s;
