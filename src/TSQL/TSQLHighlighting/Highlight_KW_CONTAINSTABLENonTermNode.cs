...
{
    public class Highlight_KW_CONTAINSTABLENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CONTAINSTABLENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CONTAINSTABLENonTermNode (string s, object positions)
        {
            text = s;
