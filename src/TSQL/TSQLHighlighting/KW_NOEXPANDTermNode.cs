...
{
    public class KW_NOEXPANDTermNode : ITreeNode
    {
        ...
        public KW_NOEXPANDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NOEXPANDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NOEXPANDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
