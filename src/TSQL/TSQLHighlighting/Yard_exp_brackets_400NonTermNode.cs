...
{
    public class Yard_exp_brackets_400NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_400NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_400NonTermNode (string s, object positions)
        {
            text = s;
