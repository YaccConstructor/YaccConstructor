...
{
    public class Highlight_KW_HOLDLOCKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_HOLDLOCKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_HOLDLOCKNonTermNode (string s, object positions)
        {
            text = s;
