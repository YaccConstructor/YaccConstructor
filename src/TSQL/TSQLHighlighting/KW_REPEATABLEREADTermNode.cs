...
{
    public class KW_REPEATABLEREADTermNode : ITreeNode
    {
        ...
        public KW_REPEATABLEREADTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_REPEATABLEREADTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_REPEATABLEREADTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
