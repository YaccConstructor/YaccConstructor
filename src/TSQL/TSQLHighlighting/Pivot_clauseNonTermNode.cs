...
{
    public class Pivot_clauseNonTermNode : ITreeNode
    {
        ...
        public Pivot_clauseNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Pivot_clauseNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Pivot_clauseNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
