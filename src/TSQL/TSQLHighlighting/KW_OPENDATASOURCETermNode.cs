...
{
    public class KW_OPENDATASOURCETermNode : ITreeNode
    {
        ...
        public KW_OPENDATASOURCETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OPENDATASOURCETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OPENDATASOURCETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
