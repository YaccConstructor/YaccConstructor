...
{
    public class Yard_rule_comma_list_67NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_67NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_67NonTermNode (string s, object positions)
        {
            text = s;
