...
{
    public class KW_ANSI_DEFAULTSTermNode : IAbstractTreeNode
    {
        ...
        public KW_ANSI_DEFAULTSTermNode (string s)
        {
            text = s;
        }

        public KW_ANSI_DEFAULTSTermNode (string s, object positions)
        {
            text = s;
