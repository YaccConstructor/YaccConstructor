...
{
    public class KW_XACT_ABORTTermNode : ITreeNode
    {
        ...
        public KW_XACT_ABORTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_XACT_ABORTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_XACT_ABORTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
