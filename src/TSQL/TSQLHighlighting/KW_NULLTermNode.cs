...
{
    public class KW_NULLTermNode : ITreeNode
    {
        ...
        public KW_NULLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NULLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NULLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
