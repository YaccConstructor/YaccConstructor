...
{
    public class Highlight_KW_FIRSTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FIRSTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FIRSTNonTermNode (string s, object positions)
        {
            text = s;
