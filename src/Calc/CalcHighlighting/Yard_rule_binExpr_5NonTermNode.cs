...
{
    public class Yard_rule_binExpr_5NonTermNode : IAbstractTreeNode
    {
        ...
        private string text;
        public Yard_rule_binExpr_5NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_binExpr_5NonTermNode (string s, object positions)
        {
            text = s;
