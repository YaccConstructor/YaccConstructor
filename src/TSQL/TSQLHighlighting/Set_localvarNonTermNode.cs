...
{
    public class Set_localvarNonTermNode : ITreeNode
    {
        ...
        public Set_localvarNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Set_localvarNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Set_localvarNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
