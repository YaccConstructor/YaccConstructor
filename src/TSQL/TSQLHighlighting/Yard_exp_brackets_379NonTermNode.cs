...
{
    public class Yard_exp_brackets_379NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_379NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_379NonTermNode (string s, object positions)
        {
            text = s;
