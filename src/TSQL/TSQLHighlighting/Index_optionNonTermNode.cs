...
{
    public class Index_optionNonTermNode : ITreeNode
    {
        ...
        public Index_optionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Index_optionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Index_optionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
