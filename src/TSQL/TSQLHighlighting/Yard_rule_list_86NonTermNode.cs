...
{
    public class Yard_rule_list_86NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_86NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_86NonTermNode (string s, object positions)
        {
            text = s;
