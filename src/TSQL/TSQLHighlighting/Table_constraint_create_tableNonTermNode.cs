...
{
    public class Table_constraint_create_tableNonTermNode : IAbstractTreeNode
    {
        ...
        public Table_constraint_create_tableNonTermNode (string s)
        {
            text = s;
        }

        public Table_constraint_create_tableNonTermNode (string s, object positions)
        {
            text = s;
