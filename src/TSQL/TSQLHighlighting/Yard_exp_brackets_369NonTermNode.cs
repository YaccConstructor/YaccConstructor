...
{
    public class Yard_exp_brackets_369NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_369NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_369NonTermNode (string s, object positions)
        {
            text = s;
