...
{
    public class KW_ACTIONTermNode : ITreeNode
    {
        ...
        public KW_ACTIONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ACTIONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ACTIONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
