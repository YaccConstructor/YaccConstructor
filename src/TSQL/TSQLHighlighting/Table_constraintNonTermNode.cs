...
{
    public class Table_constraintNonTermNode : IAbstractTreeNode
    {
        ...
        public Table_constraintNonTermNode (string s)
        {
            text = s;
        }

        public Table_constraintNonTermNode (string s, object positions)
        {
            text = s;
