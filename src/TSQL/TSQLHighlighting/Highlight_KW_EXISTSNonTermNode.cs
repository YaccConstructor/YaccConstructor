...
{
    public class Highlight_KW_EXISTSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_EXISTSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_EXISTSNonTermNode (string s, object positions)
        {
            text = s;
