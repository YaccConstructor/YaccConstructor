...
{
    public class Weighted_termNonTermNode : ITreeNode
    {
        ...
        public Weighted_termNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Weighted_termNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Weighted_termNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
