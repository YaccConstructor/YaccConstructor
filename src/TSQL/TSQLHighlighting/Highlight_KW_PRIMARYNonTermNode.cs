...
{
    public class Highlight_KW_PRIMARYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PRIMARYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PRIMARYNonTermNode (string s, object positions)
        {
            text = s;
