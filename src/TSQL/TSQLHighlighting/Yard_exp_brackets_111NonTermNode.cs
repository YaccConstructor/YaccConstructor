...
{
    public class Yard_exp_brackets_111NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_111NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_111NonTermNode (string s, object positions)
        {
            text = s;
