...
{
    public class Highlight_KW_FALSENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FALSENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FALSENonTermNode (string s, object positions)
        {
            text = s;
