...
{
    public class CountLitNode : ITreeNode
    {
        ...
        public CountLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public CountLitNode (string ycTokName, string ycValue)
        {
        ...
        public CountLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
