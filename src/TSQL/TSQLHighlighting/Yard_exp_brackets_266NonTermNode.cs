...
{
    public class Yard_exp_brackets_266NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_266NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_266NonTermNode (string s, object positions)
        {
            text = s;
