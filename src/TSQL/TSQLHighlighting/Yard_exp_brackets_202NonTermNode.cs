...
{
    public class Yard_exp_brackets_202NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_202NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_202NonTermNode (string s, object positions)
        {
            text = s;
