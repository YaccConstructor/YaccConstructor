...
{
    public class KW_REALTermNode : ITreeNode
    {
        ...
        public KW_REALTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_REALTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_REALTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
