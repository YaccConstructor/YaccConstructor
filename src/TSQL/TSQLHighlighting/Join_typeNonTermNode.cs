...
{
    public class Join_typeNonTermNode : ITreeNode
    {
        ...
        public Join_typeNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Join_typeNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Join_typeNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
