...
{
    public class Create_objectNonTermNode : ITreeNode
    {
        ...
        public Create_objectNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Create_objectNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Create_objectNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
