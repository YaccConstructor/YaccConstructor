...
{
    public class Common_directivesNonTermNode : ITreeNode
    {
        ...
        public Common_directivesNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Common_directivesNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Common_directivesNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
