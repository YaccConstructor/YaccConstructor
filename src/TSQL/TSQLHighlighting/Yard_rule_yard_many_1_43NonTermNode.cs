...
{
    public class Yard_rule_yard_many_1_43NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_43NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_43NonTermNode (string s, object positions)
        {
            text = s;
