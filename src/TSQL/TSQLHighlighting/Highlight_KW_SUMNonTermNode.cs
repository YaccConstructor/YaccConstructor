...
{
    public class Highlight_KW_SUMNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SUMNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SUMNonTermNode (string s, object positions)
        {
            text = s;
