...
{
    public class KW_FULLTermNode : ITreeNode
    {
        ...
        public KW_FULLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FULLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FULLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
