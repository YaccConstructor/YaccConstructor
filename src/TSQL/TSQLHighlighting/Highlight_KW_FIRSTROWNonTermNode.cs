...
{
    public class Highlight_KW_FIRSTROWNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FIRSTROWNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FIRSTROWNonTermNode (string s, object positions)
        {
            text = s;
