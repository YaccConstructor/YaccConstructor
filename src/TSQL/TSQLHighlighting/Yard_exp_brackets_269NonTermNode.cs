...
{
    public class Yard_exp_brackets_269NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_269NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_269NonTermNode (string s, object positions)
        {
            text = s;
