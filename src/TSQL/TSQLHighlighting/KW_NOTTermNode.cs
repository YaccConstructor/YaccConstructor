...
{
    public class KW_NOTTermNode : ITreeNode
    {
        ...
        public KW_NOTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NOTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NOTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
