...
{
    public class Drop_procedureNonTermNode : ITreeNode
    {
        ...
        public Drop_procedureNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Drop_procedureNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Drop_procedureNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
