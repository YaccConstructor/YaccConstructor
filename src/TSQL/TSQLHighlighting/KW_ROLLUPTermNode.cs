...
{
    public class KW_ROLLUPTermNode : ITreeNode
    {
        ...
        public KW_ROLLUPTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROLLUPTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROLLUPTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
