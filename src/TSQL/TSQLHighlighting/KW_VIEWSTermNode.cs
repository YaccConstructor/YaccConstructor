...
{
    public class KW_VIEWSTermNode : ITreeNode
    {
        ...
        public KW_VIEWSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_VIEWSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_VIEWSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
