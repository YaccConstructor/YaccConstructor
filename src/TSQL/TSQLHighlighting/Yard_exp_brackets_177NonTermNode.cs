...
{
    public class Yard_exp_brackets_177NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_177NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_177NonTermNode (string s, object positions)
        {
            text = s;
