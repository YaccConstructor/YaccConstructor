...
{
    public class KW_BIGINTTermNode : ITreeNode
    {
        ...
        public KW_BIGINTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BIGINTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BIGINTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
