...
{
    public class KW_SHOWPLAN_TEXTTermNode : ITreeNode
    {
        ...
        public KW_SHOWPLAN_TEXTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SHOWPLAN_TEXTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SHOWPLAN_TEXTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
