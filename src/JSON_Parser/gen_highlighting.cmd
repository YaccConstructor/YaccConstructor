...
echo JSON.yrd >> log.txt
    ..\packages\YaccConstructor.0.0.8.12\tools\YaccConstructor\YC.YaccConstructor.exe -i JSON.yrd -c ExpandEbnf -c ExpandMeta -c Linearize -c "ReplaceLiterals KW_%%s" ^
