...
{
    public class Highlight_KW_ANDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ANDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ANDNonTermNode (string s, object positions)
        {
            text = s;
