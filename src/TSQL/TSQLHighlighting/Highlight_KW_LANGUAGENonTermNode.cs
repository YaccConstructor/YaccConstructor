...
{
    public class Highlight_KW_LANGUAGENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LANGUAGENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LANGUAGENonTermNode (string s, object positions)
        {
            text = s;
