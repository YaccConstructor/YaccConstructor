...
{
    public class Yard_rule_list_30NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_30NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_30NonTermNode (string s, object positions)
        {
            text = s;
