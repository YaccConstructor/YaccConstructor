...
{
    public class Yard_exp_brackets_254NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_254NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_254NonTermNode (string s, object positions)
        {
            text = s;
