...
{
    public class Yard_exp_brackets_366NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_366NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_366NonTermNode (string s, object positions)
        {
            text = s;
