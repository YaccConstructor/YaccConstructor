...
{
    public class Execute_procNonTermNode : ITreeNode
    {
        ...
        public Execute_procNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Execute_procNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Execute_procNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
