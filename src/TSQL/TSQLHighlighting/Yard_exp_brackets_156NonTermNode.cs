...
{
    public class Yard_exp_brackets_156NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_156NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_156NonTermNode (string s, object positions)
        {
            text = s;
