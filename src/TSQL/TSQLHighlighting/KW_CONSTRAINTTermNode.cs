...
{
    public class KW_CONSTRAINTTermNode : ITreeNode
    {
        ...
        public KW_CONSTRAINTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CONSTRAINTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CONSTRAINTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
