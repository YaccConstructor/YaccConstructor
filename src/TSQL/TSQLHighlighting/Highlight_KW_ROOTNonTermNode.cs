...
{
    public class Highlight_KW_ROOTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROOTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROOTNonTermNode (string s, object positions)
        {
            text = s;
