...
{
    public class Yard_exp_brackets_145NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_145NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_145NonTermNode (string s, object positions)
        {
            text = s;
