...
{
    public class KW_LASTTermNode : ITreeNode
    {
        ...
        public KW_LASTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LASTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LASTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
