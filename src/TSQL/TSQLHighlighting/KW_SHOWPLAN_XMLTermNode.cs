...
{
    public class KW_SHOWPLAN_XMLTermNode : ITreeNode
    {
        ...
        public KW_SHOWPLAN_XMLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SHOWPLAN_XMLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SHOWPLAN_XMLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
