...
{
    public class Yard_exp_brackets_378NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_378NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_378NonTermNode (string s, object positions)
        {
            text = s;
