...
{
    public class KW_GREATERTermNode : ITreeNode
    {
        ...
        public KW_GREATERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_GREATERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_GREATERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
