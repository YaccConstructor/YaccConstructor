...
{
    public class Yard_exp_brackets_335NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_335NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_335NonTermNode (string s, object positions)
        {
            text = s;
