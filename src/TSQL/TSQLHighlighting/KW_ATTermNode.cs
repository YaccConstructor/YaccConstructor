...
{
    public class KW_ATTermNode : ITreeNode
    {
        ...
        public KW_ATTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ATTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ATTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
