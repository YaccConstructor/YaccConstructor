...
{
    public class KW_READCOMMITTEDLOCKTermNode : IAbstractTreeNode
    {
        ...
        public KW_READCOMMITTEDLOCKTermNode (string s)
        {
            text = s;
        }

        public KW_READCOMMITTEDLOCKTermNode (string s, object positions)
        {
            text = s;
