...
{
    public class OwnerLitNode : ITreeNode
    {
        ...
        public OwnerLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public OwnerLitNode (string ycTokName, string ycValue)
        {
        ...
        public OwnerLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
