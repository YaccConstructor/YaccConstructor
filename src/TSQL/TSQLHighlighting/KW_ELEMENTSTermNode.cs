...
{
    public class KW_ELEMENTSTermNode : ITreeNode
    {
        ...
        public KW_ELEMENTSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ELEMENTSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ELEMENTSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
