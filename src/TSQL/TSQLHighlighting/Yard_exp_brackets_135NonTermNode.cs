...
{
    public class Yard_exp_brackets_135NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_135NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_135NonTermNode (string s, object positions)
        {
            text = s;
