...
{
    public class Highlight_KW_SCROLL_LOCKSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SCROLL_LOCKSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SCROLL_LOCKSNonTermNode (string s, object positions)
        {
            text = s;
