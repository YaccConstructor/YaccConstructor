...
{
    public class Highlight_KW_GROUPNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_GROUPNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_GROUPNonTermNode (string s, object positions)
        {
            text = s;
