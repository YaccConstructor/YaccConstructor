...
{
    public class Highlight_DEC_NUMBERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_DEC_NUMBERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_DEC_NUMBERNonTermNode (string s, object positions)
        {
            text = s;
