...
{
    public class Highlight_KW_REFERENCESNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_REFERENCESNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_REFERENCESNonTermNode (string s, object positions)
        {
            text = s;
