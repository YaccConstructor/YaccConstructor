...
{
    public class Yard_rule_list_89NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_89NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_89NonTermNode (string s, object positions)
        {
            text = s;
