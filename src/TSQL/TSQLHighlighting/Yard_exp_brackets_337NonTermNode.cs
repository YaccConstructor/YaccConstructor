...
{
    public class Yard_exp_brackets_337NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_337NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_337NonTermNode (string s, object positions)
        {
            text = s;
