...
{
    public class Highlight_KW_DECIMALNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DECIMALNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DECIMALNonTermNode (string s, object positions)
        {
            text = s;
