...
{
    public class Highlight_KW_VIEWSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_VIEWSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_VIEWSNonTermNode (string s, object positions)
        {
            text = s;
