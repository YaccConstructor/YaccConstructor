...
{
    public class KW_DECIMALTermNode : ITreeNode
    {
        ...
        public KW_DECIMALTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DECIMALTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DECIMALTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
