...
{
    public class Yard_exp_brackets_142NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_142NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_142NonTermNode (string s, object positions)
        {
            text = s;
