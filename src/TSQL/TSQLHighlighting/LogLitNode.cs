...
{
    public class LogLitNode : ITreeNode
    {
        ...
        public LogLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public LogLitNode (string ycTokName, string ycValue)
        {
        ...
        public LogLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
