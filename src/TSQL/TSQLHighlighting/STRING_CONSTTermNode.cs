...
{
    public class STRING_CONSTTermNode : ITreeNode
    {
        ...
        public STRING_CONSTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public STRING_CONSTTermNode (string ycTokName, string ycValue)
        {
        ...
        public STRING_CONSTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
