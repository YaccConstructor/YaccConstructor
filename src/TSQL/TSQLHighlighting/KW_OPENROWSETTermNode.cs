...
{
    public class KW_OPENROWSETTermNode : ITreeNode
    {
        ...
        public KW_OPENROWSETTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OPENROWSETTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OPENROWSETTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
