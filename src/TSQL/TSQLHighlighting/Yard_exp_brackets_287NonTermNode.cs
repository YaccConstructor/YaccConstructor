...
{
    public class Yard_exp_brackets_287NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_287NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_287NonTermNode (string s, object positions)
        {
            text = s;
