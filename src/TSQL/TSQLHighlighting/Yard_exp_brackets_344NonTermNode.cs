...
{
    public class Yard_exp_brackets_344NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_344NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_344NonTermNode (string s, object positions)
        {
            text = s;
