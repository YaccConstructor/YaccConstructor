...
{
    public class Highlight_KW_RETURNNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_RETURNNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_RETURNNonTermNode (string s, object positions)
        {
            text = s;
