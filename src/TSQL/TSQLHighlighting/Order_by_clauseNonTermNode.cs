...
{
    public class Order_by_clauseNonTermNode : IAbstractTreeNode
    {
        ...
        public Order_by_clauseNonTermNode (string s)
        {
            text = s;
        }

        public Order_by_clauseNonTermNode (string s, object positions)
        {
            text = s;
