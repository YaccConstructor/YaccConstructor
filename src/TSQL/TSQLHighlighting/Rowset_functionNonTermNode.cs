...
{
    public class Rowset_functionNonTermNode : IAbstractTreeNode
    {
        ...
        public Rowset_functionNonTermNode (string s)
        {
            text = s;
        }

        public Rowset_functionNonTermNode (string s, object positions)
        {
            text = s;
