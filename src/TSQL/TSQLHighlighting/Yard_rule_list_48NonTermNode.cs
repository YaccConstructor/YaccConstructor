...
{
    public class Yard_rule_list_48NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_48NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_48NonTermNode (string s, object positions)
        {
            text = s;
