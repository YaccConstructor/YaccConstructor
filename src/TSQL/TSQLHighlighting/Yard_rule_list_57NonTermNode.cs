...
{
    public class Yard_rule_list_57NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_57NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_57NonTermNode (string s, object positions)
        {
            text = s;
