...
{
    public class KW_CREATETermNode : ITreeNode
    {
        ...
        public KW_CREATETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CREATETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CREATETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
