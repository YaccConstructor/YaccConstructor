...
{
    public class Yard_exp_brackets_247NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_247NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_247NonTermNode (string s, object positions)
        {
            text = s;
