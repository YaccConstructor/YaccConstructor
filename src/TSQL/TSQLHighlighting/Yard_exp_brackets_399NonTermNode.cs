...
{
    public class Yard_exp_brackets_399NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_399NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_399NonTermNode (string s, object positions)
        {
            text = s;
