...
{
    public class Highlight_KW_ELEMENTSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ELEMENTSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ELEMENTSNonTermNode (string s, object positions)
        {
            text = s;
