...
{
    public class Highlight_KW_FORCEPLANNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FORCEPLANNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FORCEPLANNonTermNode (string s, object positions)
        {
            text = s;
