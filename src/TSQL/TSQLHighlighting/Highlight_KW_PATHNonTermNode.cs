...
{
    public class Highlight_KW_PATHNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PATHNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PATHNonTermNode (string s, object positions)
        {
            text = s;
