...
{
    public class Highlight_KW_DECLARENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DECLARENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DECLARENonTermNode (string s, object positions)
        {
            text = s;
