...
{
    public class Yard_exp_brackets_161NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_161NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_161NonTermNode (string s, object positions)
        {
            text = s;
