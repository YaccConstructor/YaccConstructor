...
{
    public class KW_SERIALIZABLETermNode : ITreeNode
    {
        ...
        public KW_SERIALIZABLETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SERIALIZABLETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SERIALIZABLETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
