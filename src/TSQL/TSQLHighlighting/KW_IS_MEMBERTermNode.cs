...
{
    public class KW_IS_MEMBERTermNode : ITreeNode
    {
        ...
        public KW_IS_MEMBERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_IS_MEMBERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_IS_MEMBERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
