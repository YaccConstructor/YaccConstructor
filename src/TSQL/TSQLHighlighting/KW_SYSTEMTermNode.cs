...
{
    public class KW_SYSTEMTermNode : ITreeNode
    {
        ...
        public KW_SYSTEMTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SYSTEMTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SYSTEMTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
