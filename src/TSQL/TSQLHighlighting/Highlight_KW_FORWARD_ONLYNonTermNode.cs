...
{
    public class Highlight_KW_FORWARD_ONLYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FORWARD_ONLYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FORWARD_ONLYNonTermNode (string s, object positions)
        {
            text = s;
