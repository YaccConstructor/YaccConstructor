...
{
    public class KW_REMOTE_PROC_TRANSACTIONSTermNode : IAbstractTreeNode
    {
        ...
        public KW_REMOTE_PROC_TRANSACTIONSTermNode (string s)
        {
            text = s;
        }

        public KW_REMOTE_PROC_TRANSACTIONSTermNode (string s, object positions)
        {
            text = s;
