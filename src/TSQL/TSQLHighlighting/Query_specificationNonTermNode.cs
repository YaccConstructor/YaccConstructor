...
{
    public class Query_specificationNonTermNode : IAbstractTreeNode
    {
        ...
        public Query_specificationNonTermNode (string s)
        {
            text = s;
        }

        public Query_specificationNonTermNode (string s, object positions)
        {
            text = s;
