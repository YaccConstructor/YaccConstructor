...
{
    public class Highlight_KW_NOEXECNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NOEXECNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NOEXECNonTermNode (string s, object positions)
        {
            text = s;
