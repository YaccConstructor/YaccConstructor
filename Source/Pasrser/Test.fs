...
let test5 =[PLiteral("a",(1,1));PLiteral("+",(1,1));PLiteral("b",(1,1));PLiteral("+",(1,1));PLiteral("a",(1,1));PLiteral("$",(1,1))]
let test4= [PLiteral("a",(1,1));PLiteral("+",(1,1));PLiteral("b",(1,1));PLiteral("$",(1,1))] 