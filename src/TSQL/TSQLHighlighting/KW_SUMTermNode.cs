...
{
    public class KW_SUMTermNode : ITreeNode
    {
        ...
        public KW_SUMTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SUMTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SUMTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
