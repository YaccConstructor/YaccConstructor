...
{
    public class NowaitLitNode : ITreeNode
    {
        ...
        public NowaitLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public NowaitLitNode (string ycTokName, string ycValue)
        {
        ...
        public NowaitLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
