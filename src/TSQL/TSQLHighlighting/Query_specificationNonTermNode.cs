...
{
    public class Query_specificationNonTermNode : ITreeNode
    {
        ...
        public Query_specificationNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Query_specificationNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Query_specificationNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
