...
{
    public class Column_definitionNonTermNode : ITreeNode
    {
        ...
        public Column_definitionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Column_definitionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Column_definitionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
