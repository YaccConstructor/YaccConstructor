...
{
    public class Highlight_KW_REPEATABLEREADNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_REPEATABLEREADNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_REPEATABLEREADNonTermNode (string s, object positions)
        {
            text = s;
