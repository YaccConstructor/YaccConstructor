...
{
    public class Highlight_KW_EXECUTENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_EXECUTENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_EXECUTENonTermNode (string s, object positions)
        {
            text = s;
