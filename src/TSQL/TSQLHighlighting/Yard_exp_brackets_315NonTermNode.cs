...
{
    public class Yard_exp_brackets_315NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_315NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_315NonTermNode (string s, object positions)
        {
            text = s;
