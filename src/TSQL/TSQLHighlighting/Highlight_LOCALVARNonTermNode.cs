...
{
    public class Highlight_LOCALVARNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_LOCALVARNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_LOCALVARNonTermNode (string s, object positions)
        {
            text = s;
