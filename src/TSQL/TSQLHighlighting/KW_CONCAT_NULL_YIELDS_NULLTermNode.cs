...
{
    public class KW_CONCAT_NULL_YIELDS_NULLTermNode : IAbstractTreeNode
    {
        ...
        public KW_CONCAT_NULL_YIELDS_NULLTermNode (string s)
        {
            text = s;
        }

        public KW_CONCAT_NULL_YIELDS_NULLTermNode (string s, object positions)
        {
            text = s;
