...
mono ../YaccConstructor/bin/Release/YaccConstructor.exe -i SimpleCalc.yrd -c ExpandEbnf -c ExpandMeta \
         -g "RNGLRGenerator -pos int -token int -module RNGLR.ParseSimpleCalc -translate true -table LR -o SimpleCalc.yrd.fs" >> log.txt

mono ../YaccConstructor/bin/Release/YaccConstructor.exe -i Calc.yrd -c ExpandEbnf -c ExpandMeta \
         -g "RNGLRGenerator -pos int -token int -module RNGLR.ParseCalc -translate true -table LR -o Calc.yrd.fs" >> log.txt

mono ../YaccConstructor/bin/Release/YaccConstructor.exe -i simpleCalc_with_Nterms.yrd -c ExpandEbnf -c ExpandMeta \
...
mono ../YaccConstructor/bin/Release/YaccConstructor.exe -i simpleCalc_with_Nterms_2.yrd -c ExpandEbnf -c ExpandMeta \
...
mono ../YaccConstructor/bin/Release/YaccConstructor.exe -i simpleCalc_with_Nterms_3.yrd -c ExpandEbnf -c ExpandMeta \
