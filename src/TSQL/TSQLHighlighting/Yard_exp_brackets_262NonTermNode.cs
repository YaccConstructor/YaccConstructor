...
{
    public class Yard_exp_brackets_262NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_262NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_262NonTermNode (string s, object positions)
        {
            text = s;
