...
{
    public class Highlight_KW_TRANNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TRANNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TRANNonTermNode (string s, object positions)
        {
            text = s;
