...
{
    public class Yard_rule_comma_list_53NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_53NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_53NonTermNode (string s, object positions)
        {
            text = s;
