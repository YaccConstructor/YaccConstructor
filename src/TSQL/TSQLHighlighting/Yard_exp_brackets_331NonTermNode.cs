...
{
    public class Yard_exp_brackets_331NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_331NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_331NonTermNode (string s, object positions)
        {
            text = s;
