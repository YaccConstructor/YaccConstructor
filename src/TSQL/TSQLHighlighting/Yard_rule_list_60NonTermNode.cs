...
{
    public class Yard_rule_list_60NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_60NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_60NonTermNode (string s, object positions)
        {
            text = s;
