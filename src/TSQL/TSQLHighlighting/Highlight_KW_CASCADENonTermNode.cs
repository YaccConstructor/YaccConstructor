...
{
    public class Highlight_KW_CASCADENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CASCADENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CASCADENonTermNode (string s, object positions)
        {
            text = s;
