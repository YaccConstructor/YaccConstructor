...
{
    public class Highlight_KW_SHOWPLAN_TEXTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SHOWPLAN_TEXTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SHOWPLAN_TEXTNonTermNode (string s, object positions)
        {
            text = s;
