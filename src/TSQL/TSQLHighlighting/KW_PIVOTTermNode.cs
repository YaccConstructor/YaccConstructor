...
{
    public class KW_PIVOTTermNode : ITreeNode
    {
        ...
        public KW_PIVOTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PIVOTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PIVOTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
