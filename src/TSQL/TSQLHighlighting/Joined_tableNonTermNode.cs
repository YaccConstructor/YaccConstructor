...
{
    public class Joined_tableNonTermNode : ITreeNode
    {
        ...
        public Joined_tableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Joined_tableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Joined_tableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
