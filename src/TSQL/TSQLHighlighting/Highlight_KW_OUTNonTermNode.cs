...
{
    public class Highlight_KW_OUTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OUTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OUTNonTermNode (string s, object positions)
        {
            text = s;
