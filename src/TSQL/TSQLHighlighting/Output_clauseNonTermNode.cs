...
{
    public class Output_clauseNonTermNode : IAbstractTreeNode
    {
        ...
        public Output_clauseNonTermNode (string s)
        {
            text = s;
        }

        public Output_clauseNonTermNode (string s, object positions)
        {
            text = s;
