...
{
    public class Yard_exp_brackets_196NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_196NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_196NonTermNode (string s, object positions)
        {
            text = s;
