...
{
    public class Yard_rule_list_68NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_68NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_68NonTermNode (string s, object positions)
        {
            text = s;
