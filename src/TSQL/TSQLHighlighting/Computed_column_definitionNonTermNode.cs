...
{
    public class Computed_column_definitionNonTermNode : IAbstractTreeNode
    {
        ...
        public Computed_column_definitionNonTermNode (string s)
        {
            text = s;
        }

        public Computed_column_definitionNonTermNode (string s, object positions)
        {
            text = s;
