...
{
    public class Delete_updateNonTermNode : IAbstractTreeNode
    {
        ...
        public Delete_updateNonTermNode (string s)
        {
            text = s;
        }

        public Delete_updateNonTermNode (string s, object positions)
        {
            text = s;
