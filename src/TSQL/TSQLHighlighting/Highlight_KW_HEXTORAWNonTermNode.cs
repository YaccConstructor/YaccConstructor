...
{
    public class Highlight_KW_HEXTORAWNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_HEXTORAWNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_HEXTORAWNonTermNode (string s, object positions)
        {
            text = s;
