...
{
    public class Yard_exp_brackets_132NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_132NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_132NonTermNode (string s, object positions)
        {
            text = s;
