...
{
    public class Highlight_KW_RIGHTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_RIGHTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_RIGHTNonTermNode (string s, object positions)
        {
            text = s;
