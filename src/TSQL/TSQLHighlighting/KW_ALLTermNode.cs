...
{
    public class KW_ALLTermNode : ITreeNode
    {
        ...
        public KW_ALLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ALLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ALLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
