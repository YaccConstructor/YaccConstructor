...
{
    public class Yard_exp_brackets_120NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_120NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_120NonTermNode (string s, object positions)
        {
            text = s;
