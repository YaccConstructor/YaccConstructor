...
{
    public class Highlight_KW_SCROLLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SCROLLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SCROLLNonTermNode (string s, object positions)
        {
            text = s;
