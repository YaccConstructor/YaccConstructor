...
{
    public class Yard_exp_brackets_264NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_264NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_264NonTermNode (string s, object positions)
        {
            text = s;
