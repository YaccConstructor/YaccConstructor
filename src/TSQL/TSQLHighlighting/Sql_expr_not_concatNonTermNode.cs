...
{
    public class Sql_expr_not_concatNonTermNode : IAbstractTreeNode
    {
        ...
        public Sql_expr_not_concatNonTermNode (string s)
        {
            text = s;
        }

        public Sql_expr_not_concatNonTermNode (string s, object positions)
        {
            text = s;
