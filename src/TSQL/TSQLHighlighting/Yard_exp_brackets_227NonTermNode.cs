...
{
    public class Yard_exp_brackets_227NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_227NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_227NonTermNode (string s, object positions)
        {
            text = s;
