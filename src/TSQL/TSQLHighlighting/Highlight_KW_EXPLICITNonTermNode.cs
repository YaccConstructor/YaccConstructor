...
{
    public class Highlight_KW_EXPLICITNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_EXPLICITNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_EXPLICITNonTermNode (string s, object positions)
        {
            text = s;
