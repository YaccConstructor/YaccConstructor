...
{
    public class Yard_rule_list_51NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_51NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_51NonTermNode (string s, object positions)
        {
            text = s;
