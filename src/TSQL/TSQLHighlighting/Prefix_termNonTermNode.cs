...
{
    public class Prefix_termNonTermNode : ITreeNode
    {
        ...
        public Prefix_termNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Prefix_termNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Prefix_termNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
