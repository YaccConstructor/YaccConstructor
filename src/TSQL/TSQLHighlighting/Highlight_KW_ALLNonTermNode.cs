...
{
    public class Highlight_KW_ALLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ALLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ALLNonTermNode (string s, object positions)
        {
            text = s;
