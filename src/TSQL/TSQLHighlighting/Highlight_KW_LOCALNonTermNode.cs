...
{
    public class Highlight_KW_LOCALNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LOCALNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LOCALNonTermNode (string s, object positions)
        {
            text = s;
