...
{
    public class CloseLitNode : ITreeNode
    {
        ...
        public CloseLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public CloseLitNode (string ycTokName, string ycValue)
        {
        ...
        public CloseLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
