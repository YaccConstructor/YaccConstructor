...
{
    public class Highlight_KW_SEMICOLONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SEMICOLONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SEMICOLONNonTermNode (string s, object positions)
        {
            text = s;
