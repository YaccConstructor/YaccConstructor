...
{
    public class Yard_exp_brackets_336NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_336NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_336NonTermNode (string s, object positions)
        {
            text = s;
