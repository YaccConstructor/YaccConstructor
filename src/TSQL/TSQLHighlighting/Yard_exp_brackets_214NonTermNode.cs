...
{
    public class Yard_exp_brackets_214NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_214NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_214NonTermNode (string s, object positions)
        {
            text = s;
