...
{
    public class Highlight_KW_SERIALIZABLENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SERIALIZABLENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SERIALIZABLENonTermNode (string s, object positions)
        {
            text = s;
