...
{
    public class KW_SOMETermNode : ITreeNode
    {
        ...
        public KW_SOMETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SOMETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SOMETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
