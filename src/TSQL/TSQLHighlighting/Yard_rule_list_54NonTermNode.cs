...
{
    public class Yard_rule_list_54NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_54NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_54NonTermNode (string s, object positions)
        {
            text = s;
