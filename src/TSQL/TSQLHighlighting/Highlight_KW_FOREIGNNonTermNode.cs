...
{
    public class Highlight_KW_FOREIGNNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FOREIGNNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FOREIGNNonTermNode (string s, object positions)
        {
            text = s;
