...
{
    public class Column_definition_create_tableNonTermNode : IAbstractTreeNode
    {
        ...
        public Column_definition_create_tableNonTermNode (string s)
        {
            text = s;
        }

        public Column_definition_create_tableNonTermNode (string s, object positions)
        {
            text = s;
