...
{
    public class Highlight_KW_CONCATNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CONCATNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CONCATNonTermNode (string s, object positions)
        {
            text = s;
