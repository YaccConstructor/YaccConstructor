...
{
    public class Highlight_KW_LASTROWNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LASTROWNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LASTROWNonTermNode (string s, object positions)
        {
            text = s;
