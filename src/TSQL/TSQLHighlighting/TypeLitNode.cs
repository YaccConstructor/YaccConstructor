...
{
    public class TypeLitNode : ITreeNode
    {
        ...
        public TypeLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public TypeLitNode (string ycTokName, string ycValue)
        {
        ...
        public TypeLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
