...
{
    public class Yard_rule_comma_list_35NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_35NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_35NonTermNode (string s, object positions)
        {
            text = s;
