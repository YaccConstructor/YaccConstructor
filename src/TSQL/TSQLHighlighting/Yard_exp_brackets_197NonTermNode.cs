...
{
    public class Yard_exp_brackets_197NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_197NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_197NonTermNode (string s, object positions)
        {
            text = s;
