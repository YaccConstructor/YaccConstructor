...
{
    public class Highlight_KW_ROWGUIDCOLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROWGUIDCOLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROWGUIDCOLNonTermNode (string s, object positions)
        {
            text = s;
