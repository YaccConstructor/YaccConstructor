...
{
    public class While_stmtNonTermNode : ITreeNode
    {
        ...
        public While_stmtNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public While_stmtNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public While_stmtNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
