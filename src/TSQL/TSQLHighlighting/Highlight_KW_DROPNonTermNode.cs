...
{
    public class Highlight_KW_DROPNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DROPNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DROPNonTermNode (string s, object positions)
        {
            text = s;
