...
{
    public class Yard_exp_brackets_350NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_350NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_350NonTermNode (string s, object positions)
        {
            text = s;
