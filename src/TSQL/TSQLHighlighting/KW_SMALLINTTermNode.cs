...
{
    public class KW_SMALLINTTermNode : ITreeNode
    {
        ...
        public KW_SMALLINTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SMALLINTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SMALLINTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
