...
{
    public class Yard_exp_brackets_361NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_361NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_361NonTermNode (string s, object positions)
        {
            text = s;
