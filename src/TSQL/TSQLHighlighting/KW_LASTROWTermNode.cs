...
{
    public class KW_LASTROWTermNode : ITreeNode
    {
        ...
        public KW_LASTROWTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LASTROWTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LASTROWTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
