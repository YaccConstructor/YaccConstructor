...
{
    public class Yard_exp_brackets_158NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_158NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_158NonTermNode (string s, object positions)
        {
            text = s;
