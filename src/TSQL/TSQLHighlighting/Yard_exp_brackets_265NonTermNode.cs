...
{
    public class Yard_exp_brackets_265NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_265NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_265NonTermNode (string s, object positions)
        {
            text = s;
