...
{
    public class KW_SYSNAMETermNode : ITreeNode
    {
        ...
        public KW_SYSNAMETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SYSNAMETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SYSNAMETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
