...
{
    public class Yard_exp_brackets_302NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_302NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_302NonTermNode (string s, object positions)
        {
            text = s;
