...
{
    public class Highlight_KW_SOMENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SOMENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SOMENonTermNode (string s, object positions)
        {
            text = s;
