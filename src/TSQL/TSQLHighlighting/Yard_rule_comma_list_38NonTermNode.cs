...
{
    public class Yard_rule_comma_list_38NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_38NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_38NonTermNode (string s, object positions)
        {
            text = s;
