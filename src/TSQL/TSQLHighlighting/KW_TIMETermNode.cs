...
{
    public class KW_TIMETermNode : ITreeNode
    {
        ...
        public KW_TIMETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TIMETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TIMETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
