...
{
    public class Highlight_KW_ATNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ATNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ATNonTermNode (string s, object positions)
        {
            text = s;
