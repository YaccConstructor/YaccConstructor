...
{
    public class Table_constraintNonTermNode : ITreeNode
    {
        ...
        public Table_constraintNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Table_constraintNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Table_constraintNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
