...
{
    public class Yard_exp_brackets_381NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_381NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_381NonTermNode (string s, object positions)
        {
            text = s;
