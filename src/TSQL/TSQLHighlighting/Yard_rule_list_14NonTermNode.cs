...
{
    public class Yard_rule_list_14NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_14NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_14NonTermNode (string s, object positions)
        {
            text = s;
