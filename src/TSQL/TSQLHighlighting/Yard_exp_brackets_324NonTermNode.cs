...
{
    public class Yard_exp_brackets_324NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_324NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_324NonTermNode (string s, object positions)
        {
            text = s;
