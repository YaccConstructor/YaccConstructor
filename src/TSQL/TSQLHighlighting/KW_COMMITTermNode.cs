...
{
    public class KW_COMMITTermNode : ITreeNode
    {
        ...
        public KW_COMMITTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_COMMITTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_COMMITTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
