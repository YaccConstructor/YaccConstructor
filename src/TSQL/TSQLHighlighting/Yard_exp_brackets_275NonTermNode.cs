...
{
    public class Yard_exp_brackets_275NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_275NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_275NonTermNode (string s, object positions)
        {
            text = s;
