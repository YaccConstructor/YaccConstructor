...
{
    public class Yard_exp_brackets_391NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_391NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_391NonTermNode (string s, object positions)
        {
            text = s;
