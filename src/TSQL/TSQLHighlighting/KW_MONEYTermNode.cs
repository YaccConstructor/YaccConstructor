...
{
    public class KW_MONEYTermNode : ITreeNode
    {
        ...
        public KW_MONEYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MONEYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MONEYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
