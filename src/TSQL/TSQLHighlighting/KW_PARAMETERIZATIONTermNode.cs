...
{
    public class KW_PARAMETERIZATIONTermNode : ITreeNode
    {
        ...
        public KW_PARAMETERIZATIONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PARAMETERIZATIONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PARAMETERIZATIONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
