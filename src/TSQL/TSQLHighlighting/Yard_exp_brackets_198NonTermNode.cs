...
{
    public class Yard_exp_brackets_198NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_198NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_198NonTermNode (string s, object positions)
        {
            text = s;
