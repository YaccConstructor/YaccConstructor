...
{
    public class Highlight_MINNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_MINNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_MINNonTermNode (string s, object positions)
        {
            text = s;
