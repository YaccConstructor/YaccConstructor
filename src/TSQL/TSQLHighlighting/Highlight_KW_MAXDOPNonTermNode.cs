...
{
    public class Highlight_KW_MAXDOPNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MAXDOPNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MAXDOPNonTermNode (string s, object positions)
        {
            text = s;
