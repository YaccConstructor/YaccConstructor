...
{
    public class Yard_rule_list_45NonTermNode : ITreeNode
    {
        ...
        public Yard_rule_list_45NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_rule_list_45NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_rule_list_45NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
