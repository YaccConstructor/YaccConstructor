...
{
    public class Yard_exp_brackets_349NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_349NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_349NonTermNode (string s, object positions)
        {
            text = s;
