...
{
    public class KW_TABLESAMPLETermNode : ITreeNode
    {
        ...
        public KW_TABLESAMPLETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TABLESAMPLETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TABLESAMPLETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
