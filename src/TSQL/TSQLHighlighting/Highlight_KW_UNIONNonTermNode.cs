...
{
    public class Highlight_KW_UNIONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_UNIONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_UNIONNonTermNode (string s, object positions)
        {
            text = s;
