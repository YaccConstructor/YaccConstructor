...
{
    public class KW_EXCEPTTermNode : ITreeNode
    {
        ...
        public KW_EXCEPTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_EXCEPTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_EXCEPTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
