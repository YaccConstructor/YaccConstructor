...
{
    public class Highlight_KW_DENSE_RANKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DENSE_RANKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DENSE_RANKNonTermNode (string s, object positions)
        {
            text = s;
