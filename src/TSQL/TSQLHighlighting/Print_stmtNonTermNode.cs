...
{
    public class Print_stmtNonTermNode : ITreeNode
    {
        ...
        public Print_stmtNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Print_stmtNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Print_stmtNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
