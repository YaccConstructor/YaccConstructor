...
{
    public class Highlight_MAXNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_MAXNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_MAXNonTermNode (string s, object positions)
        {
            text = s;
