...
{
    public class KW_MAXRECURSIONTermNode : ITreeNode
    {
        ...
        public KW_MAXRECURSIONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MAXRECURSIONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MAXRECURSIONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
