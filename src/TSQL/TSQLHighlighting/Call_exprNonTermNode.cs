...
{
    public class Call_exprNonTermNode : ITreeNode
    {
        ...
        public Call_exprNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Call_exprNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Call_exprNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
