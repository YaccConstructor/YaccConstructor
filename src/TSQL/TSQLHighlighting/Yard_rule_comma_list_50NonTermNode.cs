...
{
    public class Yard_rule_comma_list_50NonTermNode : ITreeNode
    {
        ...
        public Yard_rule_comma_list_50NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_rule_comma_list_50NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_rule_comma_list_50NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
