...
{
    public class Begin_transactionNonTermNode : IAbstractTreeNode
    {
        ...
        public Begin_transactionNonTermNode (string s)
        {
            text = s;
        }

        public Begin_transactionNonTermNode (string s, object positions)
        {
            text = s;
