...
{
    public class Yard_exp_brackets_130NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_130NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_130NonTermNode (string s, object positions)
        {
            text = s;
