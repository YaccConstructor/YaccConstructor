...
{
    public class Yard_exp_brackets_184NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_184NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_184NonTermNode (string s, object positions)
        {
            text = s;
