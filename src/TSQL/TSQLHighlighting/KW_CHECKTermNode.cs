...
{
    public class KW_CHECKTermNode : ITreeNode
    {
        ...
        public KW_CHECKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CHECKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CHECKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
