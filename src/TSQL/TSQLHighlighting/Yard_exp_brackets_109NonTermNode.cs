...
{
    public class Yard_exp_brackets_109NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_109NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_109NonTermNode (string s, object positions)
        {
            text = s;
