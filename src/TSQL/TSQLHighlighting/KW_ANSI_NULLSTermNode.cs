...
{
    public class KW_ANSI_NULLSTermNode : ITreeNode
    {
        ...
        public KW_ANSI_NULLSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ANSI_NULLSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ANSI_NULLSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
