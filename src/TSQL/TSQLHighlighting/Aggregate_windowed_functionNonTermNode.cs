...
{
    public class Aggregate_windowed_functionNonTermNode : IAbstractTreeNode
    {
        ...
        public Aggregate_windowed_functionNonTermNode (string s)
        {
            text = s;
        }

        public Aggregate_windowed_functionNonTermNode (string s, object positions)
        {
            text = s;
