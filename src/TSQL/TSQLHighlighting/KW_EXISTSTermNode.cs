...
{
    public class KW_EXISTSTermNode : ITreeNode
    {
        ...
        public KW_EXISTSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_EXISTSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_EXISTSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
