...
{
    public class Highlight_KW_ENDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ENDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ENDNonTermNode (string s, object positions)
        {
            text = s;
