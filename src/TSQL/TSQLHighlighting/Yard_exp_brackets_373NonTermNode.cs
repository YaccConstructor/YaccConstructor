...
{
    public class Yard_exp_brackets_373NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_373NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_373NonTermNode (string s, object positions)
        {
            text = s;
