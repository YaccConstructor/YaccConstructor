...
{
    public class Highlight_KW_CUBENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CUBENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CUBENonTermNode (string s, object positions)
        {
            text = s;
