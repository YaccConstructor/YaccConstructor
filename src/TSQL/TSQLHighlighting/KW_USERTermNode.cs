...
{
    public class KW_USERTermNode : ITreeNode
    {
        ...
        public KW_USERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_USERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_USERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
