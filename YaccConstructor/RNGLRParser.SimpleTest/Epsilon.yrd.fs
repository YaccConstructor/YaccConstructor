...
let _rnglr_epsilons : Tree<Token>[] = [|new Tree<_>([|NonTerm ([|new Family(6, [|1; 2; 3|])|]); NonTerm ([|new Family(0, [||])|]); NonTerm ([|new Family(2, [||])|]); NonTerm ([|new Family(4, [||])|])|],null,0); new Tree<_>([|NonTerm ([|new Family(0, [||])|])|],null,0); new Tree<_>([|NonTerm ([|new Family(2, [||])|])|],null,0); new Tree<_>([|NonTerm ([|new Family(4, [||])|])|],null,0); new Tree<_>([|NonTerm ([|new Family(7, [|1|])|]); NonTerm ([|new Family(6, [|2; 3; 4|])|]); NonTerm ([|new Family(0, [||])|]); NonTerm ([|new Family(2, [||])|]); NonTerm ([|new Family(4, [||])|])|],null,0)|]
