...
{
    public class ValueNonTermNode : ITreeNode
    {
        ...
        public ValueNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ValueNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public ValueNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
