...
{
    public class Highlight_POWNonTermNode : IAbstractTreeNode
    {
        ...
        private string text;
        public Highlight_POWNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_POWNonTermNode (string s, object positions)
        {
            text = s;
