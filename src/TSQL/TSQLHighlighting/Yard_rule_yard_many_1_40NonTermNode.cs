...
{
    public class Yard_rule_yard_many_1_40NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_40NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_40NonTermNode (string s, object positions)
        {
            text = s;
