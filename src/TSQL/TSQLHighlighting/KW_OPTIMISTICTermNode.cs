...
{
    public class KW_OPTIMISTICTermNode : ITreeNode
    {
        ...
        public KW_OPTIMISTICTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OPTIMISTICTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OPTIMISTICTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
