...
{
    public class KW_STATICTermNode : ITreeNode
    {
        ...
        public KW_STATICTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_STATICTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_STATICTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
