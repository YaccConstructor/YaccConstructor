...
let gotoSet = 
Set.ofArray [|(-125610634,("s",2));(-125610665,("raccStart",2));(-83341596,("s",0));(-83341819,("s",0));(1290233087,("raccStart",1));(1413080974,("s",2));(1471347740,("s",0))|]
