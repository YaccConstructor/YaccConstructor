...
let _rnglr_epsilons : Tree<Token>[] = [|new Tree<_>(null,NonTerm (new Children(new UsualOne<_>(new Family(6, [|NonTerm (new Children(new UsualOne<_>(new Family(0, [||]), [||]))); NonTerm (new Children(new UsualOne<_>(new Family(2, [||]), [||]))); NonTerm (new Children(new UsualOne<_>(new Family(4, [||]), [||])))|]), [||])))); new Tree<_>(null,NonTerm (new Children(new UsualOne<_>(new Family(0, [||]), [||])))); new Tree<_>(null,NonTerm (new Children(new UsualOne<_>(new Family(2, [||]), [||])))); new Tree<_>(null,NonTerm (new Children(new UsualOne<_>(new Family(4, [||]), [||])))); new Tree<_>(null,NonTerm (new Children(new UsualOne<_>(new Family(7, [|NonTerm (new Children(new UsualOne<_>(new Family(6, [|NonTerm (new Children(new UsualOne<_>(new Family(0, [||]), [||]))); NonTerm (new Children(new UsualOne<_>(new Family(2, [||]), [||]))); NonTerm (new Children(new UsualOne<_>(new Family(4, [||]), [||])))|]), [||])))|]), [||]))))|]
