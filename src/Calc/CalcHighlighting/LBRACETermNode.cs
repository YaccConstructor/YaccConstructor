...
{
    public class LBRACETermNode : ITreeNode
    {
        ...
        public LBRACETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public LBRACETermNode (string ycTokName, string ycValue)
        {
        ...
        public LBRACETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
