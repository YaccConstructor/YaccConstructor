...
{
    public class Yard_exp_brackets_157NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_157NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_157NonTermNode (string s, object positions)
        {
            text = s;
