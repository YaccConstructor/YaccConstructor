...
{
    public class Yard_exp_brackets_206NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_206NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_206NonTermNode (string s, object positions)
        {
            text = s;
