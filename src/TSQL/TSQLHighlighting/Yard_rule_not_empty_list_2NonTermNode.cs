...
{
    public class Yard_rule_not_empty_list_2NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_not_empty_list_2NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_not_empty_list_2NonTermNode (string s, object positions)
        {
            text = s;
