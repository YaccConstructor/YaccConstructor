...
{
    public class Highlight_KW_CLUSTEREDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CLUSTEREDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CLUSTEREDNonTermNode (string s, object positions)
        {
            text = s;
