...
{
    public class Highlight_KW_FROMNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FROMNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FROMNonTermNode (string s, object positions)
        {
            text = s;
