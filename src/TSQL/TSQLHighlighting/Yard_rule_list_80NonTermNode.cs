...
{
    public class Yard_rule_list_80NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_80NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_80NonTermNode (string s, object positions)
        {
            text = s;
