...
{
    public class Highlight_comma_NonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_comma_NonTermNode (string s)
        {
            text = s;
        }

        public Highlight_comma_NonTermNode (string s, object positions)
        {
            text = s;
