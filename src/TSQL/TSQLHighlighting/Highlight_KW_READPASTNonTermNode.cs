...
{
    public class Highlight_KW_READPASTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_READPASTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_READPASTNonTermNode (string s, object positions)
        {
            text = s;
