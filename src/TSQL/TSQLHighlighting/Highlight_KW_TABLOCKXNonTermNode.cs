...
{
    public class Highlight_KW_TABLOCKXNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TABLOCKXNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TABLOCKXNonTermNode (string s, object positions)
        {
            text = s;
