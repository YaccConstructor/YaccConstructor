...
{
    public class KW_XMLDATATermNode : ITreeNode
    {
        ...
        public KW_XMLDATATermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_XMLDATATermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_XMLDATATermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
