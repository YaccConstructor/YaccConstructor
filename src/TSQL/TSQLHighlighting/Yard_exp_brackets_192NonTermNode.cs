...
{
    public class Yard_exp_brackets_192NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_192NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_192NonTermNode (string s, object positions)
        {
            text = s;
