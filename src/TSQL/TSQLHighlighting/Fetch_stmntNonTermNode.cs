...
{
    public class Fetch_stmntNonTermNode : ITreeNode
    {
        ...
        public Fetch_stmntNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Fetch_stmntNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Fetch_stmntNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
