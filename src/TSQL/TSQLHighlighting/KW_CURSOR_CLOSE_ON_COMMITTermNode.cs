...
{
    public class KW_CURSOR_CLOSE_ON_COMMITTermNode : IAbstractTreeNode
    {
        ...
        public KW_CURSOR_CLOSE_ON_COMMITTermNode (string s)
        {
            text = s;
        }

        public KW_CURSOR_CLOSE_ON_COMMITTermNode (string s, object positions)
        {
            text = s;
