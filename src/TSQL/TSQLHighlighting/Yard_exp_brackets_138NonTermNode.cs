...
{
    public class Yard_exp_brackets_138NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_138NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_138NonTermNode (string s, object positions)
        {
            text = s;
