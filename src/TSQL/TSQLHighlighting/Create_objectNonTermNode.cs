...
{
    public class Create_objectNonTermNode : IAbstractTreeNode
    {
        ...
        public Create_objectNonTermNode (string s)
        {
            text = s;
        }

        public Create_objectNonTermNode (string s, object positions)
        {
            text = s;
