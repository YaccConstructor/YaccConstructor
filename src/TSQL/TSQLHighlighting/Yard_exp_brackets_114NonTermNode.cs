...
{
    public class Yard_exp_brackets_114NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_114NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_114NonTermNode (string s, object positions)
        {
            text = s;
