...
{
    public class KW_LANGUAGETermNode : ITreeNode
    {
        ...
        public KW_LANGUAGETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LANGUAGETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LANGUAGETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
