...
{
    public class KW_FORMSOFTermNode : ITreeNode
    {
        ...
        public KW_FORMSOFTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FORMSOFTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FORMSOFTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
