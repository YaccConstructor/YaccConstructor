...
{
    public class KW_THENTermNode : ITreeNode
    {
        ...
        public KW_THENTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_THENTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_THENTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
