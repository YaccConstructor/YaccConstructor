...
{
    public class Yard_exp_brackets_321NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_321NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_321NonTermNode (string s, object positions)
        {
            text = s;
