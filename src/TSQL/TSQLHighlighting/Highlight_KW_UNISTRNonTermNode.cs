...
{
    public class Highlight_KW_UNISTRNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_UNISTRNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_UNISTRNonTermNode (string s, object positions)
        {
            text = s;
