...
{
    public class Highlight_KW_XSINILNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_XSINILNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_XSINILNonTermNode (string s, object positions)
        {
            text = s;
