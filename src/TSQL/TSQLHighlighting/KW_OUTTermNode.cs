...
{
    public class KW_OUTTermNode : ITreeNode
    {
        ...
        public KW_OUTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OUTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OUTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
