...
{
    public class Highlight_KW_PROCEDURENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PROCEDURENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PROCEDURENonTermNode (string s, object positions)
        {
            text = s;
