...
{
    public class KW_OUTPUTTermNode : ITreeNode
    {
        ...
        public KW_OUTPUTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OUTPUTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OUTPUTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
