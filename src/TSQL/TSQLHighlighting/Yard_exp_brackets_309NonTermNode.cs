...
{
    public class Yard_exp_brackets_309NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_309NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_309NonTermNode (string s, object positions)
        {
            text = s;
