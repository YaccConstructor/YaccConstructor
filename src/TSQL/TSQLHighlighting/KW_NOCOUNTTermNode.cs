...
{
    public class KW_NOCOUNTTermNode : ITreeNode
    {
        ...
        public KW_NOCOUNTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NOCOUNTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NOCOUNTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
