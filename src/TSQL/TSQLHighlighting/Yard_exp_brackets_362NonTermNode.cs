...
{
    public class Yard_exp_brackets_362NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_362NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_362NonTermNode (string s, object positions)
        {
            text = s;
