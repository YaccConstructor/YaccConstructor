...
{
    public class Yard_exp_brackets_282NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_282NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_282NonTermNode (string s, object positions)
        {
            text = s;
