...
{
    public class KW_MAXTermNode : ITreeNode
    {
        ...
        public KW_MAXTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MAXTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MAXTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
