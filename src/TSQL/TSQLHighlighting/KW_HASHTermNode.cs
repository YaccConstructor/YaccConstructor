...
{
    public class KW_HASHTermNode : ITreeNode
    {
        ...
        public KW_HASHTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_HASHTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_HASHTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
