...
{
    public class ErrorNonTermNode : ITreeNode
    {
        ...
        public ErrorNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ErrorNonTermNode (string ycTokName, string ycValue)
        {
