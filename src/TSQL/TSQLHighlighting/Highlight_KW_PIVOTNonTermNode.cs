...
{
    public class Highlight_KW_PIVOTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PIVOTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PIVOTNonTermNode (string s, object positions)
        {
            text = s;
