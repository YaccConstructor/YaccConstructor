...
{
    public class Yard_exp_brackets_290NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_290NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_290NonTermNode (string s, object positions)
        {
            text = s;
