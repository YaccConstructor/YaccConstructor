...
{
    public class Yard_exp_brackets_333NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_333NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_333NonTermNode (string s, object positions)
        {
            text = s;
