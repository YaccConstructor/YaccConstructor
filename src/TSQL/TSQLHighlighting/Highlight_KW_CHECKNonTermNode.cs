...
{
    public class Highlight_KW_CHECKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CHECKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CHECKNonTermNode (string s, object positions)
        {
            text = s;
