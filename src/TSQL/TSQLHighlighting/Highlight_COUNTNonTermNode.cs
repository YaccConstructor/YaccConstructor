...
{
    public class Highlight_COUNTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_COUNTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_COUNTNonTermNode (string s, object positions)
        {
            text = s;
