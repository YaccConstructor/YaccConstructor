...
{
    public class Yard_exp_brackets_372NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_372NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_372NonTermNode (string s, object positions)
        {
            text = s;
