...
{
    public class Yard_exp_brackets_199NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_199NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_199NonTermNode (string s, object positions)
        {
            text = s;
