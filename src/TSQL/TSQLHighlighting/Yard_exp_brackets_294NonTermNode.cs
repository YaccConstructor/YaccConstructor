...
{
    public class Yard_exp_brackets_294NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_294NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_294NonTermNode (string s, object positions)
        {
            text = s;
