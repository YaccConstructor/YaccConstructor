...
{
    public class Yard_exp_brackets_304NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_304NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_304NonTermNode (string s, object positions)
        {
            text = s;
