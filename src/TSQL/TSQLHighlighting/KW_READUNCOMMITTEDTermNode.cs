...
{
    public class KW_READUNCOMMITTEDTermNode : IAbstractTreeNode
    {
        ...
        public KW_READUNCOMMITTEDTermNode (string s)
        {
            text = s;
        }

        public KW_READUNCOMMITTEDTermNode (string s, object positions)
        {
            text = s;
