...
{
    public class Yard_exp_brackets_329NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_329NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_329NonTermNode (string s, object positions)
        {
            text = s;
