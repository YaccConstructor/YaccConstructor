...
{
    public class KW_ONTermNode : ITreeNode
    {
        ...
        public KW_ONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
