...
{
    public class FactorNonTermNode : ITreeNode
    {
        ...
        public FactorNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public FactorNonTermNode (string ycTokName, string ycValue)
        {
