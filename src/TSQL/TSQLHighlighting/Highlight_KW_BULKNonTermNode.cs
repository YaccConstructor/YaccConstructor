...
{
    public class Highlight_KW_BULKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BULKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BULKNonTermNode (string s, object positions)
        {
            text = s;
