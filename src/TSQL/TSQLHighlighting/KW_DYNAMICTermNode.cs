...
{
    public class KW_DYNAMICTermNode : ITreeNode
    {
        ...
        public KW_DYNAMICTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DYNAMICTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DYNAMICTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
