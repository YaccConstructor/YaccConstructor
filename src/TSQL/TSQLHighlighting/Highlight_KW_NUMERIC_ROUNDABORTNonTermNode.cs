...
{
    public class Highlight_KW_NUMERIC_ROUNDABORTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NUMERIC_ROUNDABORTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NUMERIC_ROUNDABORTNonTermNode (string s, object positions)
        {
            text = s;
