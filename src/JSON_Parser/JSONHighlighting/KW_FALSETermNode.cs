...
{
    public class KW_FALSETermNode : ITreeNode
    {
        ...
        public KW_FALSETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FALSETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FALSETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
