...
{
    public class Yard_rule_comma_list_50NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_50NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_50NonTermNode (string s, object positions)
        {
            text = s;
