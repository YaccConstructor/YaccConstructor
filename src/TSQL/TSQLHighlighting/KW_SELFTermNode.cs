...
{
    public class KW_SELFTermNode : ITreeNode
    {
        ...
        public KW_SELFTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SELFTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SELFTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
