...
{
    public class KW_GROUPTermNode : ITreeNode
    {
        ...
        public KW_GROUPTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_GROUPTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_GROUPTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
