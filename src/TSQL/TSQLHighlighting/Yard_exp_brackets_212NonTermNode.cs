...
{
    public class Yard_exp_brackets_212NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_212NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_212NonTermNode (string s, object positions)
        {
            text = s;
