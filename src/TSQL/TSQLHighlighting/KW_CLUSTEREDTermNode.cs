...
{
    public class KW_CLUSTEREDTermNode : ITreeNode
    {
        ...
        public KW_CLUSTEREDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CLUSTEREDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CLUSTEREDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
