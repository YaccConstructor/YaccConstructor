...
{
    public class Highlight_KW_COLLATENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_COLLATENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_COLLATENonTermNode (string s, object positions)
        {
            text = s;
