...
{
    public class Yard_exp_brackets_267NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_267NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_267NonTermNode (string s, object positions)
        {
            text = s;
