...
{
    public class Highlight_KW_INTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_INTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_INTNonTermNode (string s, object positions)
        {
            text = s;
