...
{
    public class Yard_exp_brackets_387NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_387NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_387NonTermNode (string s, object positions)
        {
            text = s;
