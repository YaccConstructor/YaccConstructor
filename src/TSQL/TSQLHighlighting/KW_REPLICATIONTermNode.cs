...
{
    public class KW_REPLICATIONTermNode : ITreeNode
    {
        ...
        public KW_REPLICATIONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_REPLICATIONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_REPLICATIONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
