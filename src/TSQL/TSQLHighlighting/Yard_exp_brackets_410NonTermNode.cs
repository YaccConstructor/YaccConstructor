...
{
    public class Yard_exp_brackets_410NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_410NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_410NonTermNode (string s, object positions)
        {
            text = s;
