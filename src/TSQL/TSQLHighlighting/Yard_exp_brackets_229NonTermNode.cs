...
{
    public class Yard_exp_brackets_229NonTermNode : ITreeNode
    {
        ...
        public Yard_exp_brackets_229NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_exp_brackets_229NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_exp_brackets_229NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
