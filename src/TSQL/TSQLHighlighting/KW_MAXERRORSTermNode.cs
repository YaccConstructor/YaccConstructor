...
{
    public class KW_MAXERRORSTermNode : ITreeNode
    {
        ...
        public KW_MAXERRORSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MAXERRORSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MAXERRORSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
