...
{
    public class DIVTermNode : ITreeNode
    {
        ...
        public DIVTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public DIVTermNode (string ycTokName, string ycValue)
        {
        ...
        public DIVTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
