...
{
    public class Yard_exp_brackets_261NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_261NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_261NonTermNode (string s, object positions)
        {
            text = s;
