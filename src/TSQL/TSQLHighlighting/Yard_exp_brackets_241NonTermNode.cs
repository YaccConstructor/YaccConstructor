...
{
    public class Yard_exp_brackets_241NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_241NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_241NonTermNode (string s, object positions)
        {
            text = s;
