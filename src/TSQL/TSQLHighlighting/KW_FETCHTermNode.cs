...
{
    public class KW_FETCHTermNode : ITreeNode
    {
        ...
        public KW_FETCHTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FETCHTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FETCHTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
