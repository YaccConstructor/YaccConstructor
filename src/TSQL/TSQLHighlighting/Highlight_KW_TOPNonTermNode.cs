...
{
    public class Highlight_KW_TOPNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TOPNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TOPNonTermNode (string s, object positions)
        {
            text = s;
