...
{
    public class Yard_exp_brackets_140NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_140NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_140NonTermNode (string s, object positions)
        {
            text = s;
