...
{
    public class KW_CROSSTermNode : ITreeNode
    {
        ...
        public KW_CROSSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CROSSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CROSSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
