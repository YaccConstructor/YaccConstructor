...
{
    public class Yard_exp_brackets_108NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_108NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_108NonTermNode (string s, object positions)
        {
            text = s;
