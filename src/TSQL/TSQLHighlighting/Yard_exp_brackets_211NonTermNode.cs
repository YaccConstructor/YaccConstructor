...
{
    public class Yard_exp_brackets_211NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_211NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_211NonTermNode (string s, object positions)
        {
            text = s;
