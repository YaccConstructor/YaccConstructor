...
{
    public class Dml_select_listNonTermNode : IAbstractTreeNode
    {
        ...
        public Dml_select_listNonTermNode (string s)
        {
            text = s;
        }

        public Dml_select_listNonTermNode (string s, object positions)
        {
            text = s;
