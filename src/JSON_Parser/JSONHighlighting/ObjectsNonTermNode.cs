...
{
    public class ObjectsNonTermNode : ITreeNode
    {
        ...
        public ObjectsNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ObjectsNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public ObjectsNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
