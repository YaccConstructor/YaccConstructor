...
{
    public class KW_PROCEDURETermNode : ITreeNode
    {
        ...
        public KW_PROCEDURETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PROCEDURETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PROCEDURETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
