...
{
    public class Highlight_KW_KEEPNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_KEEPNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_KEEPNonTermNode (string s, object positions)
        {
            text = s;
