...
{
    public class KW_IOTermNode : ITreeNode
    {
        ...
        public KW_IOTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_IOTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_IOTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
