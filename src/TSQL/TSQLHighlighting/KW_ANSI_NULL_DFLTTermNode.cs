...
{
    public class KW_ANSI_NULL_DFLTTermNode : IAbstractTreeNode
    {
        ...
        public KW_ANSI_NULL_DFLTTermNode (string s)
        {
            text = s;
        }

        public KW_ANSI_NULL_DFLTTermNode (string s, object positions)
        {
            text = s;
