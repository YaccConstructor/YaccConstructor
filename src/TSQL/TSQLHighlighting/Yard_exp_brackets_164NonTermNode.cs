...
{
    public class Yard_exp_brackets_164NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_164NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_164NonTermNode (string s, object positions)
        {
            text = s;
