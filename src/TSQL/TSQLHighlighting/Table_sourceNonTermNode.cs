...
{
    public class Table_sourceNonTermNode : ITreeNode
    {
        ...
        public Table_sourceNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Table_sourceNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Table_sourceNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
