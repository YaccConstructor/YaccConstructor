...
{
    public class Highlight_DIVNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_DIVNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_DIVNonTermNode (string s, object positions)
        {
            text = s;
