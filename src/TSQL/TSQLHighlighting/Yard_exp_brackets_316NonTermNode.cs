...
{
    public class Yard_exp_brackets_316NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_316NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_316NonTermNode (string s, object positions)
        {
            text = s;
