...
{
    public class Highlight_KW_ROW_NUMBERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROW_NUMBERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROW_NUMBERNonTermNode (string s, object positions)
        {
            text = s;
