...
{
    public class Delete_update_optionsNonTermNode : ITreeNode
    {
        ...
        public Delete_update_optionsNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Delete_update_optionsNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Delete_update_optionsNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
