...
{
    public class Yard_exp_brackets_355NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_355NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_355NonTermNode (string s, object positions)
        {
            text = s;
