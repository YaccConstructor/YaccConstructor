...
{
    public class Highlight_KW_OUTPUTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OUTPUTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OUTPUTNonTermNode (string s, object positions)
        {
            text = s;
