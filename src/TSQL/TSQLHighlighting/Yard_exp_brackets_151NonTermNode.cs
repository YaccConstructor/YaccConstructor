...
{
    public class Yard_exp_brackets_151NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_151NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_151NonTermNode (string s, object positions)
        {
            text = s;
