...
{
    public class Highlight_MULTNonTermNode : IAbstractTreeNode
    {
        ...
        private string text;
        public Highlight_MULTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_MULTNonTermNode (string s, object positions)
        {
            text = s;
