...
{
    public class KW_CONCAT_NULL_YIELDS_NULLTermNode : ITreeNode
    {
        ...
        public KW_CONCAT_NULL_YIELDS_NULLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CONCAT_NULL_YIELDS_NULLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CONCAT_NULL_YIELDS_NULLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
