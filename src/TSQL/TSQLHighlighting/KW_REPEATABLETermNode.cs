...
{
    public class KW_REPEATABLETermNode : ITreeNode
    {
        ...
        public KW_REPEATABLETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_REPEATABLETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_REPEATABLETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
