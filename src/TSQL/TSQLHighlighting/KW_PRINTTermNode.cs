...
{
    public class KW_PRINTTermNode : ITreeNode
    {
        ...
        public KW_PRINTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PRINTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PRINTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
