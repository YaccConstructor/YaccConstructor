...
{
    public class Commit_transactionNonTermNode : ITreeNode
    {
        ...
        public Commit_transactionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Commit_transactionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Commit_transactionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
