...
{
    public class Yard_exp_brackets_216NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_216NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_216NonTermNode (string s, object positions)
        {
            text = s;
