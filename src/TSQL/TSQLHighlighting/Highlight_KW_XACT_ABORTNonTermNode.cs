...
{
    public class Highlight_KW_XACT_ABORTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_XACT_ABORTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_XACT_ABORTNonTermNode (string s, object positions)
        {
            text = s;
