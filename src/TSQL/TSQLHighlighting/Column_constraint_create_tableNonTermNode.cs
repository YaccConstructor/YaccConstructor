...
{
    public class Column_constraint_create_tableNonTermNode : IAbstractTreeNode
    {
        ...
        public Column_constraint_create_tableNonTermNode (string s)
        {
            text = s;
        }

        public Column_constraint_create_tableNonTermNode (string s, object positions)
        {
            text = s;
