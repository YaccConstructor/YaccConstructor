...
{
    public class Highlight_OWNERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_OWNERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_OWNERNonTermNode (string s, object positions)
        {
            text = s;
