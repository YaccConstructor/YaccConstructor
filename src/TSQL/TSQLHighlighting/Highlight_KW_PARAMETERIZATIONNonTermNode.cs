...
{
    public class Highlight_KW_PARAMETERIZATIONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PARAMETERIZATIONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PARAMETERIZATIONNonTermNode (string s, object positions)
        {
            text = s;
