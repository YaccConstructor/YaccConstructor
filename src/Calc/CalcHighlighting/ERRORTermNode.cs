...
{
    public class ERRORTermNode : ITreeNode
    {
        ...
        public ERRORTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ERRORTermNode (string ycTokName, string ycValue)
        {
        ...
        public ERRORTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
