...
{
    public class Highlight_right_square_bracket_NonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_right_square_bracket_NonTermNode (string s)
        {
            text = s;
        }

        public Highlight_right_square_bracket_NonTermNode (string s, object positions)
        {
            text = s;
