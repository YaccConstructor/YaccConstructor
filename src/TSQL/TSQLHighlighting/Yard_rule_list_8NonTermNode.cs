...
{
    public class Yard_rule_list_8NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_8NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_8NonTermNode (string s, object positions)
        {
            text = s;
