...
{
    public class Highlight_KW_MAXERRORSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MAXERRORSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MAXERRORSNonTermNode (string s, object positions)
        {
            text = s;
