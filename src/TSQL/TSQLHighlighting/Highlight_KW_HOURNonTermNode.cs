...
{
    public class Highlight_KW_HOURNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_HOURNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_HOURNonTermNode (string s, object positions)
        {
            text = s;
