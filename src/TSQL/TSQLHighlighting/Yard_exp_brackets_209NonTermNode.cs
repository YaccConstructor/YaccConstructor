...
{
    public class Yard_exp_brackets_209NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_209NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_209NonTermNode (string s, object positions)
        {
            text = s;
