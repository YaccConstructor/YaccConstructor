...
{
    public class Highlight_KW_XLOCKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_XLOCKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_XLOCKNonTermNode (string s, object positions)
        {
            text = s;
