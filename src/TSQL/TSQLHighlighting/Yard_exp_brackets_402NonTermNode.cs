...
{
    public class Yard_exp_brackets_402NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_402NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_402NonTermNode (string s, object positions)
        {
            text = s;
