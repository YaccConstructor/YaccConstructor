...
{
    public class Yard_exp_brackets_272NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_272NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_272NonTermNode (string s, object positions)
        {
            text = s;
