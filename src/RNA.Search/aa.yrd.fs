...
let private rules = [|5; 5; 1; 0; 6; 4|]
let private canInferEpsilon = [|false; false; true; false; false; false; false|]
let defaultAstToDot =
    (fun (tree : Yard.Generators.Common.ASTGLL.Tree) -> tree.AstToDot numToString)

let private rulesStart = [|0; 3; 5; 6|]
...
let slots = dict <| [|(-1, 0); (3, 1); (65537, 2)|]
