...
{
    public class Yard_exp_brackets_376NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_376NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_376NonTermNode (string s, object positions)
        {
            text = s;
