...
{
    public class KW_HOLDLOCKTermNode : ITreeNode
    {
        ...
        public KW_HOLDLOCKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_HOLDLOCKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_HOLDLOCKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
