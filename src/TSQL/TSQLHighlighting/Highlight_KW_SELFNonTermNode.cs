...
{
    public class Highlight_KW_SELFNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SELFNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SELFNonTermNode (string s, object positions)
        {
            text = s;
