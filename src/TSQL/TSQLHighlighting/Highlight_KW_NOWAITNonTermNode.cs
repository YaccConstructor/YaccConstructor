...
{
    public class Highlight_KW_NOWAITNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NOWAITNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NOWAITNonTermNode (string s, object positions)
        {
            text = s;
