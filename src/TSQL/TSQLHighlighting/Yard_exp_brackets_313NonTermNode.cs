...
{
    public class Yard_exp_brackets_313NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_313NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_313NonTermNode (string s, object positions)
        {
            text = s;
