...
{
    public class Highlight_KW_ANSI_NULL_DFLTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ANSI_NULL_DFLTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ANSI_NULL_DFLTNonTermNode (string s, object positions)
        {
            text = s;
