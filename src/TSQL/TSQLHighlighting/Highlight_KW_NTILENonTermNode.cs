...
{
    public class Highlight_KW_NTILENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NTILENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NTILENonTermNode (string s, object positions)
        {
            text = s;
