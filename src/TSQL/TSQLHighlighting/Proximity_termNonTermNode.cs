...
{
    public class Proximity_termNonTermNode : IAbstractTreeNode
    {
        ...
        public Proximity_termNonTermNode (string s)
        {
            text = s;
        }

        public Proximity_termNonTermNode (string s, object positions)
        {
            text = s;
