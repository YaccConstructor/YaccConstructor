...
{
    public class KW_DENSE_RANKTermNode : ITreeNode
    {
        ...
        public KW_DENSE_RANKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DENSE_RANKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DENSE_RANKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
