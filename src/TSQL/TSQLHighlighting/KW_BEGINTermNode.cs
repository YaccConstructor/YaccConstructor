...
{
    public class KW_BEGINTermNode : ITreeNode
    {
        ...
        public KW_BEGINTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BEGINTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BEGINTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
