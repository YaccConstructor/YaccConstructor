...
let private gotoSet = 
    Set.ofArray [|((0, 0, 1), set [(0, 1)]);((0, 0, 2), set [(1, 1)]);((0, 0, 3), set [(2, 1)]);((0, 0, 4), set [(2, 2)]);((1, 0, 2), set [(1, 1)]);((1, 0, 3), set [(2, 1)]);((1, 0, 4), set [(2, 2)]);((2, 0, 3), set [(2, 1)]);((2, 0, 4), set [(2, 2)]);((2, 2, 5), set [(2, 3)]);((2, 3, 6), set [(2, 4)])|]
    |> dict
