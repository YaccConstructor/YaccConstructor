...
{
    public class Scalar_functionNonTermNode : ITreeNode
    {
        ...
        public Scalar_functionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Scalar_functionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Scalar_functionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
