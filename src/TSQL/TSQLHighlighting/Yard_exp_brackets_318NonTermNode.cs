...
{
    public class Yard_exp_brackets_318NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_318NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_318NonTermNode (string s, object positions)
        {
            text = s;
