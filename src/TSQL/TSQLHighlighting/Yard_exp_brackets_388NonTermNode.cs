...
{
    public class Yard_exp_brackets_388NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_388NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_388NonTermNode (string s, object positions)
        {
            text = s;
