...
{
    public class KW_TOPTermNode : ITreeNode
    {
        ...
        public KW_TOPTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TOPTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TOPTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
