...
{
    public class Yard_rule_yard_many_1_15NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_15NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_15NonTermNode (string s, object positions)
        {
            text = s;
