...
{
    public class Yard_exp_brackets_215NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_215NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_215NonTermNode (string s, object positions)
        {
            text = s;
