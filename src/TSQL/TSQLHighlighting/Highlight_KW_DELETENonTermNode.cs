...
{
    public class Highlight_KW_DELETENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DELETENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DELETENonTermNode (string s, object positions)
        {
            text = s;
