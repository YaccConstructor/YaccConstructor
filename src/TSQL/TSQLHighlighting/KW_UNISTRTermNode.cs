...
{
    public class KW_UNISTRTermNode : ITreeNode
    {
        ...
        public KW_UNISTRTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_UNISTRTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_UNISTRTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
