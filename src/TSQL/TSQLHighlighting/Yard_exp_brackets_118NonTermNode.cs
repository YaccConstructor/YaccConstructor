...
{
    public class Yard_exp_brackets_118NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_118NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_118NonTermNode (string s, object positions)
        {
            text = s;
