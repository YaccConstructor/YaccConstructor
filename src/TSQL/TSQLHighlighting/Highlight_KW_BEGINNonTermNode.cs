...
{
    public class Highlight_KW_BEGINNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BEGINNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BEGINNonTermNode (string s, object positions)
        {
            text = s;
