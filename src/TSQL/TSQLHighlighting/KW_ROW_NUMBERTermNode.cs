...
{
    public class KW_ROW_NUMBERTermNode : ITreeNode
    {
        ...
        public KW_ROW_NUMBERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROW_NUMBERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROW_NUMBERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
