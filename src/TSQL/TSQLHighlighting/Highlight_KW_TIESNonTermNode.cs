...
{
    public class Highlight_KW_TIESNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TIESNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TIESNonTermNode (string s, object positions)
        {
            text = s;
