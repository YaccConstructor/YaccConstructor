...
{
    public class GLOBALVARTermNode : ITreeNode
    {
        ...
        public GLOBALVARTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public GLOBALVARTermNode (string ycTokName, string ycValue)
        {
        ...
        public GLOBALVARTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
