...
{
    public class Highlight_KW_THESAURUSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_THESAURUSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_THESAURUSNonTermNode (string s, object positions)
        {
            text = s;
