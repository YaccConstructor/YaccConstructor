...
{
    public class KW_REMOTE_PROC_TRANSACTIONSTermNode : ITreeNode
    {
        ...
        public KW_REMOTE_PROC_TRANSACTIONSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_REMOTE_PROC_TRANSACTIONSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_REMOTE_PROC_TRANSACTIONSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
