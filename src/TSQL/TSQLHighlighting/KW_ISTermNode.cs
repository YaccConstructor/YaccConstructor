...
{
    public class KW_ISTermNode : ITreeNode
    {
        ...
        public KW_ISTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ISTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ISTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
