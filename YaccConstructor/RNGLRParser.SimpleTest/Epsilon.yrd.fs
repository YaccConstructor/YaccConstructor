...
let _rnglr_epsilons : Tree<Token>[] = [|new Tree<_>([|NonTerm (new UsualOne<_>(new Family(6, [|1; 2; 3|]), [||])); NonTerm (new UsualOne<_>(new Family(0, [||]), [||])); NonTerm (new UsualOne<_>(new Family(2, [||]), [||])); NonTerm (new UsualOne<_>(new Family(4, [||]), [||]))|],null,0); new Tree<_>([|NonTerm (new UsualOne<_>(new Family(0, [||]), [||]))|],null,0); new Tree<_>([|NonTerm (new UsualOne<_>(new Family(2, [||]), [||]))|],null,0); new Tree<_>([|NonTerm (new UsualOne<_>(new Family(4, [||]), [||]))|],null,0); new Tree<_>([|NonTerm (new UsualOne<_>(new Family(7, [|1|]), [||])); NonTerm (new UsualOne<_>(new Family(6, [|2; 3; 4|]), [||])); NonTerm (new UsualOne<_>(new Family(0, [||]), [||])); NonTerm (new UsualOne<_>(new Family(2, [||]), [||])); NonTerm (new UsualOne<_>(new Family(4, [||]), [||]))|],null,0)|]
