...
{
    public class Highlight_KW_IGNORE_DUP_KEYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_IGNORE_DUP_KEYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_IGNORE_DUP_KEYNonTermNode (string s, object positions)
        {
            text = s;
