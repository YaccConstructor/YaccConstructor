...
{
    public class Highlight_KW_ORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ORNonTermNode (string s, object positions)
        {
            text = s;
