...
{
    public class Yard_exp_brackets_178NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_178NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_178NonTermNode (string s, object positions)
        {
            text = s;
