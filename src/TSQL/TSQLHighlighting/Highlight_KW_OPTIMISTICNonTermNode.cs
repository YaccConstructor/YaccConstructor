...
{
    public class Highlight_KW_OPTIMISTICNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OPTIMISTICNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OPTIMISTICNonTermNode (string s, object positions)
        {
            text = s;
