...
{
    public class Yard_exp_brackets_96NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_96NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_96NonTermNode (string s, object positions)
        {
            text = s;
