...
{
    public class Highlight_KW_FILLFACTORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FILLFACTORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FILLFACTORNonTermNode (string s, object positions)
        {
            text = s;
