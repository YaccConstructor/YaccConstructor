...
{
    public class Yard_exp_brackets_409NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_409NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_409NonTermNode (string s, object positions)
        {
            text = s;
