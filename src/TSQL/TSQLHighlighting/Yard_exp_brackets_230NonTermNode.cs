...
{
    public class Yard_exp_brackets_230NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_230NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_230NonTermNode (string s, object positions)
        {
            text = s;
