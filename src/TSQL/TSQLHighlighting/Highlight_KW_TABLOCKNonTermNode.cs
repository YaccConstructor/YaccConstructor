...
{
    public class Highlight_KW_TABLOCKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TABLOCKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TABLOCKNonTermNode (string s, object positions)
        {
            text = s;
