...
{
    public class Yard_exp_brackets_271NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_271NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_271NonTermNode (string s, object positions)
        {
            text = s;
