...
{
    public class Yard_exp_brackets_276NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_276NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_276NonTermNode (string s, object positions)
        {
            text = s;
