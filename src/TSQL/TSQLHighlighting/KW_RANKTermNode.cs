...
{
    public class KW_RANKTermNode : ITreeNode
    {
        ...
        public KW_RANKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_RANKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_RANKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
