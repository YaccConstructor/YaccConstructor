...
{
    public class Highlight_KW_BINARYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BINARYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BINARYNonTermNode (string s, object positions)
        {
            text = s;
