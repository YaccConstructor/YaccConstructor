...
{
    public class KW_QUOTED_IDENTIFIERTermNode : IAbstractTreeNode
    {
        ...
        public KW_QUOTED_IDENTIFIERTermNode (string s)
        {
            text = s;
        }

        public KW_QUOTED_IDENTIFIERTermNode (string s, object positions)
        {
            text = s;
