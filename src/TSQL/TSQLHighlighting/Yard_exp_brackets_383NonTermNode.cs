...
{
    public class Yard_exp_brackets_383NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_383NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_383NonTermNode (string s, object positions)
        {
            text = s;
