...
{
    public class KW_PATHTermNode : ITreeNode
    {
        ...
        public KW_PATHTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PATHTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PATHTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
