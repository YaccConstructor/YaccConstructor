...
{
    public class Yard_rule_yard_many_1_4NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_4NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_4NonTermNode (string s, object positions)
        {
            text = s;
