...
{
    public class KW_TYPE_WARNINGTermNode : ITreeNode
    {
        ...
        public KW_TYPE_WARNINGTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TYPE_WARNINGTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TYPE_WARNINGTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
