...
{
    public class Highlight_KW_COMPUTENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_COMPUTENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_COMPUTENonTermNode (string s, object positions)
        {
            text = s;
