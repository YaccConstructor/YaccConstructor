...
{
    public class Yard_exp_brackets_126NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_126NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_126NonTermNode (string s, object positions)
        {
            text = s;
