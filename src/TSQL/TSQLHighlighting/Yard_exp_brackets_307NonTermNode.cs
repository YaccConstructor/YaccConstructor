...
{
    public class Yard_exp_brackets_307NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_307NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_307NonTermNode (string s, object positions)
        {
            text = s;
