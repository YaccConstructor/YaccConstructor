...
{
    public class Yard_rule_yard_many_2_3NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_2_3NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_2_3NonTermNode (string s, object positions)
        {
            text = s;
