...
{
    public class Highlight_KW_IONonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_IONonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_IONonTermNode (string s, object positions)
        {
            text = s;
