...
{
    public class KW_HAVINGTermNode : ITreeNode
    {
        ...
        public KW_HAVINGTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_HAVINGTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_HAVINGTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
