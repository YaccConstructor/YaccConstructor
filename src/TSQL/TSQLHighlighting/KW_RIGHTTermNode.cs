...
{
    public class KW_RIGHTTermNode : ITreeNode
    {
        ...
        public KW_RIGHTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_RIGHTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_RIGHTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
