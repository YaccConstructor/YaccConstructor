...
{
    public class DEC_NUMBERTermNode : ITreeNode
    {
        ...
        public DEC_NUMBERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public DEC_NUMBERTermNode (string ycTokName, string ycValue)
        {
        ...
        public DEC_NUMBERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
