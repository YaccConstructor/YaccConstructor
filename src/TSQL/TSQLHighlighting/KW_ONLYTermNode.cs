...
{
    public class KW_ONLYTermNode : ITreeNode
    {
        ...
        public KW_ONLYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ONLYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ONLYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
