...
{
    public class Yard_exp_brackets_152NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_152NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_152NonTermNode (string s, object positions)
        {
            text = s;
