...
{
    public class KW_CASETermNode : ITreeNode
    {
        ...
        public KW_CASETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CASETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CASETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
