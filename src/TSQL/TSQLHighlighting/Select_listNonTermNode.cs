...
{
    public class Select_listNonTermNode : ITreeNode
    {
        ...
        public Select_listNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Select_listNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Select_listNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
