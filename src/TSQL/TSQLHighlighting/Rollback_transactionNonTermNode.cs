...
{
    public class Rollback_transactionNonTermNode : ITreeNode
    {
        ...
        public Rollback_transactionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Rollback_transactionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Rollback_transactionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
