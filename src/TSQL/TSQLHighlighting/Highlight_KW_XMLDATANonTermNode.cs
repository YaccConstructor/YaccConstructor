...
{
    public class Highlight_KW_XMLDATANonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_XMLDATANonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_XMLDATANonTermNode (string s, object positions)
        {
            text = s;
