...
{
    public class Contains_search_conditionNonTermNode : IAbstractTreeNode
    {
        ...
        public Contains_search_conditionNonTermNode (string s)
        {
            text = s;
        }

        public Contains_search_conditionNonTermNode (string s, object positions)
        {
            text = s;
