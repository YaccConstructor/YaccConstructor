...
{
    public class Yard_exp_brackets_99NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_99NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_99NonTermNode (string s, object positions)
        {
            text = s;
