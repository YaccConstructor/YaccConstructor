...
{
    public class CaseNonTermNode : ITreeNode
    {
        ...
        public CaseNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public CaseNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public CaseNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
