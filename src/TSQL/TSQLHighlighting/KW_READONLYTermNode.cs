...
{
    public class KW_READONLYTermNode : ITreeNode
    {
        ...
        public KW_READONLYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_READONLYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_READONLYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
