...
{
    public class Yard_exp_brackets_223NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_223NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_223NonTermNode (string s, object positions)
        {
            text = s;
