...
{
    public class Yard_rule_list_17NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_17NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_17NonTermNode (string s, object positions)
        {
            text = s;
