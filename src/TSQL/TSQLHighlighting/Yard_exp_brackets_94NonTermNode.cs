...
{
    public class Yard_exp_brackets_94NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_94NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_94NonTermNode (string s, object positions)
        {
            text = s;
