...
{
    public class Highlight_KW_QUOTED_IDENTIFIERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_QUOTED_IDENTIFIERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_QUOTED_IDENTIFIERNonTermNode (string s, object positions)
        {
            text = s;
