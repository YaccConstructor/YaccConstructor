...
{
    public class Common_directivesNonTermNode : IAbstractTreeNode
    {
        ...
        public Common_directivesNonTermNode (string s)
        {
            text = s;
        }

        public Common_directivesNonTermNode (string s, object positions)
        {
            text = s;
