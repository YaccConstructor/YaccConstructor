...
{
    public class Highlight_KW_USENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_USENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_USENonTermNode (string s, object positions)
        {
            text = s;
