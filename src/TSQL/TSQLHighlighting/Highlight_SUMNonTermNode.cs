...
{
    public class Highlight_SUMNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_SUMNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_SUMNonTermNode (string s, object positions)
        {
            text = s;
