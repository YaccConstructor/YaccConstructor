...
{
    public class Yard_exp_brackets_201NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_201NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_201NonTermNode (string s, object positions)
        {
            text = s;
