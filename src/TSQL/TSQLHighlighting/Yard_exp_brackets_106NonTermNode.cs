...
{
    public class Yard_exp_brackets_106NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_106NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_106NonTermNode (string s, object positions)
        {
            text = s;
