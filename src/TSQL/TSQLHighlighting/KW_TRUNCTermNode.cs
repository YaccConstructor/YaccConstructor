...
{
    public class KW_TRUNCTermNode : ITreeNode
    {
        ...
        public KW_TRUNCTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TRUNCTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TRUNCTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
