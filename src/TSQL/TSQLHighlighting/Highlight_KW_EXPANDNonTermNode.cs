...
{
    public class Highlight_KW_EXPANDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_EXPANDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_EXPANDNonTermNode (string s, object positions)
        {
            text = s;
