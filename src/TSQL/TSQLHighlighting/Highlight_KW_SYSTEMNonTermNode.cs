...
{
    public class Highlight_KW_SYSTEMNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SYSTEMNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SYSTEMNonTermNode (string s, object positions)
        {
            text = s;
