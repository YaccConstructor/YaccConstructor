...
{
    public class Highlight_KW_RELATIVENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_RELATIVENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_RELATIVENonTermNode (string s, object positions)
        {
            text = s;
