...
{
    public class Highlight_KW_NEARNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NEARNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NEARNonTermNode (string s, object positions)
        {
            text = s;
