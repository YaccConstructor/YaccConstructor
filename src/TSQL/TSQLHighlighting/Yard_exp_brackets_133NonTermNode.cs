...
{
    public class Yard_exp_brackets_133NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_133NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_133NonTermNode (string s, object positions)
        {
            text = s;
