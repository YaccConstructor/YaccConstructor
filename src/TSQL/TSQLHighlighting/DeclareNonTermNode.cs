...
{
    public class DeclareNonTermNode : ITreeNode
    {
        ...
        public DeclareNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public DeclareNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public DeclareNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
