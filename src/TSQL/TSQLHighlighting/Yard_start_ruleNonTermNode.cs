...
{
    public class Yard_start_ruleNonTermNode : ITreeNode
    {
        ...
        public Yard_start_ruleNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_start_ruleNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_start_ruleNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
