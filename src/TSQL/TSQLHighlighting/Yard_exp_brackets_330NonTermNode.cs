...
{
    public class Yard_exp_brackets_330NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_330NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_330NonTermNode (string s, object positions)
        {
            text = s;
