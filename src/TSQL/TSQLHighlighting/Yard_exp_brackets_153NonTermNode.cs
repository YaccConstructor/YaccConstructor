...
{
    public class Yard_exp_brackets_153NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_153NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_153NonTermNode (string s, object positions)
        {
            text = s;
