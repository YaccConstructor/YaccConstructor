...
{
    public class Output_clauseNonTermNode : ITreeNode
    {
        ...
        public Output_clauseNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Output_clauseNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Output_clauseNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
