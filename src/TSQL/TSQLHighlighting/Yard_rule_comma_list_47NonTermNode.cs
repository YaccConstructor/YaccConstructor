...
{
    public class Yard_rule_comma_list_47NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_47NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_47NonTermNode (string s, object positions)
        {
            text = s;
