...
{
    public class Table_constraint_create_tableNonTermNode : ITreeNode
    {
        ...
        public Table_constraint_create_tableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Table_constraint_create_tableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Table_constraint_create_tableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
