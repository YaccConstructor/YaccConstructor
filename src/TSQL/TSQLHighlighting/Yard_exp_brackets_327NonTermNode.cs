...
{
    public class Yard_exp_brackets_327NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_327NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_327NonTermNode (string s, object positions)
        {
            text = s;
