...
{
    public class Highlight_KW_ORDERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ORDERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ORDERNonTermNode (string s, object positions)
        {
            text = s;
