...
{
    public class Yard_exp_brackets_417NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_417NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_417NonTermNode (string s, object positions)
        {
            text = s;
