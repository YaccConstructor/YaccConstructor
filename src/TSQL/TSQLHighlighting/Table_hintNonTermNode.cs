...
{
    public class Table_hintNonTermNode : ITreeNode
    {
        ...
        public Table_hintNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Table_hintNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Table_hintNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
