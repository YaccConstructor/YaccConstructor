...
{
    public class Yard_exp_brackets_205NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_205NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_205NonTermNode (string s, object positions)
        {
            text = s;
