...
{
    public class KW_EQUALTermNode : ITreeNode
    {
        ...
        public KW_EQUALTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_EQUALTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_EQUALTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
