...
{
    public class Highlight_KW_SINGLE_BLOBNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SINGLE_BLOBNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SINGLE_BLOBNonTermNode (string s, object positions)
        {
            text = s;
