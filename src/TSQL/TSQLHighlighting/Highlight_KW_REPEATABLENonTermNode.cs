...
{
    public class Highlight_KW_REPEATABLENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_REPEATABLENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_REPEATABLENonTermNode (string s, object positions)
        {
            text = s;
