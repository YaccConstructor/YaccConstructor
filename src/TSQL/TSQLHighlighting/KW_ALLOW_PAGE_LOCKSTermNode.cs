...
{
    public class KW_ALLOW_PAGE_LOCKSTermNode : ITreeNode
    {
        ...
        public KW_ALLOW_PAGE_LOCKSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ALLOW_PAGE_LOCKSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ALLOW_PAGE_LOCKSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
