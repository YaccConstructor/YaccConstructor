...
{
    public class Highlight_KW_THENNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_THENNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_THENNonTermNode (string s, object positions)
        {
            text = s;
