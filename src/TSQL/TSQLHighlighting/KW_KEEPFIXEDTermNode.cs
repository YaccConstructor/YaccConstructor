...
{
    public class KW_KEEPFIXEDTermNode : ITreeNode
    {
        ...
        public KW_KEEPFIXEDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_KEEPFIXEDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_KEEPFIXEDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
