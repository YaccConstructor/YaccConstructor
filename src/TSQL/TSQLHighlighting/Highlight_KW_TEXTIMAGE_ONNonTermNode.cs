...
{
    public class Highlight_KW_TEXTIMAGE_ONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TEXTIMAGE_ONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TEXTIMAGE_ONNonTermNode (string s, object positions)
        {
            text = s;
