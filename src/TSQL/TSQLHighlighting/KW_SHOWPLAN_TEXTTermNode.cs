...
{
    public class KW_SHOWPLAN_TEXTTermNode : IAbstractTreeNode
    {
        ...
        public KW_SHOWPLAN_TEXTTermNode (string s)
        {
            text = s;
        }

        public KW_SHOWPLAN_TEXTTermNode (string s, object positions)
        {
            text = s;
