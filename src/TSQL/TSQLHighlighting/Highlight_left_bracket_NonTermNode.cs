...
{
    public class Highlight_left_bracket_NonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_left_bracket_NonTermNode (string s)
        {
            text = s;
        }

        public Highlight_left_bracket_NonTermNode (string s, object positions)
        {
            text = s;
