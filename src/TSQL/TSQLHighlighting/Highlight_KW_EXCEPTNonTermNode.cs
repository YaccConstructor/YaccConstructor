...
{
    public class Highlight_KW_EXCEPTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_EXCEPTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_EXCEPTNonTermNode (string s, object positions)
        {
            text = s;
