...
{
    public class Highlight_KW_FORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FORNonTermNode (string s, object positions)
        {
            text = s;
