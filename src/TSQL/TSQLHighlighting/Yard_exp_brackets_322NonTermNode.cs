...
{
    public class Yard_exp_brackets_322NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_322NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_322NonTermNode (string s, object positions)
        {
            text = s;
