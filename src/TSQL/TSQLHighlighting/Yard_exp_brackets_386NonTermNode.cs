...
{
    public class Yard_exp_brackets_386NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_386NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_386NonTermNode (string s, object positions)
        {
            text = s;
