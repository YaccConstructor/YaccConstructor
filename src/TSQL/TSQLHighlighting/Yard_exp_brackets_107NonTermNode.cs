...
{
    public class Yard_exp_brackets_107NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_107NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_107NonTermNode (string s, object positions)
        {
            text = s;
