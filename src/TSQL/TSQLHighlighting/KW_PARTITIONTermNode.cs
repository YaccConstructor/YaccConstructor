...
{
    public class KW_PARTITIONTermNode : ITreeNode
    {
        ...
        public KW_PARTITIONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PARTITIONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PARTITIONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
