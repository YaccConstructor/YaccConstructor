...
{
    public class Highlight_NUMBERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_NUMBERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_NUMBERNonTermNode (string s, object positions)
        {
            text = s;
