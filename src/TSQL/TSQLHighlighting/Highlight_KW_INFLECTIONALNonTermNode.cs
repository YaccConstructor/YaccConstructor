...
{
    public class Highlight_KW_INFLECTIONALNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_INFLECTIONALNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_INFLECTIONALNonTermNode (string s, object positions)
        {
            text = s;
