...
{
    public class Yard_exp_brackets_141NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_141NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_141NonTermNode (string s, object positions)
        {
            text = s;
