...
{
    public class Yard_rule_list_33NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_33NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_33NonTermNode (string s, object positions)
        {
            text = s;
