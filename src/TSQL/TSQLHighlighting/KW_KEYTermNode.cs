...
{
    public class KW_KEYTermNode : ITreeNode
    {
        ...
        public KW_KEYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_KEYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_KEYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
