...
{
    public class Yard_rule_list_36NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_36NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_36NonTermNode (string s, object positions)
        {
            text = s;
