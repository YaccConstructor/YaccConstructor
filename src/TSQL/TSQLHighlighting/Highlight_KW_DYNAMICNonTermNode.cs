...
{
    public class Highlight_KW_DYNAMICNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DYNAMICNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DYNAMICNonTermNode (string s, object positions)
        {
            text = s;
