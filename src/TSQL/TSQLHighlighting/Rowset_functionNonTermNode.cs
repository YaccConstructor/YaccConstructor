...
{
    public class Rowset_functionNonTermNode : ITreeNode
    {
        ...
        public Rowset_functionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Rowset_functionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Rowset_functionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
