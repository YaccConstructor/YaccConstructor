...
{
    public class KW_IDENTITYTermNode : ITreeNode
    {
        ...
        public KW_IDENTITYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_IDENTITYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_IDENTITYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
