...
{
    public class KW_CODEPAGETermNode : ITreeNode
    {
        ...
        public KW_CODEPAGETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CODEPAGETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CODEPAGETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
