...
{
    public class Yard_exp_brackets_172NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_172NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_172NonTermNode (string s, object positions)
        {
            text = s;
