...
{
    public class Yard_exp_brackets_155NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_155NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_155NonTermNode (string s, object positions)
        {
            text = s;
