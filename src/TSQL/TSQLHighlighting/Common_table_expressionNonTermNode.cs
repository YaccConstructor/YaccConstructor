...
{
    public class Common_table_expressionNonTermNode : IAbstractTreeNode
    {
        ...
        public Common_table_expressionNonTermNode (string s)
        {
            text = s;
        }

        public Common_table_expressionNonTermNode (string s, object positions)
        {
            text = s;
