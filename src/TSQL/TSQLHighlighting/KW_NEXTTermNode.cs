...
{
    public class KW_NEXTTermNode : ITreeNode
    {
        ...
        public KW_NEXTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NEXTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NEXTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
