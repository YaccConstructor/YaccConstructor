...
{
    public class Unpivot_clauseNonTermNode : ITreeNode
    {
        ...
        public Unpivot_clauseNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Unpivot_clauseNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Unpivot_clauseNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
