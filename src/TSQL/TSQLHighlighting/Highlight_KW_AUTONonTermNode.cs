...
{
    public class Highlight_KW_AUTONonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_AUTONonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_AUTONonTermNode (string s, object positions)
        {
            text = s;
