...
{
    public class KW_HEXTORAWTermNode : ITreeNode
    {
        ...
        public KW_HEXTORAWTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_HEXTORAWTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_HEXTORAWTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
