...
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (383bp,133bp) node {11};
\end{scope}
  % Node: 10
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (195bp,133bp) node {10};
\end{scope}
  % Node: 13
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (139bp,133bp) node {13};
\end{scope}
  % Node: 12
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (83bp,133bp) node {12};
\end{scope}
  % Node: 15
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (451bp,133bp) node {15};
\end{scope}
  % Node: 14
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (23bp,133bp) node {14};
\end{scope}
  % Node: 1
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (195bp,88bp) node {1};
\end{scope}
  % Node: 3
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (327bp,39bp) node {3};
\end{scope}
  % Node: 2
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (251bp,39bp) node {2};
\end{scope}
  % Node: 5
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (251bp,83bp) node {5};
\end{scope}
  % Node: 4
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (383bp,88bp) node {4};
\end{scope}
  % Node: 6
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (327bp,83bp) node {6};
\end{scope}
  % Node: 9
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (251bp,133bp) node {9};
\end{scope}
  % Node: 8
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (327bp,133bp) node {8};
\end{scope}
%
\end{tikzpicture}
% End of code
