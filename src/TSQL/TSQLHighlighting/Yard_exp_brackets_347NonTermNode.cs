...
{
    public class Yard_exp_brackets_347NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_347NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_347NonTermNode (string s, object positions)
        {
            text = s;
