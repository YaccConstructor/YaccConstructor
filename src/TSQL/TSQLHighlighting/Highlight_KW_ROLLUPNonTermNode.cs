...
{
    public class Highlight_KW_ROLLUPNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROLLUPNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROLLUPNonTermNode (string s, object positions)
        {
            text = s;
