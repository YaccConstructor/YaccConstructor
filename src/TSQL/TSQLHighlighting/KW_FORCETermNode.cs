...
{
    public class KW_FORCETermNode : ITreeNode
    {
        ...
        public KW_FORCETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FORCETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FORCETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
