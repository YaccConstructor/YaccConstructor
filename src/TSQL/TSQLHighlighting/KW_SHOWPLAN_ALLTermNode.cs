...
{
    public class KW_SHOWPLAN_ALLTermNode : ITreeNode
    {
        ...
        public KW_SHOWPLAN_ALLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SHOWPLAN_ALLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SHOWPLAN_ALLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
