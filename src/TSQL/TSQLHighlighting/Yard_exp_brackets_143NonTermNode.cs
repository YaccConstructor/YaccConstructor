...
{
    public class Yard_exp_brackets_143NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_143NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_143NonTermNode (string s, object positions)
        {
            text = s;
