...
{
    public class Highlight_KW_PRIORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PRIORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PRIORNonTermNode (string s, object positions)
        {
            text = s;
