...
{
    public class Yard_exp_brackets_277NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_277NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_277NonTermNode (string s, object positions)
        {
            text = s;
