...
{
    public class Yard_exp_brackets_208NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_208NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_208NonTermNode (string s, object positions)
        {
            text = s;
