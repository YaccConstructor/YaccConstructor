...
{
    public class Highlight_KW_CURSORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CURSORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CURSORNonTermNode (string s, object positions)
        {
            text = s;
