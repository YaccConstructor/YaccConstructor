...
{
    public class Yard_exp_brackets_325NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_325NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_325NonTermNode (string s, object positions)
        {
            text = s;
