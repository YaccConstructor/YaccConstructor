...
{
    public class Highlight_KW_MAXNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MAXNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MAXNonTermNode (string s, object positions)
        {
            text = s;
