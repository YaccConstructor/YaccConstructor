...
{
    public class Highlight_KW_READCOMMITTEDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_READCOMMITTEDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_READCOMMITTEDNonTermNode (string s, object positions)
        {
            text = s;
