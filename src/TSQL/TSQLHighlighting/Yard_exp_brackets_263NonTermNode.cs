...
{
    public class Yard_exp_brackets_263NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_263NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_263NonTermNode (string s, object positions)
        {
            text = s;
