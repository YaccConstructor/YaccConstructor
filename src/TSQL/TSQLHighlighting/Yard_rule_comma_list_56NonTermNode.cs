...
{
    public class Yard_rule_comma_list_56NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_56NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_56NonTermNode (string s, object positions)
        {
            text = s;
