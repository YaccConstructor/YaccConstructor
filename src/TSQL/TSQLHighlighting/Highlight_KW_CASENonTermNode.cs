...
{
    public class Highlight_KW_CASENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CASENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CASENonTermNode (string s, object positions)
        {
            text = s;
