...
{
    public class Yard_exp_brackets_129NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_129NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_129NonTermNode (string s, object positions)
        {
            text = s;
