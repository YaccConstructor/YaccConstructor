...
{
    public class STRING1TermNode : ITreeNode
    {
        ...
        public STRING1TermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public STRING1TermNode (string ycTokName, string ycValue)
        {
        ...
        public STRING1TermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
