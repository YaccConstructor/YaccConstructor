...
{
    public class Highlight_KW_LOGINNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LOGINNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LOGINNonTermNode (string s, object positions)
        {
            text = s;
