...
{
    public class Yard_rule_comma_list_7NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_7NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_7NonTermNode (string s, object positions)
        {
            text = s;
