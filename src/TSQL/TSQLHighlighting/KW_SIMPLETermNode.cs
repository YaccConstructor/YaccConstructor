...
{
    public class KW_SIMPLETermNode : ITreeNode
    {
        ...
        public KW_SIMPLETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SIMPLETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SIMPLETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
