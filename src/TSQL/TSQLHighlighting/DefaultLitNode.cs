...
{
    public class DefaultLitNode : ITreeNode
    {
        ...
        public DefaultLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public DefaultLitNode (string ycTokName, string ycValue)
        {
        ...
        public DefaultLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
