...
{
    public class Highlight_RBRACENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_RBRACENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_RBRACENonTermNode (string s, object positions)
        {
            text = s;
