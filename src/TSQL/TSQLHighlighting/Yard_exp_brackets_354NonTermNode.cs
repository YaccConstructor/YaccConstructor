...
{
    public class Yard_exp_brackets_354NonTermNode : ITreeNode
    {
        ...
        public Yard_exp_brackets_354NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_exp_brackets_354NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_exp_brackets_354NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
