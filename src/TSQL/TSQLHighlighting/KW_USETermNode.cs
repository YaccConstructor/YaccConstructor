...
{
    public class KW_USETermNode : ITreeNode
    {
        ...
        public KW_USETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_USETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_USETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
