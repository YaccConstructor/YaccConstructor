...
{
    public class Highlight_KW_INNERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_INNERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_INNERNonTermNode (string s, object positions)
        {
            text = s;
