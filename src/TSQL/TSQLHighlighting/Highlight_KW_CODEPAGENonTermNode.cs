...
{
    public class Highlight_KW_CODEPAGENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CODEPAGENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CODEPAGENonTermNode (string s, object positions)
        {
            text = s;
