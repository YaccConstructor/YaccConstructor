...
{
    public class Simple_termNonTermNode : ITreeNode
    {
        ...
        public Simple_termNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Simple_termNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Simple_termNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
