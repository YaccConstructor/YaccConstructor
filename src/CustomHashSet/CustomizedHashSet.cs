...
namespace System.Collections.Generic.Customized
{
    ...
    public class HashSet<T> : ICollection<T>, ISet<T>, IReadOnlyCollection<T>, ISerializable, IDeserializationCallback
    {
        ...
        private void CopyFrom(HashSet<T> source)
        {
            ...
            int threshold = CustomizedHashHelpers.ExpandPrime(count + 1);
        ...
        public void CopyTo(T[] array, int arrayIndex, int count)
        {
            ...
            if (count < 0)
            {
                throw new ArgumentOutOfRangeException(nameof(count), count, "ArgumentOutOfRange_NeedNonNegNum");
            }
        ...
        public void TrimExcess()
        {
            ...
            else
            {
                ...
                int newSize = CustomizedHashHelpers.GetPrime(_count);
        ...
        private void IncreaseCapacity()
        {
            ...
            int newSize = CustomizedHashHelpers.ExpandPrime(_count);
            if (newSize <= _count)
            {
