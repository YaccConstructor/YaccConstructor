...
{
    public class Left_square_bracket_LitNode : IAbstractTreeNode
    {
        ...
        public Left_square_bracket_LitNode (string s)
        {
            text = s;
        }

        public Left_square_bracket_LitNode (string s, object positions)
        {
            text = s;
