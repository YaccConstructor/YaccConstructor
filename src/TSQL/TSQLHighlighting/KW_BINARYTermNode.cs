...
{
    public class KW_BINARYTermNode : ITreeNode
    {
        ...
        public KW_BINARYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BINARYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BINARYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
