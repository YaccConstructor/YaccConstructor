...
{
    public class KW_BULKTermNode : ITreeNode
    {
        ...
        public KW_BULKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BULKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BULKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
