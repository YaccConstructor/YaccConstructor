...
{
    public class Yard_exp_brackets_191NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_191NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_191NonTermNode (string s, object positions)
        {
            text = s;
