...
{
    public class Yard_exp_brackets_242NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_242NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_242NonTermNode (string s, object positions)
        {
            text = s;
