...
{
    public class Yard_exp_brackets_382NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_382NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_382NonTermNode (string s, object positions)
        {
            text = s;
