...
{
    public class Sql_exprNonTermNode : ITreeNode
    {
        ...
        public Sql_exprNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Sql_exprNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Sql_exprNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
