...
{
    public class KW_UNPIVOTTermNode : ITreeNode
    {
        ...
        public KW_UNPIVOTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_UNPIVOTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_UNPIVOTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
