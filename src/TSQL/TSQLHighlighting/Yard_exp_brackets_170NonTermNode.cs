...
{
    public class Yard_exp_brackets_170NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_170NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_170NonTermNode (string s, object positions)
        {
            text = s;
