...
{
    public class KW_OUTERTermNode : ITreeNode
    {
        ...
        public KW_OUTERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OUTERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OUTERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
