...
{
    public class Yard_exp_brackets_274NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_274NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_274NonTermNode (string s, object positions)
        {
            text = s;
