...
{
    public class Yard_exp_brackets_332NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_332NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_332NonTermNode (string s, object positions)
        {
            text = s;
