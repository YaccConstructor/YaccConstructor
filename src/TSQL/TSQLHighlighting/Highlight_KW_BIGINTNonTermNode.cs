...
{
    public class Highlight_KW_BIGINTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BIGINTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BIGINTNonTermNode (string s, object positions)
        {
            text = s;
