...
{
    public class Yard_exp_brackets_284NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_284NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_284NonTermNode (string s, object positions)
        {
            text = s;
