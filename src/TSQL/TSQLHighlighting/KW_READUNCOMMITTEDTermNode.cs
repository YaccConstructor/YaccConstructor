...
{
    public class KW_READUNCOMMITTEDTermNode : ITreeNode
    {
        ...
        public KW_READUNCOMMITTEDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_READUNCOMMITTEDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_READUNCOMMITTEDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
