...
let leftSide = [|0; 5; 1; 1; 2; 3|]
let private rules = [|6; 1; 8; 0; 2; 7; 3; 4|]
...
let private lists_gotos = [|1; 2; 3; 5; 6; 7; 8; 4|]
let private small_gotos =
        [|2; 0; 393217; 131077; 65538; 131075; 196612; 262149; 458758; 196609; 524295|]
...
while cur < small_gotos.Length do
    ...
    cur <- cur + length
let private lists_reduces = [|[|0,3|]; [|2,1|]; [|4,1|]; [|5,1|]; [|3,1|]|]
let private small_reduces =
        [|262145; 589824; 327681; 524289; 393217; 524290; 458753; 524291; 524289; 524292|]
