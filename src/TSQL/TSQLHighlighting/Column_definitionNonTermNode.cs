...
{
    public class Column_definitionNonTermNode : IAbstractTreeNode
    {
        ...
        public Column_definitionNonTermNode (string s)
        {
            text = s;
        }

        public Column_definitionNonTermNode (string s, object positions)
        {
            text = s;
