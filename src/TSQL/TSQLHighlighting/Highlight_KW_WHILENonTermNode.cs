...
{
    public class Highlight_KW_WHILENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_WHILENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_WHILENonTermNode (string s, object positions)
        {
            text = s;
