...
{
    public class KW_FASTTermNode : ITreeNode
    {
        ...
        public KW_FASTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FASTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FASTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
