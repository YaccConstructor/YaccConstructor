...
{
    public class Highlight_KW_DISTINCTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DISTINCTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DISTINCTNonTermNode (string s, object positions)
        {
            text = s;
