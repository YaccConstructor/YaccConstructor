...
{
    public class Highlight_KW_INTONonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_INTONonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_INTONonTermNode (string s, object positions)
        {
            text = s;
