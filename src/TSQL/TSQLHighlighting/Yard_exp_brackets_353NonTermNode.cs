...
{
    public class Yard_exp_brackets_353NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_353NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_353NonTermNode (string s, object positions)
        {
            text = s;
