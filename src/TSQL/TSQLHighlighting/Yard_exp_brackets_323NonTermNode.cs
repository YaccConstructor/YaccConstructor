...
{
    public class Yard_exp_brackets_323NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_323NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_323NonTermNode (string s, object positions)
        {
            text = s;
