...
{
    public class Yard_exp_brackets_281NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_281NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_281NonTermNode (string s, object positions)
        {
            text = s;
