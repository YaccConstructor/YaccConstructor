...
{
    public class KW_PERCENTTermNode : ITreeNode
    {
        ...
        public KW_PERCENTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PERCENTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PERCENTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
