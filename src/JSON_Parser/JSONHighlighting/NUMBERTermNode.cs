...
{
    public class NUMBERTermNode : ITreeNode
    {
        ...
        public NUMBERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public NUMBERTermNode (string ycTokName, string ycValue)
        {
        ...
        public NUMBERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
