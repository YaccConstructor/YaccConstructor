...
{
    public class Yard_exp_brackets_339NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_339NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_339NonTermNode (string s, object positions)
        {
            text = s;
