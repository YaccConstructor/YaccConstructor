...
{
    public class Yard_exp_brackets_278NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_278NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_278NonTermNode (string s, object positions)
        {
            text = s;
