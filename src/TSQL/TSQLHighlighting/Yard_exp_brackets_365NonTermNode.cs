...
{
    public class Yard_exp_brackets_365NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_365NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_365NonTermNode (string s, object positions)
        {
            text = s;
