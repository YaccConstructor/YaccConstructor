...
{
    public class KW_READCOMMITTEDTermNode : IAbstractTreeNode
    {
        ...
        public KW_READCOMMITTEDTermNode (string s)
        {
            text = s;
        }

        public KW_READCOMMITTEDTermNode (string s, object positions)
        {
            text = s;
