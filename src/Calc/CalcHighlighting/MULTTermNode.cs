...
{
    public class MULTTermNode : ITreeNode
    {
        ...
        public MULTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public MULTTermNode (string ycTokName, string ycValue)
        {
        ...
        public MULTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
