...
{
    public class KW_NUMERIC_ROUNDABORTTermNode : ITreeNode
    {
        ...
        public KW_NUMERIC_ROUNDABORTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NUMERIC_ROUNDABORTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NUMERIC_ROUNDABORTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
