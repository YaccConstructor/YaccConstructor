...
{
    public class KW_ROWSTermNode : ITreeNode
    {
        ...
        public KW_ROWSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROWSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROWSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
