...
{
    public class Highlight_KW_IFNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_IFNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_IFNonTermNode (string s, object positions)
        {
            text = s;
