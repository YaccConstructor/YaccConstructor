...
{
    public class Yard_exp_brackets_134NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_134NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_134NonTermNode (string s, object positions)
        {
            text = s;
