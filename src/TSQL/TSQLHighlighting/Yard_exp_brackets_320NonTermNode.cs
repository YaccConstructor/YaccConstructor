...
{
    public class Yard_exp_brackets_320NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_320NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_320NonTermNode (string s, object positions)
        {
            text = s;
