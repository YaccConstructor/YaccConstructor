...
{
    public class Yard_exp_brackets_345NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_345NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_345NonTermNode (string s, object positions)
        {
            text = s;
