...
{
    public class Execute_character_stringNonTermNode : ITreeNode
    {
        ...
        public Execute_character_stringNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Execute_character_stringNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Execute_character_stringNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
