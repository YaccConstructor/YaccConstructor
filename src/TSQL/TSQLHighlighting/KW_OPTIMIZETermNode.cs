...
{
    public class KW_OPTIMIZETermNode : ITreeNode
    {
        ...
        public KW_OPTIMIZETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OPTIMIZETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OPTIMIZETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
