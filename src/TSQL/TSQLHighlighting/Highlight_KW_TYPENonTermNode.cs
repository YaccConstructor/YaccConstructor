...
{
    public class Highlight_KW_TYPENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TYPENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TYPENonTermNode (string s, object positions)
        {
            text = s;
