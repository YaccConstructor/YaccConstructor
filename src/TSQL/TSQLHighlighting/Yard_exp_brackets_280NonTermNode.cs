...
{
    public class Yard_exp_brackets_280NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_280NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_280NonTermNode (string s, object positions)
        {
            text = s;
