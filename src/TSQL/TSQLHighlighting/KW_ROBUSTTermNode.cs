...
{
    public class KW_ROBUSTTermNode : ITreeNode
    {
        ...
        public KW_ROBUSTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROBUSTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROBUSTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
