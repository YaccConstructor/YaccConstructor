...
{
    public class Yard_exp_brackets_253NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_253NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_253NonTermNode (string s, object positions)
        {
            text = s;
