...
{
    public class Highlight_KW_STATICNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_STATICNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_STATICNonTermNode (string s, object positions)
        {
            text = s;
