...
{
    public class Highlight_KW_WITHNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_WITHNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_WITHNonTermNode (string s, object positions)
        {
            text = s;
