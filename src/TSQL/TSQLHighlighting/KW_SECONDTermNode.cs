...
{
    public class KW_SECONDTermNode : ITreeNode
    {
        ...
        public KW_SECONDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SECONDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SECONDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
