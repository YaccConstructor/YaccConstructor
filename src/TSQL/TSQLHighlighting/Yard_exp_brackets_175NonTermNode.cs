...
{
    public class Yard_exp_brackets_175NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_175NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_175NonTermNode (string s, object positions)
        {
            text = s;
