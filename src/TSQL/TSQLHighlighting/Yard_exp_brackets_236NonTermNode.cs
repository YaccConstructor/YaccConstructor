...
{
    public class Yard_exp_brackets_236NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_236NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_236NonTermNode (string s, object positions)
        {
            text = s;
