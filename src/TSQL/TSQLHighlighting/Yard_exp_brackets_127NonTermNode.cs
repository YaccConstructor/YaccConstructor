...
{
    public class Yard_exp_brackets_127NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_127NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_127NonTermNode (string s, object positions)
        {
            text = s;
