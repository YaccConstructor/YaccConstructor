...
{
    public class KW_UPDLOCKTermNode : ITreeNode
    {
        ...
        public KW_UPDLOCKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_UPDLOCKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_UPDLOCKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
