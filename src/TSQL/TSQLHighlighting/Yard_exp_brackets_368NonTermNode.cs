...
{
    public class Yard_exp_brackets_368NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_368NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_368NonTermNode (string s, object positions)
        {
            text = s;
