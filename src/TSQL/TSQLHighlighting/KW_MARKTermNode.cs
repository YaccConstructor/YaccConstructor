...
{
    public class KW_MARKTermNode : ITreeNode
    {
        ...
        public KW_MARKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MARKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MARKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
