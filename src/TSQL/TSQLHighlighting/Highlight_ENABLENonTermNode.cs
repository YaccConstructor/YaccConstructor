...
{
    public class Highlight_ENABLENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_ENABLENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_ENABLENonTermNode (string s, object positions)
        {
            text = s;
