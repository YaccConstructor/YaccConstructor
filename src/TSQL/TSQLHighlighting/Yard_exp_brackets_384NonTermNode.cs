...
{
    public class Yard_exp_brackets_384NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_384NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_384NonTermNode (string s, object positions)
        {
            text = s;
