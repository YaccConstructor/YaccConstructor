...
let private gotoSet = 
    Set.ofArray [|((0, 0, 1), set [(0, 1)]);((0, 0, 2), set [(1, 1)]);((0, 0, 3), set [(2, 1)]);((0, 0, 4), set [(2, 2)]);((1, 0, 2), set [(1, 1)]);((1, 0, 3), set [(2, 1)]);((1, 0, 4), set [(2, 2)]);((2, 0, 3), set [(2, 1)]);((2, 0, 4), set [(2, 2)]);((2, 2, 5), set [(2, 3)]);((2, 2, 6), set [(2, 4)]);((2, 2, 7), set [(2, 5)]);((2, 3, 8), set [(2, 6)]);((2, 4, 8), set [(2, 6)]);((2, 5, 8), set [(2, 6)])|]
    |> dict
