...
{
    public class Highlight_KW_FORMATFILENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FORMATFILENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FORMATFILENonTermNode (string s, object positions)
        {
            text = s;
