...
{
    public class POWTermNode : ITreeNode
    {
        ...
        public POWTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public POWTermNode (string ycTokName, string ycValue)
        {
        ...
        public POWTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
