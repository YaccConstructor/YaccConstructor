...
{
    public class Highlight_KW_FORCENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FORCENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FORCENonTermNode (string s, object positions)
        {
            text = s;
