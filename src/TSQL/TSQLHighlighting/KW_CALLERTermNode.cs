...
{
    public class KW_CALLERTermNode : ITreeNode
    {
        ...
        public KW_CALLERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CALLERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CALLERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
