...
{
    public class Highlight_KW_BITNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_BITNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_BITNonTermNode (string s, object positions)
        {
            text = s;
