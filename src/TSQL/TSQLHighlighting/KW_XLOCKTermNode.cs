...
{
    public class KW_XLOCKTermNode : ITreeNode
    {
        ...
        public KW_XLOCKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_XLOCKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_XLOCKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
