...
{
    public class KW_READCOMMITTEDTermNode : ITreeNode
    {
        ...
        public KW_READCOMMITTEDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_READCOMMITTEDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_READCOMMITTEDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
