...
{
    public class Yard_exp_brackets_389NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_389NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_389NonTermNode (string s, object positions)
        {
            text = s;
