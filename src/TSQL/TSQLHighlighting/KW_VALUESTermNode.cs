...
{
    public class KW_VALUESTermNode : ITreeNode
    {
        ...
        public KW_VALUESTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_VALUESTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_VALUESTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
