...
{
    public class Sql_valueNonTermNode : ITreeNode
    {
        ...
        public Sql_valueNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Sql_valueNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Sql_valueNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
