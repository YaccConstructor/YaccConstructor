...
{
    public class KW_WITHTermNode : ITreeNode
    {
        ...
        public KW_WITHTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_WITHTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_WITHTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
