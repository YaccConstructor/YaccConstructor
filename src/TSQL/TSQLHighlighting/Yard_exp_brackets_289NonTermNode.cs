...
{
    public class Yard_exp_brackets_289NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_289NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_289NonTermNode (string s, object positions)
        {
            text = s;
