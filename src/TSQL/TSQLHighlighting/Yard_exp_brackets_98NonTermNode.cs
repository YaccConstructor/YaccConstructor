...
{
    public class Yard_exp_brackets_98NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_98NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_98NonTermNode (string s, object positions)
        {
            text = s;
