...
{
    public class Highlight_KW_HAVINGNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_HAVINGNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_HAVINGNonTermNode (string s, object positions)
        {
            text = s;
