...
{
    public class KW_CONTAINSTABLETermNode : ITreeNode
    {
        ...
        public KW_CONTAINSTABLETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CONTAINSTABLETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CONTAINSTABLETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
