...
{
    public class Yard_exp_brackets_117NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_117NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_117NonTermNode (string s, object positions)
        {
            text = s;
