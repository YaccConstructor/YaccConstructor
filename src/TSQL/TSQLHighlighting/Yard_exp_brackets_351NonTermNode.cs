...
{
    public class Yard_exp_brackets_351NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_351NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_351NonTermNode (string s, object positions)
        {
            text = s;
