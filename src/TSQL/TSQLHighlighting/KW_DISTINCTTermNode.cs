...
{
    public class KW_DISTINCTTermNode : ITreeNode
    {
        ...
        public KW_DISTINCTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DISTINCTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DISTINCTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
