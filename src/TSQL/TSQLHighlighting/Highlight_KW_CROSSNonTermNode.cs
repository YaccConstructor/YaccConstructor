...
{
    public class Highlight_KW_CROSSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CROSSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CROSSNonTermNode (string s, object positions)
        {
            text = s;
