...
{
    public class KW_FAST_FORWARDTermNode : ITreeNode
    {
        ...
        public KW_FAST_FORWARDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FAST_FORWARDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FAST_FORWARDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
