...
{
    public class Dml_select_listNonTermNode : ITreeNode
    {
        ...
        public Dml_select_listNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Dml_select_listNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Dml_select_listNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
