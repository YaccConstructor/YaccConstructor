...
{
    public class KW_TINYINTTermNode : ITreeNode
    {
        ...
        public KW_TINYINTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TINYINTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TINYINTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
