...
{
    public class Highlight_KW_SQL_VARIANTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SQL_VARIANTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SQL_VARIANTNonTermNode (string s, object positions)
        {
            text = s;
