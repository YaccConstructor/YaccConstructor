...
{
    public class KW_BASE64TermNode : ITreeNode
    {
        ...
        public KW_BASE64TermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BASE64TermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BASE64TermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
