...
{
    public class Yard_exp_brackets_348NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_348NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_348NonTermNode (string s, object positions)
        {
            text = s;
