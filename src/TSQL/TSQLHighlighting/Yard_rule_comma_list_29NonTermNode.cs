...
{
    public class Yard_rule_comma_list_29NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_29NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_29NonTermNode (string s, object positions)
        {
            text = s;
