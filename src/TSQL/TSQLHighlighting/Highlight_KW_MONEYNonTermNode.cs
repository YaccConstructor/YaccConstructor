...
{
    public class Highlight_KW_MONEYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MONEYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MONEYNonTermNode (string s, object positions)
        {
            text = s;
