...
{
    public class Highlight_KW_OPENQUERYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OPENQUERYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OPENQUERYNonTermNode (string s, object positions)
        {
            text = s;
