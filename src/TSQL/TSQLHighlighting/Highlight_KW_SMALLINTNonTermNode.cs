...
{
    public class Highlight_KW_SMALLINTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SMALLINTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SMALLINTNonTermNode (string s, object positions)
        {
            text = s;
