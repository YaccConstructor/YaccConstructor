...
{
    public class Yard_exp_brackets_115NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_115NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_115NonTermNode (string s, object positions)
        {
            text = s;
