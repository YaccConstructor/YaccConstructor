...
{
    public class Generation_termNonTermNode : ITreeNode
    {
        ...
        public Generation_termNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Generation_termNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Generation_termNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
