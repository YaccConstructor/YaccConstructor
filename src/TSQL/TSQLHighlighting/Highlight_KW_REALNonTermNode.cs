...
{
    public class Highlight_KW_REALNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_REALNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_REALNonTermNode (string s, object positions)
        {
            text = s;
