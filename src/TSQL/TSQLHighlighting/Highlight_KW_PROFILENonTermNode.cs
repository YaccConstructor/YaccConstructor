...
{
    public class Highlight_KW_PROFILENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PROFILENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PROFILENonTermNode (string s, object positions)
        {
            text = s;
