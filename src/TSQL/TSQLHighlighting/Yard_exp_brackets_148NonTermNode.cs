...
{
    public class Yard_exp_brackets_148NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_148NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_148NonTermNode (string s, object positions)
        {
            text = s;
