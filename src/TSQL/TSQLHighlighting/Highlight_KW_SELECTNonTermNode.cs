...
{
    public class Highlight_KW_SELECTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SELECTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SELECTNonTermNode (string s, object positions)
        {
            text = s;
