...
{
    public class PredicateNonTermNode : ITreeNode
    {
        ...
        public PredicateNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public PredicateNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public PredicateNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
