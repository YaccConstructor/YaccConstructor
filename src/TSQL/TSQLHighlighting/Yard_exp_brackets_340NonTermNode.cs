...
{
    public class Yard_exp_brackets_340NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_340NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_340NonTermNode (string s, object positions)
        {
            text = s;
