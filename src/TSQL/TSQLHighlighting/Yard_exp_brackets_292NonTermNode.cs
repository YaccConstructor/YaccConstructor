...
{
    public class Yard_exp_brackets_292NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_292NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_292NonTermNode (string s, object positions)
        {
            text = s;
