...
{
    public class Yard_exp_brackets_139NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_139NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_139NonTermNode (string s, object positions)
        {
            text = s;
