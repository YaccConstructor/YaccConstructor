...
{
    public class PLUSTermNode : ITreeNode
    {
        ...
        public PLUSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public PLUSTermNode (string ycTokName, string ycValue)
        {
        ...
        public PLUSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
