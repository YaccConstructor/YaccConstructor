...
{
    public class Highlight_KW_LEFTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LEFTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LEFTNonTermNode (string s, object positions)
        {
            text = s;
