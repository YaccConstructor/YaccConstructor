...
{
    public class KW_FREETEXTTABLETermNode : ITreeNode
    {
        ...
        public KW_FREETEXTTABLETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FREETEXTTABLETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FREETEXTTABLETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
