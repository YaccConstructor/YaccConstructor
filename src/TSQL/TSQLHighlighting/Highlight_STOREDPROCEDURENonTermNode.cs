...
{
    public class Highlight_STOREDPROCEDURENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_STOREDPROCEDURENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_STOREDPROCEDURENonTermNode (string s, object positions)
        {
            text = s;
