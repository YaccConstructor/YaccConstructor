...
{
    public class Highlight_KW_LASTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LASTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LASTNonTermNode (string s, object positions)
        {
            text = s;
