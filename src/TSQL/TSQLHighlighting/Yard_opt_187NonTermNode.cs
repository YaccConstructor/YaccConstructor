...
{
    public class Yard_opt_187NonTermNode : ITreeNode
    {
        ...
        public Yard_opt_187NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_opt_187NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_opt_187NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
