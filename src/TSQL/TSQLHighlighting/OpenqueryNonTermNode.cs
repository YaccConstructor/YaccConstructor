...
{
    public class OpenqueryNonTermNode : ITreeNode
    {
        ...
        public OpenqueryNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public OpenqueryNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public OpenqueryNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
