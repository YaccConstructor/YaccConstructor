...
{
    public class Yard_exp_brackets_408NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_408NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_408NonTermNode (string s, object positions)
        {
            text = s;
