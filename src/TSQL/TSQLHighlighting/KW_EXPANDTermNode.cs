...
{
    public class KW_EXPANDTermNode : ITreeNode
    {
        ...
        public KW_EXPANDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_EXPANDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_EXPANDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
