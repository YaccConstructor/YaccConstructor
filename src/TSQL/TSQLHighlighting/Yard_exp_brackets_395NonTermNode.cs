...
{
    public class Yard_exp_brackets_395NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_395NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_395NonTermNode (string s, object positions)
        {
            text = s;
