...
{
    public class KW_REPEATABLEREADTermNode : IAbstractTreeNode
    {
        ...
        public KW_REPEATABLEREADTermNode (string s)
        {
            text = s;
        }

        public KW_REPEATABLEREADTermNode (string s, object positions)
        {
            text = s;
