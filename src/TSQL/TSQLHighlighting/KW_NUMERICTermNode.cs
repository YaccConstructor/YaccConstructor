...
{
    public class KW_NUMERICTermNode : ITreeNode
    {
        ...
        public KW_NUMERICTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NUMERICTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NUMERICTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
