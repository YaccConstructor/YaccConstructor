...
{
    public class Yard_exp_brackets_131NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_131NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_131NonTermNode (string s, object positions)
        {
            text = s;
