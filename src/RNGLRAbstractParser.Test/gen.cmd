..\packages\YaccConstructor.0.0.8.11\tools\YaccConstructor\YaccConstructor.exe -i SimpleCalc.yrd -c ExpandEbnf -c ExpandMeta ^
        -g "RNGLRGenerator -pos int -token int -module RNGLR.ParseSimpleCalc -translate true -table LR -o SimpleCalc.yrd.fs" >> log.txt

..\packages\YaccConstructor.0.0.8.11\tools\YaccConstructor\YaccConstructor.exe -i Calc.yrd -c ExpandEbnf -c ExpandMeta ^
        -g "RNGLRGenerator -pos int -token int -module RNGLR.ParseCalc -translate true -table LR -o Calc.yrd.fs" >> log.txt

..\packages\YaccConstructor.0.0.8.11\tools\YaccConstructor\YaccConstructor.exe -i simpleCalc_with_Nterms.yrd -c ExpandEbnf -c ExpandMeta ^
...
..\packages\YaccConstructor.0.0.8.11\tools\YaccConstructor\YaccConstructor.exe -i simpleCalc_with_Nterms_2.yrd -c ExpandEbnf -c ExpandMeta ^
...
..\packages\YaccConstructor.0.0.8.11\tools\YaccConstructor\YaccConstructor.exe -i simpleCalc_with_Nterms_3.yrd -c ExpandEbnf -c ExpandMeta ^
...
..\packages\YaccConstructor.0.0.8.11\tools\YaccConstructor\YaccConstructor.exe -i simpleCalc_with_Nterms_4.yrd -c ExpandEbnf -c ExpandMeta ^
...
..\packages\YaccConstructor.0.0.8.11\tools\YaccConstructor\YaccConstructor.exe -i PrettySimpleCalc.yrd -c ExpandEbnf -c ExpandMeta ^
