...
{
    public class KW_OPENQUERYTermNode : ITreeNode
    {
        ...
        public KW_OPENQUERYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_OPENQUERYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_OPENQUERYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
