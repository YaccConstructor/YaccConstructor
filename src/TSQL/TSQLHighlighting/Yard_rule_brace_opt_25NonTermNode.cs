...
{
    public class Yard_rule_brace_opt_25NonTermNode : ITreeNode
    {
        ...
        public Yard_rule_brace_opt_25NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_rule_brace_opt_25NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_rule_brace_opt_25NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
