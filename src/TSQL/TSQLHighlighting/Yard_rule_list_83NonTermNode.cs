...
{
    public class Yard_rule_list_83NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_83NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_83NonTermNode (string s, object positions)
        {
            text = s;
