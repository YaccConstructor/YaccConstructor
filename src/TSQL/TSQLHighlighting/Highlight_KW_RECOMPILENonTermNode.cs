...
{
    public class Highlight_KW_RECOMPILENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_RECOMPILENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_RECOMPILENonTermNode (string s, object positions)
        {
            text = s;
