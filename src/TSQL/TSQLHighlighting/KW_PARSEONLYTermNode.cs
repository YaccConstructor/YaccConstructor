...
{
    public class KW_PARSEONLYTermNode : ITreeNode
    {
        ...
        public KW_PARSEONLYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PARSEONLYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PARSEONLYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
