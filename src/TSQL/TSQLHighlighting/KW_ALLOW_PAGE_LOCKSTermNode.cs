...
{
    public class KW_ALLOW_PAGE_LOCKSTermNode : IAbstractTreeNode
    {
        ...
        public KW_ALLOW_PAGE_LOCKSTermNode (string s)
        {
            text = s;
        }

        public KW_ALLOW_PAGE_LOCKSTermNode (string s, object positions)
        {
            text = s;
