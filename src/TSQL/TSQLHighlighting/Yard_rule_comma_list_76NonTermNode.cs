...
{
    public class Yard_rule_comma_list_76NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_76NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_76NonTermNode (string s, object positions)
        {
            text = s;
