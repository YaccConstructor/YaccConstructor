...
{
    public class If_stmtNonTermNode : ITreeNode
    {
        ...
        public If_stmtNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public If_stmtNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public If_stmtNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
