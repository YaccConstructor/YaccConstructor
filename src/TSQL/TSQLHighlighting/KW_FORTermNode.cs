...
{
    public class KW_FORTermNode : ITreeNode
    {
        ...
        public KW_FORTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FORTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FORTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
