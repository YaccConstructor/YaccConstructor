...
{
    public class Yard_rule_comma_list_79NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_79NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_79NonTermNode (string s, object positions)
        {
            text = s;
