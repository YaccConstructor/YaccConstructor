...
{
    public class KW_LOOPTermNode : ITreeNode
    {
        ...
        public KW_LOOPTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LOOPTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LOOPTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
