...
{
    public class Yard_exp_brackets_279NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_279NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_279NonTermNode (string s, object positions)
        {
            text = s;
