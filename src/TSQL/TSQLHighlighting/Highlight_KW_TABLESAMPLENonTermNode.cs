...
{
    public class Highlight_KW_TABLESAMPLENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TABLESAMPLENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TABLESAMPLENonTermNode (string s, object positions)
        {
            text = s;
