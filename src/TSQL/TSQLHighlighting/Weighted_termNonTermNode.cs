...
{
    public class Weighted_termNonTermNode : IAbstractTreeNode
    {
        ...
        public Weighted_termNonTermNode (string s)
        {
            text = s;
        }

        public Weighted_termNonTermNode (string s, object positions)
        {
            text = s;
