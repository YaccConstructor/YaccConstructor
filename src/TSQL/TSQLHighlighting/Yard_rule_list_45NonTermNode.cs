...
{
    public class Yard_rule_list_45NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_45NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_45NonTermNode (string s, object positions)
        {
            text = s;
