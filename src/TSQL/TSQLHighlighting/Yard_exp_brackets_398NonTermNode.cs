...
{
    public class Yard_exp_brackets_398NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_398NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_398NonTermNode (string s, object positions)
        {
            text = s;
