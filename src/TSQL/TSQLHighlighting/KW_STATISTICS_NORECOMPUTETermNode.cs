...
{
    public class KW_STATISTICS_NORECOMPUTETermNode : ITreeNode
    {
        ...
        public KW_STATISTICS_NORECOMPUTETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_STATISTICS_NORECOMPUTETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_STATISTICS_NORECOMPUTETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
