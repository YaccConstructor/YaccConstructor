...
{
    public class Yard_exp_brackets_100NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_100NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_100NonTermNode (string s, object positions)
        {
            text = s;
