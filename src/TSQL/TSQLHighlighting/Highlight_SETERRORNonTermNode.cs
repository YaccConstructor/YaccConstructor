...
{
    public class Highlight_SETERRORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_SETERRORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_SETERRORNonTermNode (string s, object positions)
        {
            text = s;
