...
{
    public class Highlight_KW_ANSI_PADDINGNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ANSI_PADDINGNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ANSI_PADDINGNonTermNode (string s, object positions)
        {
            text = s;
