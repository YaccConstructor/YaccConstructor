...
{
    public class KW_FIRSTROWTermNode : ITreeNode
    {
        ...
        public KW_FIRSTROWTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FIRSTROWTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FIRSTROWTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
