...
{
    public class Yard_opt_206NonTermNode : ITreeNode
    {
        ...
        public Yard_opt_206NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_opt_206NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_opt_206NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
