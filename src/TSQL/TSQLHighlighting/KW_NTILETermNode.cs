...
{
    public class KW_NTILETermNode : ITreeNode
    {
        ...
        public KW_NTILETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NTILETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NTILETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
