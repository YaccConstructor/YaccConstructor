...
{
    public class Yard_exp_brackets_91NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_91NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_91NonTermNode (string s, object positions)
        {
            text = s;
