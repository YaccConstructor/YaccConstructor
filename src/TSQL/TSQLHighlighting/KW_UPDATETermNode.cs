...
{
    public class KW_UPDATETermNode : ITreeNode
    {
        ...
        public KW_UPDATETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_UPDATETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_UPDATETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
