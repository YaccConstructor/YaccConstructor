...
{
    public class Highlight_KW_MAXRECURSIONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MAXRECURSIONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MAXRECURSIONNonTermNode (string s, object positions)
        {
            text = s;
