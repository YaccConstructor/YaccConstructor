...
{
    public class KW_ANSI_NULL_DFLTTermNode : ITreeNode
    {
        ...
        public KW_ANSI_NULL_DFLTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ANSI_NULL_DFLTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ANSI_NULL_DFLTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
