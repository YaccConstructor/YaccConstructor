...
{
    public class KW_DELETETermNode : ITreeNode
    {
        ...
        public KW_DELETETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DELETETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DELETETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
