...
{
    public class Yard_exp_brackets_237NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_237NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_237NonTermNode (string s, object positions)
        {
            text = s;
