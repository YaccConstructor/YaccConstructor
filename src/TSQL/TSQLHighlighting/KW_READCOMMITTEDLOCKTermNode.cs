...
{
    public class KW_READCOMMITTEDLOCKTermNode : ITreeNode
    {
        ...
        public KW_READCOMMITTEDLOCKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_READCOMMITTEDLOCKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_READCOMMITTEDLOCKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
