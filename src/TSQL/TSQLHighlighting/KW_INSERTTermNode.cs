...
{
    public class KW_INSERTTermNode : ITreeNode
    {
        ...
        public KW_INSERTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_INSERTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_INSERTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
