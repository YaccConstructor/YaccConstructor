...
{
    public class Highlight_KW_IDENTITYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_IDENTITYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_IDENTITYNonTermNode (string s, object positions)
        {
            text = s;
