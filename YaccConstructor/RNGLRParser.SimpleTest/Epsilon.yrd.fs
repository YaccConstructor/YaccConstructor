...
let _rnglr_epsilons : Tree<Token>[] = [|new Tree<_>(null,box (new AST(new Family(6, [|box (new AST(new Family(0, [||]), null)); box (new AST(new Family(2, [||]), null)); box (new AST(new Family(4, [||]), null))|]), null))); new Tree<_>(null,box (new AST(new Family(0, [||]), null))); new Tree<_>(null,box (new AST(new Family(2, [||]), null))); new Tree<_>(null,box (new AST(new Family(4, [||]), null))); new Tree<_>(null,box (new AST(new Family(7, [|box (new AST(new Family(6, [|box (new AST(new Family(0, [||]), null)); box (new AST(new Family(2, [||]), null)); box (new AST(new Family(4, [||]), null))|]), null))|]), null)))|]
