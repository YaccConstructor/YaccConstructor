...
{
    public class KW_ANSI_PADDINGTermNode : ITreeNode
    {
        ...
        public KW_ANSI_PADDINGTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ANSI_PADDINGTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ANSI_PADDINGTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
