...
{
    public class Highlight_KW_MERGENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MERGENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MERGENonTermNode (string s, object positions)
        {
            text = s;
