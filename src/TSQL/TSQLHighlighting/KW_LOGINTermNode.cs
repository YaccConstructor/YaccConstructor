...
{
    public class KW_LOGINTermNode : ITreeNode
    {
        ...
        public KW_LOGINTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_LOGINTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_LOGINTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
