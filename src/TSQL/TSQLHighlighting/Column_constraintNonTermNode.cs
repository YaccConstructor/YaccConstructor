...
{
    public class Column_constraintNonTermNode : IAbstractTreeNode
    {
        ...
        public Column_constraintNonTermNode (string s)
        {
            text = s;
        }

        public Column_constraintNonTermNode (string s, object positions)
        {
            text = s;
