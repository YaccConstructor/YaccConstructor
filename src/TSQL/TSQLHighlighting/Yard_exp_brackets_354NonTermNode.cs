...
{
    public class Yard_exp_brackets_354NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_354NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_354NonTermNode (string s, object positions)
        {
            text = s;
