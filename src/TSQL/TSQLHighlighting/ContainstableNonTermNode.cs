...
{
    public class ContainstableNonTermNode : ITreeNode
    {
        ...
        public ContainstableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ContainstableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public ContainstableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
