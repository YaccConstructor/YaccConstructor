...
{
    public class Yard_exp_brackets_356NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_356NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_356NonTermNode (string s, object positions)
        {
            text = s;
