...
{
    public class Yard_exp_brackets_222NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_222NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_222NonTermNode (string s, object positions)
        {
            text = s;
