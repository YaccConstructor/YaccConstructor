...
{
    public class Yard_rule_comma_list_19NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_19NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_19NonTermNode (string s, object positions)
        {
            text = s;
