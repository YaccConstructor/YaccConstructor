...
{
    public class Highlight_KW_PERCENTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PERCENTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PERCENTNonTermNode (string s, object positions)
        {
            text = s;
