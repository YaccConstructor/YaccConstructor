...
{
    public class Tablesample_clauseNonTermNode : ITreeNode
    {
        ...
        public Tablesample_clauseNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Tablesample_clauseNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Tablesample_clauseNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
