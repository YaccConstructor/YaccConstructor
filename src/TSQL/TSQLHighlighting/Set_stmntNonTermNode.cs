...
{
    public class Set_stmntNonTermNode : ITreeNode
    {
        ...
        public Set_stmntNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Set_stmntNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Set_stmntNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
