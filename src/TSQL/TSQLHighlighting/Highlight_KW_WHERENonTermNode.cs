...
{
    public class Highlight_KW_WHERENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_WHERENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_WHERENonTermNode (string s, object positions)
        {
            text = s;
