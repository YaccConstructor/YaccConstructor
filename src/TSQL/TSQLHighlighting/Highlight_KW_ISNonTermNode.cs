...
{
    public class Highlight_KW_ISNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ISNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ISNonTermNode (string s, object positions)
        {
            text = s;
