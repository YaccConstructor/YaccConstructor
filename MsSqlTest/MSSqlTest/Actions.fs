...
let ruleToAction = dict [|(9,sql_expr9); (10,binop8); (7,execute_as7); (3,sql_datatype6); (8,set_stmnt5); (6,proc_body_stmnt4); (5,create_proc3); (2,start22); (4,root_rule1); (0,start0)|]
