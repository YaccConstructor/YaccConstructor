...
{
    public class Highlight_KW_IMPLICIT_TRANSACTIONSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_IMPLICIT_TRANSACTIONSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_IMPLICIT_TRANSACTIONSNonTermNode (string s, object positions)
        {
            text = s;
