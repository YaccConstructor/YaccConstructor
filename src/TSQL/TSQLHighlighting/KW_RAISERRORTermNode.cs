...
{
    public class KW_RAISERRORTermNode : ITreeNode
    {
        ...
        public KW_RAISERRORTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_RAISERRORTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_RAISERRORTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
