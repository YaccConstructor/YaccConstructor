...
{
    public class KW_SINGLE_BLOBTermNode : ITreeNode
    {
        ...
        public KW_SINGLE_BLOBTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SINGLE_BLOBTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SINGLE_BLOBTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
