...
{
    public class KW_COLLATETermNode : ITreeNode
    {
        ...
        public KW_COLLATETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_COLLATETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_COLLATETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
