...
{
    public class Yard_exp_brackets_146NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_146NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_146NonTermNode (string s, object positions)
        {
            text = s;
