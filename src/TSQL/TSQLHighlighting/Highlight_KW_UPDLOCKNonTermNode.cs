...
{
    public class Highlight_KW_UPDLOCKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_UPDLOCKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_UPDLOCKNonTermNode (string s, object positions)
        {
            text = s;
