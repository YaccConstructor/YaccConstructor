...
{
    public class KW_PAD_INDEXTermNode : ITreeNode
    {
        ...
        public KW_PAD_INDEXTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PAD_INDEXTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PAD_INDEXTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
