...
{
    public class KW_ABSENTTermNode : ITreeNode
    {
        ...
        public KW_ABSENTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ABSENTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ABSENTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
