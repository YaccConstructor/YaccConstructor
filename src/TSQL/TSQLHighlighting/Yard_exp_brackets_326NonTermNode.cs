...
{
    public class Yard_exp_brackets_326NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_326NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_326NonTermNode (string s, object positions)
        {
            text = s;
