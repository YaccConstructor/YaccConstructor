...
{
    public class Yard_exp_brackets_308NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_308NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_308NonTermNode (string s, object positions)
        {
            text = s;
