...
{
    public class Yard_exp_brackets_207NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_207NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_207NonTermNode (string s, object positions)
        {
            text = s;
