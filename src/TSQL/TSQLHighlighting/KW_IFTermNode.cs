...
{
    public class KW_IFTermNode : ITreeNode
    {
        ...
        public KW_IFTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_IFTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_IFTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
