...
{
    public class Yard_opt_90NonTermNode : ITreeNode
    {
        ...
        public Yard_opt_90NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_opt_90NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_opt_90NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
