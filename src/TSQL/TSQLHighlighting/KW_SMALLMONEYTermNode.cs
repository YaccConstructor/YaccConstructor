...
{
    public class KW_SMALLMONEYTermNode : ITreeNode
    {
        ...
        public KW_SMALLMONEYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SMALLMONEYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SMALLMONEYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
