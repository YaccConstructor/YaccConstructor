...
{
    public class Yard_exp_brackets_300NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_300NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_300NonTermNode (string s, object positions)
        {
            text = s;
