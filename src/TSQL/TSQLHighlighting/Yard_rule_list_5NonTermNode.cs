...
{
    public class Yard_rule_list_5NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_5NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_5NonTermNode (string s, object positions)
        {
            text = s;
