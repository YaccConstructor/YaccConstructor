...
{
    public class Highlight_KW_GLOBALNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_GLOBALNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_GLOBALNonTermNode (string s, object positions)
        {
            text = s;
