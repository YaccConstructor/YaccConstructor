...
{
    public class Right_square_bracket_LitNode : IAbstractTreeNode
    {
        ...
        public Right_square_bracket_LitNode (string s)
        {
            text = s;
        }

        public Right_square_bracket_LitNode (string s, object positions)
        {
            text = s;
