...
{
    public class KW_BROWSETermNode : ITreeNode
    {
        ...
        public KW_BROWSETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_BROWSETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_BROWSETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
