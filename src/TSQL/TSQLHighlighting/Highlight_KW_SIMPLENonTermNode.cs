...
{
    public class Highlight_KW_SIMPLENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SIMPLENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SIMPLENonTermNode (string s, object positions)
        {
            text = s;
