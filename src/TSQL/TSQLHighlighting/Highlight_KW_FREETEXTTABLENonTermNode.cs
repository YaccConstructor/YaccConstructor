...
{
    public class Highlight_KW_FREETEXTTABLENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FREETEXTTABLENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FREETEXTTABLENonTermNode (string s, object positions)
        {
            text = s;
