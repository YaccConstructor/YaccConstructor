...
{
    public class Column_definition_create_tableNonTermNode : ITreeNode
    {
        ...
        public Column_definition_create_tableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Column_definition_create_tableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Column_definition_create_tableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
