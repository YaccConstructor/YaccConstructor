...
{
    public class Yard_exp_brackets_124NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_124NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_124NonTermNode (string s, object positions)
        {
            text = s;
