...
{
    public class Yard_rule_list_71NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_71NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_71NonTermNode (string s, object positions)
        {
            text = s;
