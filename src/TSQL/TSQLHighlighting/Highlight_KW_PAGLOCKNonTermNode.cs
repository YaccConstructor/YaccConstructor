...
{
    public class Highlight_KW_PAGLOCKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PAGLOCKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PAGLOCKNonTermNode (string s, object positions)
        {
            text = s;
