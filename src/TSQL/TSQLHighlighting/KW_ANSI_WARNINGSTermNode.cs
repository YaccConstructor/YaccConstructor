...
{
    public class KW_ANSI_WARNINGSTermNode : IAbstractTreeNode
    {
        ...
        public KW_ANSI_WARNINGSTermNode (string s)
        {
            text = s;
        }

        public KW_ANSI_WARNINGSTermNode (string s, object positions)
        {
            text = s;
