...
{
    public class Highlight_CLASSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_CLASSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_CLASSNonTermNode (string s, object positions)
        {
            text = s;
