...
{
    public class KW_NEARTermNode : ITreeNode
    {
        ...
        public KW_NEARTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NEARTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NEARTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
