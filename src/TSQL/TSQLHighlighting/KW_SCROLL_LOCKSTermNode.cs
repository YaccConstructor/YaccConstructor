...
{
    public class KW_SCROLL_LOCKSTermNode : ITreeNode
    {
        ...
        public KW_SCROLL_LOCKSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_SCROLL_LOCKSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_SCROLL_LOCKSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
