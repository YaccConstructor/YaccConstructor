...
{
    public class KW_KEEPTermNode : ITreeNode
    {
        ...
        public KW_KEEPTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_KEEPTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_KEEPTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
