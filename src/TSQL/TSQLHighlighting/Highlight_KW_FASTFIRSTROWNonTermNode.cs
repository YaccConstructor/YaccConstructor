...
{
    public class Highlight_KW_FASTFIRSTROWNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FASTFIRSTROWNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FASTFIRSTROWNonTermNode (string s, object positions)
        {
            text = s;
