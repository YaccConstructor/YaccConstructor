...
{
    public class Highlight_TYPENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_TYPENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_TYPENonTermNode (string s, object positions)
        {
            text = s;
