...
{
    public class Yard_exp_brackets_252NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_252NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_252NonTermNode (string s, object positions)
        {
            text = s;
