...
{
    public class Yard_exp_brackets_396NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_396NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_396NonTermNode (string s, object positions)
        {
            text = s;
