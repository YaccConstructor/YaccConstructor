...
{
    public class Yard_exp_brackets_112NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_112NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_112NonTermNode (string s, object positions)
        {
            text = s;
