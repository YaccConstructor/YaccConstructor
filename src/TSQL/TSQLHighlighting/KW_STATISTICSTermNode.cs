...
{
    public class KW_STATISTICSTermNode : ITreeNode
    {
        ...
        public KW_STATISTICSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_STATISTICSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_STATISTICSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
