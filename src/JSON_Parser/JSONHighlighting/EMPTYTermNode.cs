...
{
    public class EMPTYTermNode : ITreeNode
    {
        ...
        public EMPTYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public EMPTYTermNode (string ycTokName, string ycValue)
        {
        ...
        public EMPTYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
