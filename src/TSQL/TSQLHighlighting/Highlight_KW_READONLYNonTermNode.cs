...
{
    public class Highlight_KW_READONLYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_READONLYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_READONLYNonTermNode (string s, object positions)
        {
            text = s;
