...
{
    public class KW_FLOATTermNode : ITreeNode
    {
        ...
        public KW_FLOATTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FLOATTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FLOATTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
