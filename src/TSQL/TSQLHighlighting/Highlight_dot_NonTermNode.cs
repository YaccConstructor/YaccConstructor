...
{
    public class Highlight_dot_NonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_dot_NonTermNode (string s)
        {
            text = s;
        }

        public Highlight_dot_NonTermNode (string s, object positions)
        {
            text = s;
