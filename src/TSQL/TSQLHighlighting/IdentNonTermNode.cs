...
{
    public class IdentNonTermNode : ITreeNode
    {
        ...
        public IdentNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public IdentNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public IdentNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
