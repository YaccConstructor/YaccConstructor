...
{
    public class BinopNonTermNode : ITreeNode
    {
        ...
        public BinopNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public BinopNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public BinopNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
