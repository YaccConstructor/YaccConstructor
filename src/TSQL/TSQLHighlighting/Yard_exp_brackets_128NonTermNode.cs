...
{
    public class Yard_exp_brackets_128NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_128NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_128NonTermNode (string s, object positions)
        {
            text = s;
