...
{
    public class Yard_some_2NonTermNode : ITreeNode
    {
        ...
        public Yard_some_2NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_some_2NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_some_2NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
