...
{
    public class STOREDPROCEDURETermNode : ITreeNode
    {
        ...
        public STOREDPROCEDURETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public STOREDPROCEDURETermNode (string ycTokName, string ycValue)
        {
        ...
        public STOREDPROCEDURETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
