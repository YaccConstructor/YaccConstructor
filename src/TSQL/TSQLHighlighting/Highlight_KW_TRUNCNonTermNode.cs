...
{
    public class Highlight_KW_TRUNCNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TRUNCNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TRUNCNonTermNode (string s, object positions)
        {
            text = s;
