...
{
    public class KW_CHARTermNode : ITreeNode
    {
        ...
        public KW_CHARTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CHARTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CHARTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
