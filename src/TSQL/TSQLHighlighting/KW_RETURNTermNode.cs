...
{
    public class KW_RETURNTermNode : ITreeNode
    {
        ...
        public KW_RETURNTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_RETURNTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_RETURNTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
