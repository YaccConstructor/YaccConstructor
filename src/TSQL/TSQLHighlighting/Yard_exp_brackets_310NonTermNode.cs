...
{
    public class Yard_exp_brackets_310NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_310NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_310NonTermNode (string s, object positions)
        {
            text = s;
