...
{
    public class KW_ROLLBACKTermNode : ITreeNode
    {
        ...
        public KW_ROLLBACKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROLLBACKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROLLBACKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
