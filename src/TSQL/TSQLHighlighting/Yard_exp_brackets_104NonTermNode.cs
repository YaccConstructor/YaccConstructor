...
{
    public class Yard_exp_brackets_104NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_104NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_104NonTermNode (string s, object positions)
        {
            text = s;
