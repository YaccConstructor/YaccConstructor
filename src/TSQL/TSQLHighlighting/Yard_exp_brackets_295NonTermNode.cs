...
{
    public class Yard_exp_brackets_295NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_295NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_295NonTermNode (string s, object positions)
        {
            text = s;
