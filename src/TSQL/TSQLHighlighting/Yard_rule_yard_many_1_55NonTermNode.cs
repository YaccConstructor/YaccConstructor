...
{
    public class Yard_rule_yard_many_1_55NonTermNode : ITreeNode
    {
        ...
        public Yard_rule_yard_many_1_55NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_rule_yard_many_1_55NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_rule_yard_many_1_55NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
