...
{
    public class Highlight_KW_NONCLUSTEREDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NONCLUSTEREDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NONCLUSTEREDNonTermNode (string s, object positions)
        {
            text = s;
