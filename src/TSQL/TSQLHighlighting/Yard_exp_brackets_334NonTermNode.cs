...
{
    public class Yard_exp_brackets_334NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_334NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_334NonTermNode (string s, object positions)
        {
            text = s;
