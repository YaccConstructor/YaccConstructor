...
{
    public class CursorLitNode : ITreeNode
    {
        ...
        public CursorLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public CursorLitNode (string ycTokName, string ycValue)
        {
        ...
        public CursorLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
