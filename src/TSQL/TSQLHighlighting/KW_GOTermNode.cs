...
{
    public class KW_GOTermNode : ITreeNode
    {
        ...
        public KW_GOTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_GOTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_GOTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
