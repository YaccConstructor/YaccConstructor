...
{
    public class Highlight_KW_REPLICATIONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_REPLICATIONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_REPLICATIONNonTermNode (string s, object positions)
        {
            text = s;
