...
{
    public class Highlight_KW_INNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_INNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_INNonTermNode (string s, object positions)
        {
            text = s;
