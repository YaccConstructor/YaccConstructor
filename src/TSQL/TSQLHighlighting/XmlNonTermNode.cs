...
{
    public class XmlNonTermNode : ITreeNode
    {
        ...
        public XmlNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public XmlNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public XmlNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
