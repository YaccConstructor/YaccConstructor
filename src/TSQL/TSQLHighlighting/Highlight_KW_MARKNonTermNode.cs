...
{
    public class Highlight_KW_MARKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MARKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MARKNonTermNode (string s, object positions)
        {
            text = s;
