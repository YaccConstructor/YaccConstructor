...
{
    public class Highlight_KW_XMLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_XMLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_XMLNonTermNode (string s, object positions)
        {
            text = s;
