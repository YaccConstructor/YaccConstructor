...
{
    public class Highlight_KW_JOINNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_JOINNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_JOINNonTermNode (string s, object positions)
        {
            text = s;
