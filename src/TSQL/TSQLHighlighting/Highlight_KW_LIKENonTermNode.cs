...
{
    public class Highlight_KW_LIKENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LIKENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LIKENonTermNode (string s, object positions)
        {
            text = s;
