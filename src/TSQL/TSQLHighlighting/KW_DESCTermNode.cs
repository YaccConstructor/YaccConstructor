...
{
    public class KW_DESCTermNode : ITreeNode
    {
        ...
        public KW_DESCTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DESCTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DESCTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
