...
{
    public class Highlight_KW_IS_MEMBERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_IS_MEMBERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_IS_MEMBERNonTermNode (string s, object positions)
        {
            text = s;
