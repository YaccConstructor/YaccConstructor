...
{
    public class Left_square_bracket_LitNode : ITreeNode
    {
        ...
        public Left_square_bracket_LitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Left_square_bracket_LitNode (string ycTokName, string ycValue)
        {
        ...
        public Left_square_bracket_LitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
