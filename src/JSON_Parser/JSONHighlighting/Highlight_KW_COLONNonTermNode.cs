...
{
    public class Highlight_KW_COLONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_COLONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_COLONNonTermNode (string s, object positions)
        {
            text = s;
