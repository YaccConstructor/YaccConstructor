...
{
    public class Yard_opt_51NonTermNode : ITreeNode
    {
        ...
        public Yard_opt_51NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_opt_51NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_opt_51NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
