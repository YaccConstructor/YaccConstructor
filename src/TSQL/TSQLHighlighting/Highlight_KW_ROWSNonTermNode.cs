...
{
    public class Highlight_KW_ROWSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROWSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROWSNonTermNode (string s, object positions)
        {
            text = s;
