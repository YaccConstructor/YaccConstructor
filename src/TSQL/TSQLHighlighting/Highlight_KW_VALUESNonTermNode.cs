...
{
    public class Highlight_KW_VALUESNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_VALUESNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_VALUESNonTermNode (string s, object positions)
        {
            text = s;
