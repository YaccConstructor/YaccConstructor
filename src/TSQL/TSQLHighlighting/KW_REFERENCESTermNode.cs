...
{
    public class KW_REFERENCESTermNode : ITreeNode
    {
        ...
        public KW_REFERENCESTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_REFERENCESTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_REFERENCESTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
