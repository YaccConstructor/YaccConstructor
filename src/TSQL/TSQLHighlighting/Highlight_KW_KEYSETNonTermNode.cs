...
{
    public class Highlight_KW_KEYSETNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_KEYSETNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_KEYSETNonTermNode (string s, object positions)
        {
            text = s;
