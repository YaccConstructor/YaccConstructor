...
{
    public class Sql_expr_not_concatNonTermNode : ITreeNode
    {
        ...
        public Sql_expr_not_concatNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Sql_expr_not_concatNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Sql_expr_not_concatNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
