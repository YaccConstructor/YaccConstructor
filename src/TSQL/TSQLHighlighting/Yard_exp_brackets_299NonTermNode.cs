...
{
    public class Yard_exp_brackets_299NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_299NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_299NonTermNode (string s, object positions)
        {
            text = s;
