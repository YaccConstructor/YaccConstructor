...
{
    public class RNGLR_EOFTermNode : ITreeNode
    {
        ...
        public RNGLR_EOFTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public RNGLR_EOFTermNode (string ycTokName, string ycValue)
        {
        ...
        public RNGLR_EOFTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
