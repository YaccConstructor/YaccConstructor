...
{
    public class Yard_rule_comma_list_4NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_4NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_4NonTermNode (string s, object positions)
        {
            text = s;
