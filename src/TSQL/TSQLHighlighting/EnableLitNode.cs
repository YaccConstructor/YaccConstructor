...
{
    public class EnableLitNode : ITreeNode
    {
        ...
        public EnableLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public EnableLitNode (string ycTokName, string ycValue)
        {
        ...
        public EnableLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
