...
{
    public class Highlight_KW_SINGLE_CLOBNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SINGLE_CLOBNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SINGLE_CLOBNonTermNode (string s, object positions)
        {
            text = s;
