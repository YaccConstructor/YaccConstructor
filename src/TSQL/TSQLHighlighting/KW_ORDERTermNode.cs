...
{
    public class KW_ORDERTermNode : ITreeNode
    {
        ...
        public KW_ORDERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ORDERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ORDERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
