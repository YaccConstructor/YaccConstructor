...
{
    public class Highlight_KW_LOOPNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_LOOPNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_LOOPNonTermNode (string s, object positions)
        {
            text = s;
