...
{
    public class Yard_exp_brackets_243NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_243NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_243NonTermNode (string s, object positions)
        {
            text = s;
