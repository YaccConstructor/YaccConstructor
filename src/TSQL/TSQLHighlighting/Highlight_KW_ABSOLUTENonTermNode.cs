...
{
    public class Highlight_KW_ABSOLUTENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ABSOLUTENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ABSOLUTENonTermNode (string s, object positions)
        {
            text = s;
