...
{
    public class StateLitNode : ITreeNode
    {
        ...
        public StateLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public StateLitNode (string ycTokName, string ycValue)
        {
        ...
        public StateLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
