...
{
    public class KW_PRIORTermNode : ITreeNode
    {
        ...
        public KW_PRIORTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PRIORTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PRIORTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
