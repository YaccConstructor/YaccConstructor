...
{
    public class Begin_transactionNonTermNode : ITreeNode
    {
        ...
        public Begin_transactionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Begin_transactionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Begin_transactionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
