...
{
    public class Highlight_KW_UPDATENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_UPDATENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_UPDATENonTermNode (string s, object positions)
        {
            text = s;
