...
{
    public class Yard_rule_comma_list_70NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_70NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_70NonTermNode (string s, object positions)
        {
            text = s;
