...
{
    public class Delete_updateNonTermNode : ITreeNode
    {
        ...
        public Delete_updateNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Delete_updateNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Delete_updateNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
