...
{
    public class Highlight_KW_ASCNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ASCNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ASCNonTermNode (string s, object positions)
        {
            text = s;
