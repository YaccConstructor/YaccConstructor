...
{
    public class Yard_exp_brackets_179NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_179NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_179NonTermNode (string s, object positions)
        {
            text = s;
