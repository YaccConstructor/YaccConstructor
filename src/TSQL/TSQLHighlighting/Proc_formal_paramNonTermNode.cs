...
{
    public class Proc_formal_paramNonTermNode : IAbstractTreeNode
    {
        ...
        public Proc_formal_paramNonTermNode (string s)
        {
            text = s;
        }

        public Proc_formal_paramNonTermNode (string s, object positions)
        {
            text = s;
