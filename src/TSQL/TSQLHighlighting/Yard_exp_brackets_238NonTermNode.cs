...
{
    public class Yard_exp_brackets_238NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_238NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_238NonTermNode (string s, object positions)
        {
            text = s;
