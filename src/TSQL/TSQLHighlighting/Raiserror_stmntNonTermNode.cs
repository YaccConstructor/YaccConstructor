...
{
    public class Raiserror_stmntNonTermNode : IAbstractTreeNode
    {
        ...
        public Raiserror_stmntNonTermNode (string s)
        {
            text = s;
        }

        public Raiserror_stmntNonTermNode (string s, object positions)
        {
            text = s;
