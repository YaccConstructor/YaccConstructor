...
{
    public class KW_CASCADETermNode : ITreeNode
    {
        ...
        public KW_CASCADETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_CASCADETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_CASCADETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
