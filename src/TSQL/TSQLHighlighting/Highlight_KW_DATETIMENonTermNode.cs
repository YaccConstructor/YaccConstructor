...
{
    public class Highlight_KW_DATETIMENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_DATETIMENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_DATETIMENonTermNode (string s, object positions)
        {
            text = s;
