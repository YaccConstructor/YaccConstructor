...
{
    public class Yard_exp_brackets_168NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_168NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_168NonTermNode (string s, object positions)
        {
            text = s;
