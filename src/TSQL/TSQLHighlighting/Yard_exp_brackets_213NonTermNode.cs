...
{
    public class Yard_exp_brackets_213NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_213NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_213NonTermNode (string s, object positions)
        {
            text = s;
