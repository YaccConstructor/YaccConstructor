...
{
    public class Yard_exp_brackets_411NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_411NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_411NonTermNode (string s, object positions)
        {
            text = s;
