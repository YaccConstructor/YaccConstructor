...
{
    public class KW_MINUTETermNode : ITreeNode
    {
        ...
        public KW_MINUTETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MINUTETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MINUTETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
