...
{
    public class KW_ENDTermNode : ITreeNode
    {
        ...
        public KW_ENDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ENDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ENDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
