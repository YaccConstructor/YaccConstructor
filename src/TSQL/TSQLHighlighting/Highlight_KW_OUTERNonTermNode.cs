...
{
    public class Highlight_KW_OUTERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OUTERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OUTERNonTermNode (string s, object positions)
        {
            text = s;
