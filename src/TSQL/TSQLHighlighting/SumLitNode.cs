...
{
    public class SumLitNode : ITreeNode
    {
        ...
        public SumLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public SumLitNode (string ycTokName, string ycValue)
        {
        ...
        public SumLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
