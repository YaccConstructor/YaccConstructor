...
{
    public class Yard_exp_brackets_119NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_119NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_119NonTermNode (string s, object positions)
        {
            text = s;
