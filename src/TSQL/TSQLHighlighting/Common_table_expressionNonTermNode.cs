...
{
    public class Common_table_expressionNonTermNode : ITreeNode
    {
        ...
        public Common_table_expressionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Common_table_expressionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Common_table_expressionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
