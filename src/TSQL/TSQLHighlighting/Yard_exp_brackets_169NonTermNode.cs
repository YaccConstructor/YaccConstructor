...
{
    public class Yard_exp_brackets_169NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_169NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_169NonTermNode (string s, object positions)
        {
            text = s;
