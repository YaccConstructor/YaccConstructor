...
{
    public class KW_TYPETermNode : ITreeNode
    {
        ...
        public KW_TYPETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TYPETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TYPETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
