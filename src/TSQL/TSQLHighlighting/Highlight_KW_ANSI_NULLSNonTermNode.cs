...
{
    public class Highlight_KW_ANSI_NULLSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ANSI_NULLSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ANSI_NULLSNonTermNode (string s, object positions)
        {
            text = s;
