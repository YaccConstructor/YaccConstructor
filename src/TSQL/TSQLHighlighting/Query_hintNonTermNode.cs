...
{
    public class Query_hintNonTermNode : ITreeNode
    {
        ...
        public Query_hintNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Query_hintNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Query_hintNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
