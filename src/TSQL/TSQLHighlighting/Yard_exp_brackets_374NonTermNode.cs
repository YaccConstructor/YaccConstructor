...
{
    public class Yard_exp_brackets_374NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_374NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_374NonTermNode (string s, object positions)
        {
            text = s;
