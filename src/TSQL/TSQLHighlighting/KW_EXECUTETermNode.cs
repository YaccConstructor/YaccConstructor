...
{
    public class KW_EXECUTETermNode : ITreeNode
    {
        ...
        public KW_EXECUTETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_EXECUTETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_EXECUTETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
