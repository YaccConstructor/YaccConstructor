...
{
    public class KW_FORWARD_ONLYTermNode : ITreeNode
    {
        ...
        public KW_FORWARD_ONLYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FORWARD_ONLYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FORWARD_ONLYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
