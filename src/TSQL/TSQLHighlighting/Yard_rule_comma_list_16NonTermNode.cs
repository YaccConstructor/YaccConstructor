...
{
    public class Yard_rule_comma_list_16NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_16NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_16NonTermNode (string s, object positions)
        {
            text = s;
