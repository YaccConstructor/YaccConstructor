...
{
    public class KW_PERSISTEDTermNode : ITreeNode
    {
        ...
        public KW_PERSISTEDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PERSISTEDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PERSISTEDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
