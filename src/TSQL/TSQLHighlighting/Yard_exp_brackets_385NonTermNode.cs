...
{
    public class Yard_exp_brackets_385NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_385NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_385NonTermNode (string s, object positions)
        {
            text = s;
