...
{
    public class Yard_exp_brackets_240NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_240NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_240NonTermNode (string s, object positions)
        {
            text = s;
