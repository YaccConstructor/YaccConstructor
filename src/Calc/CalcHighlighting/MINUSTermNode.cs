...
{
    public class MINUSTermNode : ITreeNode
    {
        ...
        public MINUSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public MINUSTermNode (string ycTokName, string ycValue)
        {
        ...
        public MINUSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
