...
{
    public class Highlight_KW_OVERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OVERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OVERNonTermNode (string s, object positions)
        {
            text = s;
