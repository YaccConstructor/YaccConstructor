...
{
    public class Yard_exp_brackets_311NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_311NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_311NonTermNode (string s, object positions)
        {
            text = s;
