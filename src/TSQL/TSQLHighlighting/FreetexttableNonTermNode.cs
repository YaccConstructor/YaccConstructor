...
{
    public class FreetexttableNonTermNode : ITreeNode
    {
        ...
        public FreetexttableNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public FreetexttableNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public FreetexttableNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
