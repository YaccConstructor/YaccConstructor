...
{
    public class MaxLitNode : ITreeNode
    {
        ...
        public MaxLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public MaxLitNode (string ycTokName, string ycValue)
        {
        ...
        public MaxLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
