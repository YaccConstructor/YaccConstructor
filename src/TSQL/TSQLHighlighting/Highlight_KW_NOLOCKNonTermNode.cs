...
{
    public class Highlight_KW_NOLOCKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NOLOCKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NOLOCKNonTermNode (string s, object positions)
        {
            text = s;
