...
{
    public class Yard_rule_list_20NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_20NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_20NonTermNode (string s, object positions)
        {
            text = s;
