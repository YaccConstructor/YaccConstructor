...
{
    public class Yard_exp_brackets_165NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_165NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_165NonTermNode (string s, object positions)
        {
            text = s;
