...
{
    public class KW_RELATIVETermNode : ITreeNode
    {
        ...
        public KW_RELATIVETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_RELATIVETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_RELATIVETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
