...
{
    public class Yard_rule_yard_many_1_72NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_72NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_72NonTermNode (string s, object positions)
        {
            text = s;
