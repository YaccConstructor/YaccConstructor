...
{
    public class Highlight_KW_OPTIONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OPTIONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OPTIONNonTermNode (string s, object positions)
        {
            text = s;
