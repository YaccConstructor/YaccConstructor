...
{
    public class KW_MDW_CONTROLTermNode : ITreeNode
    {
        ...
        public KW_MDW_CONTROLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_MDW_CONTROLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_MDW_CONTROLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
