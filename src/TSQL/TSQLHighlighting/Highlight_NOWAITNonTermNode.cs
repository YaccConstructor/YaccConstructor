...
{
    public class Highlight_NOWAITNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_NOWAITNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_NOWAITNonTermNode (string s, object positions)
        {
            text = s;
