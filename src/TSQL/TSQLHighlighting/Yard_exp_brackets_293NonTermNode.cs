...
{
    public class Yard_exp_brackets_293NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_293NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_293NonTermNode (string s, object positions)
        {
            text = s;
