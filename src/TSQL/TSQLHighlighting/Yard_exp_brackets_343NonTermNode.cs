...
{
    public class Yard_exp_brackets_343NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_343NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_343NonTermNode (string s, object positions)
        {
            text = s;
