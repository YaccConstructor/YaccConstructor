...
{
    public class Yard_exp_brackets_312NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_312NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_312NonTermNode (string s, object positions)
        {
            text = s;
