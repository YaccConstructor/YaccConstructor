...
{
    public class Yard_exp_brackets_200NonTermNode : ITreeNode
    {
        ...
        public Yard_exp_brackets_200NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_exp_brackets_200NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_exp_brackets_200NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
