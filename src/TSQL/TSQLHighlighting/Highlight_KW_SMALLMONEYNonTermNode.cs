...
{
    public class Highlight_KW_SMALLMONEYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SMALLMONEYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SMALLMONEYNonTermNode (string s, object positions)
        {
            text = s;
