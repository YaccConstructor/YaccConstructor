            ...
            let yardLAltAction expr = 
                ...
                | RESeq [gnescc_x0] -> 
                    let (gnescc_x0) =
                        let yardElemAction expr = 
                            match expr with
                            | RELeaf select_stmnt -> (select_stmnt :?> _ ) 
                            | x -> getUnmatched x "RELeaf"
            ...
            let yardRAltAction expr = 
                ...
                | RESeq [gnescc_x0; gnescc_x1] -> 
                    let (gnescc_x0) =
                        let yardElemAction expr = 
                            match expr with
                            | RELeaf query_expression -> (query_expression :?> _ ) 
                            | x -> getUnmatched x "RELeaf"
...
let query_expression6 expr = 
    let inner  = 
                        ...
                        let yardLAltAction expr = 
                            ...
                            | RESeq [gnescc_x0] -> 
                                let (gnescc_x0) =
                                    let yardElemAction expr = 
                                        match expr with
                                        | RELeaf query_specification -> (query_specification :?> _ ) 
                                        | x -> getUnmatched x "RELeaf"
                                                    ...
                                                    let yardLAltAction expr = 
                                                        ...
                                                        | RESeq [gnescc_x0] -> 
                                                            let (gnescc_x0) =
                                                                let yardElemAction expr = 
                                                                    match expr with
                                                                    | RELeaf tKW_EXCEPT -> tKW_EXCEPT :?> 'a
                                                                    | x -> getUnmatched x "RELeaf"
                                                    ...
                                                    let yardRAltAction expr = 
                                                        ...
                                                        | RESeq [gnescc_x0] -> 
                                                            let (gnescc_x0) =
                                                                let yardElemAction expr = 
                                                                    match expr with
                                                                    | RELeaf tKW_INTERSECT -> tKW_INTERSECT :?> 'a
                                                                    | x -> getUnmatched x "RELeaf"
        ...
        | x -> getUnmatched x "RESeq"
    box (inner)
let yard_rule_67 expr = 
    let inner  = 
        match expr with
        | RELeaf sql_expr -> (sql_expr :?> _ ) 
        | x -> getUnmatched x "RELeaf"
    box (inner)
let yard_rule_78 expr = 
    let inner  = 
        match expr with
        | RELeaf tCOMMA -> tCOMMA :?> 'a
        | x -> getUnmatched x "RELeaf"
    box (inner)
let yard_rule_list_89 expr = 
    let inner  = 
        match expr with
        | RESeq [gnescc_x0; gnescc_x1] -> 
            let (gnescc_x0) =
                let yardElemAction expr = 
                    match expr with
                    | RELeaf yard_rule_6 -> (yard_rule_6 :?> _ ) 
                    | x -> getUnmatched x "RELeaf"
                        ...
                        let yardClsAction expr = 
                            ...
                            | RESeq [gnescc_x0; gnescc_x1] -> 
                                let (gnescc_x0) =
                                    let yardElemAction expr = 
                                        match expr with
                                        | RELeaf yard_rule_7 -> (yard_rule_7 :?> _ ) 
                                        | x -> getUnmatched x "RELeaf"
...
let yard_rule_910 expr = 
    let inner  = 
                                                                                        ...
                                                                                        let yardElemAction expr = 
                                                                                            ...
                                                                                            | RESeq [gnescc_x0; gnescc_x1] -> 
                                                                                                ...
                                                                                                let (gnescc_x1) =
                                                                                                    let yardElemAction expr = 
                                                                                                        match expr with
                                                                                                        | RELeaf tKW_IDENTITY -> tKW_IDENTITY :?> 'a
                                                                                                        | x -> getUnmatched x "RELeaf"
                                                                                        ...
                                                                                        let yardElemAction expr = 
                                                                                            ...
                                                                                            | RESeq [gnescc_x0; gnescc_x1] -> 
                                                                                                ...
                                                                                                let (gnescc_x1) =
                                                                                                    let yardElemAction expr = 
                                                                                                        match expr with
                                                                                                        | RELeaf tKW_ROWGUID -> tKW_ROWGUID :?> 'a
                                                                                                        | x -> getUnmatched x "RELeaf"
                                                                                                ...
                                                                                                let yardRAltAction expr = 
                                                                                                    ...
                                                                                                    | RESeq [gnescc_x0] -> 
                                                                                                        let (gnescc_x0) =
                                                                                                            let yardElemAction expr = 
                                                                                                                match expr with
                                                                                                                | RELeaf tDOUBLE_COLON -> tDOUBLE_COLON :?> 'a
                                                                                                                | x -> getUnmatched x "RELeaf"
                                                                                                ...
                                                                                                let yardRAltAction expr = 
                                                                                                    ...
                                                                                                    | RESeq [gnescc_x0; gnescc_x1; gnescc_x2; gnescc_x3] -> 
                                                                                                        ...
                                                                                                        let (gnescc_x2) =
                                                                                                            let yardElemAction expr = 
                                                                                                                match expr with
                                                                                                                | RELeaf yard_rule_list_8 -> (yard_rule_list_8 :?> _ ) 
                                                                                                                | x -> getUnmatched x "RELeaf"
        ...
        | x -> getUnmatched x "REAlt"
    box (inner)
let yard_rule_1011 expr = 
    let inner  = 
        match expr with
        | RELeaf tCOMMA -> tCOMMA :?> 'a
        | x -> getUnmatched x "RELeaf"
    box (inner)
let yard_rule_list_1112 expr = 
    let inner  = 
        match expr with
        | RESeq [gnescc_x0; gnescc_x1] -> 
            let (gnescc_x0) =
                let yardElemAction expr = 
                    match expr with
                    | RELeaf yard_rule_9 -> (yard_rule_9 :?> _ ) 
                    | x -> getUnmatched x "RELeaf"
                        ...
                        let yardClsAction expr = 
                            ...
                            | RESeq [gnescc_x0; gnescc_x1] -> 
                                let (gnescc_x0) =
                                    let yardElemAction expr = 
                                        match expr with
                                        | RELeaf yard_rule_10 -> (yard_rule_10 :?> _ ) 
                                        | x -> getUnmatched x "RELeaf"
        ...
        | x -> getUnmatched x "RESeq"
    box (inner)
let query_specification13 expr = 
    let inner  = 
        match expr with
        | RESeq [gnescc_x0; gnescc_x1; gnescc_x2; gnescc_x3] -> 
            let (gnescc_x0) =
                                ...
                                let yardRAltAction expr = 
                                    ...
                                    | RESeq [gnescc_x0] -> 
                                        let (gnescc_x0) =
                                            let yardElemAction expr = 
                                                match expr with
                                                | RELeaf tKW_DISTINCT -> tKW_DISTINCT :?> 'a
                                                | x -> getUnmatched x "RELeaf"
                                ...
                                let (gnescc_x4) =
                                    let yardElemAction expr = 
                                        ...
                                        | REOpt(opt) -> 
                                            let yardOptAction expr = 
                                                match expr with
                                                | RELeaf tKW_PRESENT -> tKW_PRESENT :?> 'a
                                                | x -> getUnmatched x "RELeaf"
            ...
            let (gnescc_x3) =
                let yardElemAction expr = 
                    match expr with
                    | RELeaf yard_rule_list_11 -> (yard_rule_list_11 :?> _ ) 
                    | x -> getUnmatched x "RELeaf"
...
let ruleToAction = dict [|(20,sql_value20); (5,sql_expr19); (21,binop18); (11,execute_as17); (12,sql_datatype16); (3,set_stmnt15); (4,execute_stmnt14); (7,query_specification13); (19,yard_rule_list_1112); (17,yard_rule_1011); (18,yard_rule_910); (14,yard_rule_list_89); (13,yard_rule_78); (9,yard_rule_67); (6,query_expression6); (2,select_stmnt5); (8,proc_body_stmnt4); (15,create_proc3); (16,start22); (0,root_rule1); (10,start0)|]
