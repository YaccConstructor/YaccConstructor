...
{
    public class Yard_exp_brackets_137NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_137NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_137NonTermNode (string s, object positions)
        {
            text = s;
