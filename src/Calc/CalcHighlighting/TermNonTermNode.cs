...
{
    public class TermNonTermNode : ITreeNode
    {
        ...
        public TermNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public TermNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public TermNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
