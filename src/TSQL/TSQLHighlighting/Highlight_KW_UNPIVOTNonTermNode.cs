...
{
    public class Highlight_KW_UNPIVOTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_UNPIVOTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_UNPIVOTNonTermNode (string s, object positions)
        {
            text = s;
