...
{
    public class KW_TRANSACTIONTermNode : ITreeNode
    {
        ...
        public KW_TRANSACTIONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TRANSACTIONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TRANSACTIONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
