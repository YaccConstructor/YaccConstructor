...
{
    public class Yard_exp_brackets_195NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_195NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_195NonTermNode (string s, object positions)
        {
            text = s;
