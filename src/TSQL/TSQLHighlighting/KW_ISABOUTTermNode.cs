...
{
    public class KW_ISABOUTTermNode : ITreeNode
    {
        ...
        public KW_ISABOUTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ISABOUTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ISABOUTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
