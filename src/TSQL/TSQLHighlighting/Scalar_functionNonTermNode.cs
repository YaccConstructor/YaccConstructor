...
{
    public class Scalar_functionNonTermNode : IAbstractTreeNode
    {
        ...
        public Scalar_functionNonTermNode (string s)
        {
            text = s;
        }

        public Scalar_functionNonTermNode (string s, object positions)
        {
            text = s;
