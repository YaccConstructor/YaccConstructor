...
{
    public class Yard_exp_brackets_270NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_270NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_270NonTermNode (string s, object positions)
        {
            text = s;
