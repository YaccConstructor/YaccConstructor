...
{
    public class Equal_LitNode : ITreeNode
    {
        ...
        public Equal_LitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Equal_LitNode (string ycTokName, string ycValue)
        {
        ...
        public Equal_LitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
