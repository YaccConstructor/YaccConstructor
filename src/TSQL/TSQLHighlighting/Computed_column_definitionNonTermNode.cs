...
{
    public class Computed_column_definitionNonTermNode : ITreeNode
    {
        ...
        public Computed_column_definitionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Computed_column_definitionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Computed_column_definitionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
