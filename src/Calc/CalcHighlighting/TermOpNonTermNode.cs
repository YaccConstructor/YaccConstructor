...
{
    public class TermOpNonTermNode : ITreeNode
    {
        ...
        public TermOpNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public TermOpNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public TermOpNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
