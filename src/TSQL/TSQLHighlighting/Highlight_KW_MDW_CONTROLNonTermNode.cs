...
{
    public class Highlight_KW_MDW_CONTROLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_MDW_CONTROLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_MDW_CONTROLNonTermNode (string s, object positions)
        {
            text = s;
