...
{
    public class Highlight_LBRACENonTermNode : IAbstractTreeNode
    {
        ...
        private string text;
        public Highlight_LBRACENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_LBRACENonTermNode (string s, object positions)
        {
            text = s;
