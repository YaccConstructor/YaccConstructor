...
{
    public class Yard_rule_list_74NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_74NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_74NonTermNode (string s, object positions)
        {
            text = s;
