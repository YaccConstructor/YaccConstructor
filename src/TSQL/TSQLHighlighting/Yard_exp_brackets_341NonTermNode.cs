...
{
    public class Yard_exp_brackets_341NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_341NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_341NonTermNode (string s, object positions)
        {
            text = s;
