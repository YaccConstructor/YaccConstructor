...
{
    public class Highlight_KW_PARTITIONNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PARTITIONNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PARTITIONNonTermNode (string s, object positions)
        {
            text = s;
