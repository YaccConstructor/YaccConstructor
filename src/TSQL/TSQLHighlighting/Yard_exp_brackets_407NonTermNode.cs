...
{
    public class Yard_exp_brackets_407NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_407NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_407NonTermNode (string s, object positions)
        {
            text = s;
