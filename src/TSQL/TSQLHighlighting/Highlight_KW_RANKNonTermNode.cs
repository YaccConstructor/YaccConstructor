...
{
    public class Highlight_KW_RANKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_RANKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_RANKNonTermNode (string s, object positions)
        {
            text = s;
