...
{
    public class Query_expressionNonTermNode : ITreeNode
    {
        ...
        public Query_expressionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Query_expressionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Query_expressionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
