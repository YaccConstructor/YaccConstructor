...
{
    public class KW_FORMATFILETermNode : ITreeNode
    {
        ...
        public KW_FORMATFILETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FORMATFILETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FORMATFILETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
