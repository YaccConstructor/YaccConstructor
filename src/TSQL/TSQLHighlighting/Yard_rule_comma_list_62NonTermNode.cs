...
{
    public class Yard_rule_comma_list_62NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_62NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_62NonTermNode (string s, object positions)
        {
            text = s;
