...
{
    public class KW_THESAURUSTermNode : ITreeNode
    {
        ...
        public KW_THESAURUSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_THESAURUSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_THESAURUSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
