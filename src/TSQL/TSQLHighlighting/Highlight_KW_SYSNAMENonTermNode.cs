...
{
    public class Highlight_KW_SYSNAMENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SYSNAMENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SYSNAMENonTermNode (string s, object positions)
        {
            text = s;
