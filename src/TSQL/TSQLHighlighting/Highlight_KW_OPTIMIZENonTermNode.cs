...
{
    public class Highlight_KW_OPTIMIZENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OPTIMIZENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OPTIMIZENonTermNode (string s, object positions)
        {
            text = s;
