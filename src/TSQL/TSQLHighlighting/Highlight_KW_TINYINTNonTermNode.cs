...
{
    public class Highlight_KW_TINYINTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TINYINTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TINYINTNonTermNode (string s, object positions)
        {
            text = s;
