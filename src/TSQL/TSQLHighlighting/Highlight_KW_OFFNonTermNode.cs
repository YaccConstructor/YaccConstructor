...
{
    public class Highlight_KW_OFFNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OFFNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OFFNonTermNode (string s, object positions)
        {
            text = s;
