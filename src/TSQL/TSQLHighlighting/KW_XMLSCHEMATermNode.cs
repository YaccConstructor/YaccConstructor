...
{
    public class KW_XMLSCHEMATermNode : ITreeNode
    {
        ...
        public KW_XMLSCHEMATermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_XMLSCHEMATermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_XMLSCHEMATermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
