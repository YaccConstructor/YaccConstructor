...
{
    public class KW_INTTermNode : ITreeNode
    {
        ...
        public KW_INTTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_INTTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_INTTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
