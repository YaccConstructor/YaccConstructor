...
{
    public class OpendatasourceNonTermNode : ITreeNode
    {
        ...
        public OpendatasourceNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public OpendatasourceNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public OpendatasourceNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
