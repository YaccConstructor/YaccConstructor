...
{
    public class Tablesample_clauseNonTermNode : IAbstractTreeNode
    {
        ...
        public Tablesample_clauseNonTermNode (string s)
        {
            text = s;
        }

        public Tablesample_clauseNonTermNode (string s, object positions)
        {
            text = s;
