...
{
    public class KW_WHENTermNode : ITreeNode
    {
        ...
        public KW_WHENTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_WHENTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_WHENTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
