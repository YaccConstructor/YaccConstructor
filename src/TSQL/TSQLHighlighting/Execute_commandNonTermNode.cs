...
{
    public class Execute_commandNonTermNode : ITreeNode
    {
        ...
        public Execute_commandNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Execute_commandNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Execute_commandNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
