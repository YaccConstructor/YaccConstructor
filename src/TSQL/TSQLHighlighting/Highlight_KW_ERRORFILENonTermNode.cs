...
{
    public class Highlight_KW_ERRORFILENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ERRORFILENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ERRORFILENonTermNode (string s, object positions)
        {
            text = s;
