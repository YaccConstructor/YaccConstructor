...
{
    public class Yard_exp_brackets_367NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_367NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_367NonTermNode (string s, object positions)
        {
            text = s;
