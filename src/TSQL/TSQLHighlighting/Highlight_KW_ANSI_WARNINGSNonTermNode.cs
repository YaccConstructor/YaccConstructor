...
{
    public class Highlight_KW_ANSI_WARNINGSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ANSI_WARNINGSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ANSI_WARNINGSNonTermNode (string s, object positions)
        {
            text = s;
