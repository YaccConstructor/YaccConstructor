...
{
    public class Highlight_KW_TYPE_WARNINGNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TYPE_WARNINGNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TYPE_WARNINGNonTermNode (string s, object positions)
        {
            text = s;
