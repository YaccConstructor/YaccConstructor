...
{
    public class KW_INFLECTIONALTermNode : ITreeNode
    {
        ...
        public KW_INFLECTIONALTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_INFLECTIONALTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_INFLECTIONALTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
