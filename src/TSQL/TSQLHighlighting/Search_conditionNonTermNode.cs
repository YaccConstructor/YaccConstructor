...
{
    public class Search_conditionNonTermNode : IAbstractTreeNode
    {
        ...
        public Search_conditionNonTermNode (string s)
        {
            text = s;
        }

        public Search_conditionNonTermNode (string s, object positions)
        {
            text = s;
