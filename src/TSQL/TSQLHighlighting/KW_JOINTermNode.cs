...
{
    public class KW_JOINTermNode : ITreeNode
    {
        ...
        public KW_JOINTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_JOINTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_JOINTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
