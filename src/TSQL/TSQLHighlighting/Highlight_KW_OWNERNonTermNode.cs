...
{
    public class Highlight_KW_OWNERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_OWNERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_OWNERNonTermNode (string s, object positions)
        {
            text = s;
