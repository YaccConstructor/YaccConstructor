...
{
    public class MinLitNode : ITreeNode
    {
        ...
        public MinLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public MinLitNode (string ycTokName, string ycValue)
        {
        ...
        public MinLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
