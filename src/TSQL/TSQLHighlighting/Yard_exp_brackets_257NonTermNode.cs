...
{
    public class Yard_exp_brackets_257NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_257NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_257NonTermNode (string s, object positions)
        {
            text = s;
