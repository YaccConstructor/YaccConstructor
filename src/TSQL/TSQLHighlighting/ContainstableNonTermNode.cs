...
{
    public class ContainstableNonTermNode : IAbstractTreeNode
    {
        ...
        public ContainstableNonTermNode (string s)
        {
            text = s;
        }

        public ContainstableNonTermNode (string s, object positions)
        {
            text = s;
