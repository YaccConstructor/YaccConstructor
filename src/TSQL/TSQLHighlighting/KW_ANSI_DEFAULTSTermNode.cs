...
{
    public class KW_ANSI_DEFAULTSTermNode : ITreeNode
    {
        ...
        public KW_ANSI_DEFAULTSTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ANSI_DEFAULTSTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ANSI_DEFAULTSTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
