...
{
    public class Yard_exp_brackets_149NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_149NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_149NonTermNode (string s, object positions)
        {
            text = s;
