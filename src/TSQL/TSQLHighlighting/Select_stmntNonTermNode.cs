...
{
    public class Select_stmntNonTermNode : ITreeNode
    {
        ...
        public Select_stmntNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Select_stmntNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Select_stmntNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
