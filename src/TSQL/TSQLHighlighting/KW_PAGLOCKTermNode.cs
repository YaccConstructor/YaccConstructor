...
{
    public class KW_PAGLOCKTermNode : ITreeNode
    {
        ...
        public KW_PAGLOCKTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_PAGLOCKTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_PAGLOCKTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
