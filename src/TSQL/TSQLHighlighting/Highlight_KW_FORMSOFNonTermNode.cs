...
{
    public class Highlight_KW_FORMSOFNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_FORMSOFNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_FORMSOFNonTermNode (string s, object positions)
        {
            text = s;
