...
{
    public class Highlight_KW_CALLERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CALLERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CALLERNonTermNode (string s, object positions)
        {
            text = s;
