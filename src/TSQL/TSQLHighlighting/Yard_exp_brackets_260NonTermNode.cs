...
{
    public class Yard_exp_brackets_260NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_260NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_260NonTermNode (string s, object positions)
        {
            text = s;
