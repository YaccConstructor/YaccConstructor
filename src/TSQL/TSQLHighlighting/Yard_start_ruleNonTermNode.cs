...
{
    public class Yard_start_ruleNonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_start_ruleNonTermNode (string s)
        {
            text = s;
        }

        public Yard_start_ruleNonTermNode (string s, object positions)
        {
            text = s;
