...
{
    public class KW_TRUETermNode : ITreeNode
    {
        ...
        public KW_TRUETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TRUETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TRUETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
