...
{
    public class KW_NCHARTermNode : ITreeNode
    {
        ...
        public KW_NCHARTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NCHARTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NCHARTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
