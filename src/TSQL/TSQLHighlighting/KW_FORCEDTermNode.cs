...
{
    public class KW_FORCEDTermNode : ITreeNode
    {
        ...
        public KW_FORCEDTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FORCEDTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FORCEDTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
