...
{
    public class Highlight_KW_ROWLOCKNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROWLOCKNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROWLOCKNonTermNode (string s, object positions)
        {
            text = s;
