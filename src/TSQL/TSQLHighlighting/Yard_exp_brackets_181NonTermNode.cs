...
{
    public class Yard_exp_brackets_181NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_181NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_181NonTermNode (string s, object positions)
        {
            text = s;
