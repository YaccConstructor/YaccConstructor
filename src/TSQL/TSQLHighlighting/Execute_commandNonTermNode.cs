...
{
    public class Execute_commandNonTermNode : IAbstractTreeNode
    {
        ...
        public Execute_commandNonTermNode (string s)
        {
            text = s;
        }

        public Execute_commandNonTermNode (string s, object positions)
        {
            text = s;
