...
{
    public class Highlight_KW_USERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_USERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_USERNonTermNode (string s, object positions)
        {
            text = s;
