...
{
    public class KW_COLONTermNode : ITreeNode
    {
        ...
        public KW_COLONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_COLONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_COLONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
