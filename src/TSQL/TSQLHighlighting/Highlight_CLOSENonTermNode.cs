...
{
    public class Highlight_CLOSENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_CLOSENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_CLOSENonTermNode (string s, object positions)
        {
            text = s;
