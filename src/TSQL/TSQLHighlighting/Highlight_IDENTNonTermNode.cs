...
{
    public class Highlight_IDENTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_IDENTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_IDENTNonTermNode (string s, object positions)
        {
            text = s;
