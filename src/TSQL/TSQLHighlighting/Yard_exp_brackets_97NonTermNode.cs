...
{
    public class Yard_exp_brackets_97NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_97NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_97NonTermNode (string s, object positions)
        {
            text = s;
