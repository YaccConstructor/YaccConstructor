...
{
    public class KW_HOURTermNode : ITreeNode
    {
        ...
        public KW_HOURTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_HOURTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_HOURTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
