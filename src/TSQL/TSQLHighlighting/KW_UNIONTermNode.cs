...
{
    public class KW_UNIONTermNode : ITreeNode
    {
        ...
        public KW_UNIONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_UNIONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_UNIONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
