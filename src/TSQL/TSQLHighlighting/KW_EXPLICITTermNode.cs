...
{
    public class KW_EXPLICITTermNode : ITreeNode
    {
        ...
        public KW_EXPLICITTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_EXPLICITTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_EXPLICITTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
