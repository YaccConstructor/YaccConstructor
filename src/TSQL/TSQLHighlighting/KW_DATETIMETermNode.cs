...
{
    public class KW_DATETIMETermNode : ITreeNode
    {
        ...
        public KW_DATETIMETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DATETIMETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DATETIMETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
