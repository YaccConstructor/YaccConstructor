...
{
    public class KW_TEXTIMAGE_ONTermNode : ITreeNode
    {
        ...
        public KW_TEXTIMAGE_ONTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TEXTIMAGE_ONTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TEXTIMAGE_ONTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
