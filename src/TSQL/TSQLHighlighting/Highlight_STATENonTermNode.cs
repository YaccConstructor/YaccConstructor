...
{
    public class Highlight_STATENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_STATENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_STATENonTermNode (string s, object positions)
        {
            text = s;
