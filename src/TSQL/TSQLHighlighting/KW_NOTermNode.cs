...
{
    public class KW_NOTermNode : ITreeNode
    {
        ...
        public KW_NOTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_NOTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_NOTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
