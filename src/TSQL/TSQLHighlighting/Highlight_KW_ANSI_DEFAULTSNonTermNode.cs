...
{
    public class Highlight_KW_ANSI_DEFAULTSNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ANSI_DEFAULTSNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ANSI_DEFAULTSNonTermNode (string s, object positions)
        {
            text = s;
