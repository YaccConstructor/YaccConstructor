...
{
    public class Yard_some_6NonTermNode : ITreeNode
    {
        ...
        public Yard_some_6NonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Yard_some_6NonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Yard_some_6NonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
