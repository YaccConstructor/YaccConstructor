...
{
    public class Highlight_KW_HASHNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_HASHNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_HASHNonTermNode (string s, object positions)
        {
            text = s;
