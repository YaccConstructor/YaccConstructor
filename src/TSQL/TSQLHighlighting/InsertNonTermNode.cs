...
{
    public class InsertNonTermNode : ITreeNode
    {
        ...
        public InsertNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public InsertNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public InsertNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
