...
{
    public class KW_FILLFACTORTermNode : ITreeNode
    {
        ...
        public KW_FILLFACTORTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FILLFACTORTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FILLFACTORTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
