...
{
    public class KW_VARBINARYTermNode : ITreeNode
    {
        ...
        public KW_VARBINARYTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_VARBINARYTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_VARBINARYTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
