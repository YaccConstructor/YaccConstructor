...
{
    public class Yard_exp_brackets_224NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_224NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_224NonTermNode (string s, object positions)
        {
            text = s;
