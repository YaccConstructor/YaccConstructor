...
{
    public class Highlight_KW_NCHARNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_NCHARNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_NCHARNonTermNode (string s, object positions)
        {
            text = s;
