...
{
    public class Proc_body_stmntNonTermNode : ITreeNode
    {
        ...
        public Proc_body_stmntNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Proc_body_stmntNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Proc_body_stmntNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
