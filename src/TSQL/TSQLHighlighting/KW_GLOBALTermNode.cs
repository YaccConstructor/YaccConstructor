...
{
    public class KW_GLOBALTermNode : ITreeNode
    {
        ...
        public KW_GLOBALTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_GLOBALTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_GLOBALTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
