...
{
    public class Highlight_KW_RAISERRORNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_RAISERRORNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_RAISERRORNonTermNode (string s, object positions)
        {
            text = s;
