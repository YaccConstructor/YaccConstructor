...
{
    public class KW_DROPTermNode : ITreeNode
    {
        ...
        public KW_DROPTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_DROPTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_DROPTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
