...
{
    public class Yard_exp_brackets_203NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_203NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_203NonTermNode (string s, object positions)
        {
            text = s;
