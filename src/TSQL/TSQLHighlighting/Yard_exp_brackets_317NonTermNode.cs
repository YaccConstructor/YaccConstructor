...
{
    public class Yard_exp_brackets_317NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_317NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_317NonTermNode (string s, object positions)
        {
            text = s;
