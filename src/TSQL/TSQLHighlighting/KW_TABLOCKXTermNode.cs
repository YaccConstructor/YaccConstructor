...
{
    public class KW_TABLOCKXTermNode : ITreeNode
    {
        ...
        public KW_TABLOCKXTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_TABLOCKXTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_TABLOCKXTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
