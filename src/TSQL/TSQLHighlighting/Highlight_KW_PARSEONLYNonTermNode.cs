...
{
    public class Highlight_KW_PARSEONLYNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_PARSEONLYNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_PARSEONLYNonTermNode (string s, object positions)
        {
            text = s;
