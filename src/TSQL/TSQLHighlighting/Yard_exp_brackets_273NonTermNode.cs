...
{
    public class Yard_exp_brackets_273NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_273NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_273NonTermNode (string s, object positions)
        {
            text = s;
