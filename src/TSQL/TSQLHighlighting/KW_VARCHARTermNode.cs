...
{
    public class KW_VARCHARTermNode : ITreeNode
    {
        ...
        public KW_VARCHARTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_VARCHARTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_VARCHARTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
