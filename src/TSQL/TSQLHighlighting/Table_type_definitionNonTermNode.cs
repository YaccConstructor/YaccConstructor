...
{
    public class Table_type_definitionNonTermNode : ITreeNode
    {
        ...
        public Table_type_definitionNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Table_type_definitionNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Table_type_definitionNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
