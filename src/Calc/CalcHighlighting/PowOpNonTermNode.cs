...
{
    public class PowOpNonTermNode : ITreeNode
    {
        ...
        public PowOpNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public PowOpNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public PowOpNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
