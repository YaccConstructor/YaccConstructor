...
{
    public class KW_ELSETermNode : ITreeNode
    {
        ...
        public KW_ELSETermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ELSETermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ELSETermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
