...
{
    public class KW_QUOTED_IDENTIFIERTermNode : ITreeNode
    {
        ...
        public KW_QUOTED_IDENTIFIERTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_QUOTED_IDENTIFIERTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_QUOTED_IDENTIFIERTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
