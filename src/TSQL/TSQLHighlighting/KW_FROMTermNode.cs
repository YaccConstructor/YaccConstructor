...
{
    public class KW_FROMTermNode : ITreeNode
    {
        ...
        public KW_FROMTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_FROMTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_FROMTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
