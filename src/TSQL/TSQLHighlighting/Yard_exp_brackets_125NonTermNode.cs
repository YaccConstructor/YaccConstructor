...
{
    public class Yard_exp_brackets_125NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_125NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_125NonTermNode (string s, object positions)
        {
            text = s;
