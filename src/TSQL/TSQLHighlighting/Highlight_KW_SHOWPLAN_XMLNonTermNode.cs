...
{
    public class Highlight_KW_SHOWPLAN_XMLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_SHOWPLAN_XMLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_SHOWPLAN_XMLNonTermNode (string s, object positions)
        {
            text = s;
