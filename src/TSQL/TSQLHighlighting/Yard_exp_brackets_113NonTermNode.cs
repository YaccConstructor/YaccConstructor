...
{
    public class Yard_exp_brackets_113NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_113NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_113NonTermNode (string s, object positions)
        {
            text = s;
