...
{
    public class Yard_rule_comma_list_44NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_44NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_44NonTermNode (string s, object positions)
        {
            text = s;
