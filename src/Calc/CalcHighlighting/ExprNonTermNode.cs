...
{
    public class ExprNonTermNode : ITreeNode
    {
        ...
        public ExprNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public ExprNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public ExprNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
