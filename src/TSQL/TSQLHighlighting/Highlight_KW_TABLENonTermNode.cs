...
{
    public class Highlight_KW_TABLENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_TABLENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_TABLENonTermNode (string s, object positions)
        {
            text = s;
