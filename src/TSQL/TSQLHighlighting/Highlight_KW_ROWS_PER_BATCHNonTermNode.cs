...
{
    public class Highlight_KW_ROWS_PER_BATCHNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ROWS_PER_BATCHNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ROWS_PER_BATCHNonTermNode (string s, object positions)
        {
            text = s;
