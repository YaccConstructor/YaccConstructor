...
{
    public class Highlight_KW_XMLSCHEMANonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_XMLSCHEMANonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_XMLSCHEMANonTermNode (string s, object positions)
        {
            text = s;
