...
{
    public class Yard_exp_brackets_342NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_342NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_342NonTermNode (string s, object positions)
        {
            text = s;
