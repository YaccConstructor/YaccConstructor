...
{
    public class Yard_rule_comma_list_85NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_85NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_85NonTermNode (string s, object positions)
        {
            text = s;
