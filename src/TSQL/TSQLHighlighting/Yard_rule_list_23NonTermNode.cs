...
{
    public class Yard_rule_list_23NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_list_23NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_list_23NonTermNode (string s, object positions)
        {
            text = s;
