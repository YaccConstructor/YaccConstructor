...
{
    public class Yard_rule_brace_opt_1NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_brace_opt_1NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_brace_opt_1NonTermNode (string s, object positions)
        {
            text = s;
