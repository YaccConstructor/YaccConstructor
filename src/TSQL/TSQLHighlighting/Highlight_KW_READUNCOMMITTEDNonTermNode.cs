...
{
    public class Highlight_KW_READUNCOMMITTEDNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_READUNCOMMITTEDNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_READUNCOMMITTEDNonTermNode (string s, object positions)
        {
            text = s;
