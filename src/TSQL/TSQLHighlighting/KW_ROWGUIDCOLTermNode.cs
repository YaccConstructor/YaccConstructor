...
{
    public class KW_ROWGUIDCOLTermNode : ITreeNode
    {
        ...
        public KW_ROWGUIDCOLTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public KW_ROWGUIDCOLTermNode (string ycTokName, string ycValue)
        {
        ...
        public KW_ROWGUIDCOLTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
