...
{
    public class Highlight_KW_ELSENonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ELSENonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ELSENonTermNode (string s, object positions)
        {
            text = s;
