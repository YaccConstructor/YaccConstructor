...
{
    public class Yard_exp_brackets_403NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_403NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_403NonTermNode (string s, object positions)
        {
            text = s;
