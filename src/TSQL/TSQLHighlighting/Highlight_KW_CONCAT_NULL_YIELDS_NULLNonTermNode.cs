...
{
    public class Highlight_KW_CONCAT_NULL_YIELDS_NULLNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_CONCAT_NULL_YIELDS_NULLNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_CONCAT_NULL_YIELDS_NULLNonTermNode (string s, object positions)
        {
            text = s;
