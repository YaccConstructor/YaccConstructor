...
{
    public class Yard_exp_brackets_390NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_390NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_390NonTermNode (string s, object positions)
        {
            text = s;
