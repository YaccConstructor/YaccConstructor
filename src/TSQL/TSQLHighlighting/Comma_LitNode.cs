...
{
    public class Comma_LitNode : ITreeNode
    {
        ...
        public Comma_LitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Comma_LitNode (string ycTokName, string ycValue)
        {
        ...
        public Comma_LitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
