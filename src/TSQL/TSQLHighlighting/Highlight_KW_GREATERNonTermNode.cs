...
{
    public class Highlight_KW_GREATERNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_GREATERNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_GREATERNonTermNode (string s, object positions)
        {
            text = s;
