...
{
    public class Yard_exp_brackets_246NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_246NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_246NonTermNode (string s, object positions)
        {
            text = s;
