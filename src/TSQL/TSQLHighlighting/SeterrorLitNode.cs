...
{
    public class SeterrorLitNode : ITreeNode
    {
        ...
        public SeterrorLitNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public SeterrorLitNode (string ycTokName, string ycValue)
        {
        ...
        public SeterrorLitNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
