...
let gotoSet = 
Set.ofArray [|(-125610634,("s",2));(-125610665,("raccStart",2));(-63144034,("s",0));(-63144065,("s",0));(1290233087,("raccStart",1));(1351011686,("s",0));(1413080943,("s",3));(1413080974,("s",2))|]
