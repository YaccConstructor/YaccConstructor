...
{
    public class Execute_asNonTermNode : ITreeNode
    {
        ...
        public Execute_asNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Execute_asNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Execute_asNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
