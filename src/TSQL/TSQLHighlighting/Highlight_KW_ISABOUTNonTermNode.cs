...
{
    public class Highlight_KW_ISABOUTNonTermNode : IAbstractTreeNode
    {
        ...
        public Highlight_KW_ISABOUTNonTermNode (string s)
        {
            text = s;
        }

        public Highlight_KW_ISABOUTNonTermNode (string s, object positions)
        {
            text = s;
