...
{
    public class Yard_exp_brackets_328NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_328NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_328NonTermNode (string s, object positions)
        {
            text = s;
