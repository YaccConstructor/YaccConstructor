...
{
    public class Yard_exp_brackets_296NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_exp_brackets_296NonTermNode (string s)
        {
            text = s;
        }

        public Yard_exp_brackets_296NonTermNode (string s, object positions)
        {
            text = s;
