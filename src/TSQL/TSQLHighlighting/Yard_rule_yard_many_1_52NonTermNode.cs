...
{
    public class Yard_rule_yard_many_1_52NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_yard_many_1_52NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_yard_many_1_52NonTermNode (string s, object positions)
        {
            text = s;
