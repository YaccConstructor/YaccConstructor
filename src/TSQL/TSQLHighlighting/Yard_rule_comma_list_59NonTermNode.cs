...
{
    public class Yard_rule_comma_list_59NonTermNode : IAbstractTreeNode
    {
        ...
        public Yard_rule_comma_list_59NonTermNode (string s)
        {
            text = s;
        }

        public Yard_rule_comma_list_59NonTermNode (string s, object positions)
        {
            text = s;
