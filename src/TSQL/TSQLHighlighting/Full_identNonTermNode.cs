...
{
    public class Full_identNonTermNode : ITreeNode
    {
        ...
        public Full_identNonTermNode (string ycTokName) : this (ycTokName, string.Empty)
        {
        }

        public Full_identNonTermNode (string ycTokName, string ycValue)
        {
        ...
        public Full_identNonTermNode (string ycTokName, string ycValue, object positions) : this (ycTokName, ycValue)
        {
