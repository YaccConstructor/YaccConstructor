...
{
    public class Execute_character_stringNonTermNode : IAbstractTreeNode
    {
        ...
        public Execute_character_stringNonTermNode (string s)
        {
            text = s;
        }

        public Execute_character_stringNonTermNode (string s, object positions)
        {
            text = s;
